 ...
 * http://opensource.org/licenses/MIT
 *
 */(function($,window,document,undefined){"use strict";$.isFunction=$.isFunction||function(obj){return typeof obj==="function"&&typeof obj.nodeType!=="number"};window=typeof window!="undefined"&&window.Math==Math?window:typeof self!="undefined"&&self.Math==Math?self:Function("return this")();$.fn.transition=function(){var $allModules=$(this),moduleSelector=$allModules.selector||"",time=(new Date).getTime(),performance=[],moduleArguments=arguments,query=moduleArguments[0],queryArguments=[].slice.call(arguments,1),methodInvoked=typeof query==="string",returnedValue;$allModules.each((function(index){var $module=$(this),element=this,settings,instance,error,className,metadata,animationEnd,moduleNamespace,eventNamespace,module;module={initialize:function(){settings=module.get.settings.apply(element,moduleArguments);className=settings.className;error=settings.error;metadata=settings.metadata;eventNamespace="."+settings.namespace;moduleNamespace="module-"+settings.namespace;instance=$module.data(moduleNamespace)||module;animationEnd=module.get.animationEndEvent();if(methodInvoked){methodInvoked=module.invoke(query)}if(methodInvoked===false){module.verbose("Converted arguments into settings object",settings);if(settings.interval){module.delay(settings.interval)}else{module.animate()}module.instantiate()}},instantiate:function(){module.verbose("Storing instance of module",module);instance=module;$module.data(moduleNamespace,instance)},destroy:function(){module.verbose("Destroying previous module for",element);$module.removeData(moduleNamespace)},refresh:function(){module.verbose("Refreshing display type on next animation");delete module.displayType},forceRepaint:function(){module.verbose("Forcing element repaint");var $parentElement=$module.parent(),$nextElement=$module.next();if($nextElement.length===0){$module.detach().appendTo($parentElement)}else{$module.detach().insertBefore($nextElement)}},repaint:function(){module.verbose("Repainting element");var fakeAssignment=element.offsetWidth},delay:function(interval){var direction=module.get.animationDirection(),shouldReverse,delay;if(!direction){direction=module.can.transition()?module.get.direction():"static"}interval=interval!==undefined?interval:settings.interval;shouldReverse=settings.reverse=="auto"&&direction==className.outward;delay=shouldReverse||settings.reverse===true?($allModules.length-index)*interval:index*interval;module.debug("Delaying animation by",delay);setTimeout(module.animate,delay)},animate:function(overrideSettings){settings=overrideSettings||settings;if(!module.is.supported()){module.error(error.support);return false}module.debug("Preparing animation",settings.animation);if(module.is.animating()){if(settings.queue){if(!settings.allowRepeats&&module.has.direction()&&module.is.occurring()&&module.queuing!==true){module.debug("Animation is currently occurring, preventing queueing same animation",settings.animation)}else{module.queue(settings.animation)}return false}else if(!settings.allowRepeats&&module.is.occurring()){module.debug("Animation is already occurring, will not execute repeated animation",settings.animation);return false}else{module.debug("New animation started, completing previous early",settings.animation);instance.complete()}}if(module.can.animate()){module.set.animating(settings.animation)}else{module.error(error.noAnimation,settings.animation,element)}},reset:function(){module.debug("Resetting animation to beginning conditions");module.remove.animationCallbacks();module.restore.conditions();module.remove.animating()},queue:function(animation){module.debug("Queueing animation of",animation);module.queuing=true;$module.one(animationEnd+".queue"+eventNamespace,(function(){module.queuing=false;module.repaint();module.animate.apply(this,settings)}))},complete:function(event){if(event&&event.target===element){event.stopPropagation()}module.debug("Animation complete",settings.animation);module.remove.completeCallback();module.remove.failSafe();if(!module.is.looping()){if(module.is.outward()){module.verbose("Animation is outward, hiding element");module.restore.conditions();module.hide()}else if(module.is.inward()){module.verbose("Animation is outward, showing element");module.restore.conditions();module.show()}else{module.verbose("Static animation completed");module.restore.conditions();settings.onComplete.call(element)}}},force:{visible:function(){var style=$module.attr("style"),userStyle=module.get.userStyle(style),displayType=module.get.displayType(),overrideStyle=userStyle+"display: "+displayType+" !important;",inlineDisplay=$module[0].style.display,mustStayHidden=!displayType||inlineDisplay==="none"&&settings.skipInlineHidden||$module[0].tagName.match(/(script|link|style)/i);if(mustStayHidden){module.remove.transition();return false}module.verbose("Overriding default display to show element",displayType);$module.attr("style",overrideStyle);return true},hidden:function(){var style=$module.attr("style"),currentDisplay=$module.css("display"),emptyStyle=style===undefined||style==="";if(currentDisplay!=="none"&&!module.is.hidden()){module.verbose("Overriding default display to hide element");$module.css("display","none")}else if(emptyStyle){$module.removeAttr("style")}}},has:{direction:function(animation){var hasDirection=false;animation=animation||settings.animation;if(typeof animation==="string"){animation=animation.split(" ");$.each(animation,(function(index,word){if(word===className.inward||word===className.outward){hasDirection=true}}))}return hasDirection},inlineDisplay:function(){var style=$module.attr("style")||"";return Array.isArray(style.match(/display.*?;/,""))}},set:{animating:function(animation){module.remove.completeCallback();animation=animation||settings.animation;var animationClass=module.get.animationClass(animation);module.save.animation(animationClass);if(module.force.visible()){module.remove.hidden();module.remove.direction();module.start.animation(animationClass)}},duration:function(animationName,duration){duration=duration||settings.duration;duration=typeof duration=="number"?duration+"ms":duration;if(duration||duration===0){module.verbose("Setting animation duration",duration);$module.css({"animation-duration":duration})}},direction:function(direction){direction=direction||module.get.direction();if(direction==className.inward){module.set.inward()}else{module.set.outward()}},looping:function(){module.debug("Transition set to loop");$module.addClass(className.looping)},hidden:function(){$module.addClass(className.transition).addClass(className.hidden)},inward:function(){module.debug("Setting direction to inward");$module.removeClass(className.outward).addClass(className.inward)},outward:function(){module.debug("Setting direction to outward");$module.removeClass(className.inward).addClass(className.outward)},visible:function(){$module.addClass(className.transition).addClass(className.visible)}},start:{animation:function(animationClass){animationClass=animationClass||module.get.animationClass();module.debug("Starting tween",animationClass);$module.addClass(animationClass).one(animationEnd+".complete"+eventNamespace,module.complete);if(settings.useFailSafe){module.add.failSafe()}module.set.duration(settings.duration);settings.onStart.call(element)}},save:{animation:function(animation){if(!module.cache){module.cache={}}module.cache.animation=animation},displayType:function(displayType){if(displayType!=="none"){$module.data(metadata.displayType,displayType)}},transitionExists:function(animation,exists){$.fn.transition.exists[animation]=exists;module.verbose("Saving existence of transition",animation,exists)}},restore:{conditions:function(){var animation=module.get.currentAnimation();if(animation){$module.removeClass(animation);module.verbose("Removing animation class",module.cache)}module.remove.duration()}},add:{failSafe:function(){var duration=module.get.duration();module.timer=setTimeout((function(){$module.triggerHandler(animationEnd)}),duration+settings.failSafeDelay);module.verbose("Adding fail safe timer",module.timer)}},remove:{animating:function(){$module.removeClass(className.animating)},animationCallbacks:function(){module.remove.queueCallback();module.remove.completeCallback()},queueCallback:function(){$module.off(".queue"+eventNamespace)},completeCallback:function(){$module.off(".complete"+eventNamespace)},display:function(){$module.css("display","")},direction:function(){$module.removeClass(className.inward).removeClass(className.outward)},duration:function(){$module.css("animation-duration","")},failSafe:function(){module.verbose("Removing fail safe timer",module.timer);if(module.timer){clearTimeout(module.timer)}},hidden:function(){$module.removeClass(className.hidden)},visible:function(){$module.removeClass(className.visible)},looping:function(){module.debug("Transitions are no longer looping");if(module.is.looping()){module.reset();$module.removeClass(className.looping)}},transition:function(){$module.removeClass(className.transition).removeClass(className.visible).removeClass(className.hidden)}},get:{settings:function(animation,duration,onComplete){if(typeof animation=="object"){return $.extend(true,{},$.fn.transition.settings,animation)}else if(typeof onComplete=="function"){return $.extend({},$.fn.transition.settings,{animation:animation,onComplete:onComplete,duration:duration})}else if(typeof duration=="string"||typeof duration=="number"){return $.extend({},$.fn.transition.settings,{animation:animation,duration:duration})}else if(typeof duration=="object"){return $.extend({},$.fn.transition.settings,duration,{animation:animation})}else if(typeof duration=="function"){return $.extend({},$.fn.transition.settings,{animation:animation,onComplete:duration})}else{return $.extend({},$.fn.transition.settings,{animation:animation})}},animationClass:function(animation){var animationClass=animation||settings.animation,directionClass=module.can.transition()&&!module.has.direction()?module.get.direction()+" ":"";return className.animating+" "+className.transition+" "+directionClass+animationClass},currentAnimation:function(){return module.cache&&module.cache.animation!==undefined?module.cache.animation:false},currentDirection:function(){return module.is.inward()?className.inward:className.outward},direction:function(){return module.is.hidden()||!module.is.visible()?className.inward:className.outward},animationDirection:function(animation){var direction;animation=animation||settings.animation;if(typeof animation==="string"){animation=animation.split(" ");$.each(animation,(function(index,word){if(word===className.inward){direction=className.inward}else if(word===className.outward){direction=className.outward}}))}if(direction){return direction}return false},duration:function(duration){duration=duration||settings.duration;if(duration===false){duration=$module.css("animation-duration")||0}return typeof duration==="string"?duration.indexOf("ms")>-1?parseFloat(duration):parseFloat(duration)*1e3:duration},displayType:function(shouldDetermine){shouldDetermine=shouldDetermine!==undefined?shouldDetermine:true;if(settings.displayType){return settings.displayType}if(shouldDetermine&&$module.data(metadata.displayType)===undefined){var currentDisplay=$module.css("display");if(currentDisplay===""||currentDisplay==="none"){module.can.transition(true)}else{module.save.displayType(currentDisplay)}}return $module.data(metadata.displayType)},userStyle:function(style){style=style||$module.attr("style")||"";return style.replace(/display.*?;/,"")},transitionExists:function(animation){return $.fn.transition.exists[animation]},animationStartEvent:function(){var element=document.createElement("div"),animations={animation:"animationstart",OAnimation:"oAnimationStart",MozAnimation:"mozAnimationStart",WebkitAnimation:"webkitAnimationStart"},animation;for(animation in animations){if(element.style[animation]!==undefined){return animations[animation]}}return false},animationEndEvent:function(){var element=document.createElement("div"),animations={animation:"animationend",OAnimation:"oAnimationEnd",MozAnimation:"mozAnimationEnd",WebkitAnimation:"webkitAnimationEnd"},animation;for(animation in animations){if(element.style[animation]!==undefined){return animations[animation]}}return false}},can:{transition:function(forced){var animation=settings.animation,transitionExists=module.get.transitionExists(animation),displayType=module.get.displayType(false),elementClass,tagName,$clone,currentAnimation,inAnimation,directionExists;if(transitionExists===undefined||forced){module.verbose("Determining whether animation exists");elementClass=$module.attr("class");tagName=$module.prop("tagName");$clone=$("<"+tagName+" />").addClass(elementClass).insertAfter($module);currentAnimation=$clone.addClass(animation).removeClass(className.inward).removeClass(className.outward).addClass(className.animating).addClass(className.transition).css("animationName");$clone.detach().insertAfter($module);inAnimation=$clone.addClass(className.inward).css("animationName");if(!displayType){$clone.detach().insertAfter($module);displayType=$clone.attr("class",elementClass).removeAttr("style").removeClass(className.hidden).removeClass(className.visible).show().css("display");module.verbose("Determining final display state",displayType);module.save.displayType(displayType)}$clone.remove();if(currentAnimation!=inAnimation){module.debug("Direction exists for animation",animation);directionExists=true}else if(currentAnimation=="none"||!currentAnimation){module.debug("No animation defined in css",animation);return}else{module.debug("Static animation found",animation,displayType);directionExists=false}module.save.transitionExists(animation,directionExists)}return transitionExists!==undefined?transitionExists:directionExists},animate:function(){return module.can.transition()!==undefined}},is:{animating:function(){return $module.hasClass(className.animating)},inward:function(){return $module.hasClass(className.inward)},outward:function(){return $module.hasClass(className.outward)},looping:function(){return $module.hasClass(className.looping)},occurring:function(animation){animation=animation||settings.animation;animation="."+animation.replace(" ",".");return $module.filter(animation).length>0},visible:function(){return $module.is(":visible")},hidden:function(){return $module.css("visibility")==="hidden"},supported:function(){return animationEnd!==false}},hide:function(){if(settings.onHide.call(element)===false){module.verbose("Hide callback returned false cancelling hide");return false}module.verbose("Hiding element");if(module.is.animating()){module.reset()}element.blur();module.remove.display();module.remove.visible();settings.onBeforeHide.call(element,module.hideNow)},hideNow:function(){module.set.hidden();module.force.hidden();settings.onHidden.call(element);settings.onComplete.call(element)},show:function(display){if(module.force.visible()&&settings.onShow.call(element)!==false){module.verbose("Showing element",display);module.remove.hidden();settings.onBeforeShow.call(element,module.showNow)}},showNow:function(){module.set.visible();settings.onVisible.call(element);settings.onComplete.call(element)},toggle:function(){if(module.is.visible()){module.hide()}else{module.show()}},stop:function(){module.debug("Stopping current animation");$module.triggerHandler(animationEnd)},stopAll:function(){module.debug("Stopping all animation");module.remove.queueCallback();$module.triggerHandler(animationEnd)},clear:{queue:function(){module.debug("Clearing animation queue");module.remove.queueCallback()}},enable:function(){module.verbose("Starting animation");$module.removeClass(className.disabled)},disable:function(){module.debug("Stopping animation");$module.addClass(className.disabled)},setting:function(name,value){module.debug("Changing setting",name,value);if($.isPlainObject(name)){$.extend(true,settings,name)}else if(value!==undefined){if($.isPlainObject(settings[name])){$.extend(true,settings[name],value)}else{settings[name]=value}}else{return settings[name]}},internal:function(name,value){if($.isPlainObject(name)){$.extend(true,module,name)}else if(value!==undefined){module[name]=value}else{return module[name]}},debug:function(){if(!settings.silent&&settings.debug){if(settings.performance){module.performance.log(arguments)}else{module.debug=Function.prototype.bind.call(console.info,console,settings.name+":");module.debug.apply(console,arguments)}}},verbose:function(){if(!settings.silent&&settings.verbose&&settings.debug){if(settings.performance){module.performance.log(arguments)}else{module.verbose=Function.prototype.bind.call(console.info,console,settings.name+":");module.verbose.apply(console,arguments)}}},error:function(){if(!settings.silent){module.error=Function.prototype.bind.call(console.error,console,settings.name+":");module.error.apply(console,arguments)}},performance:{log:function(message){var currentTime,executionTime,previousTime;if(settings.performance){currentTime=(new Date).getTime();previousTime=time||currentTime;executionTime=currentTime-previousTime;time=currentTime;performance.push({Name:message[0],Arguments:[].slice.call(message,1)||"",Element:element,"Execution Time":executionTime})}clearTimeout(module.performance.timer);module.performance.timer=setTimeout(module.performance.display,500)},display:function(){var title=settings.name+":",totalTime=0;time=false;clearTimeout(module.performance.timer);$.each(performance,(function(index,data){totalTime+=data["Execution Time"]}));title+=" "+totalTime+"ms";if(moduleSelector){title+=" '"+moduleSelector+"'"}if($allModules.length>1){title+=" "+"("+$allModules.length+")"}if((console.group!==undefined||console.table!==undefined)&&performance.length>0){console.groupCollapsed(title);if(console.table){console.table(performance)}else{$.each(performance,(function(index,data){console.log(data["Name"]+": "+data["Execution Time"]+"ms")}))}console.groupEnd()}performance=[]}},invoke:function(query,passedArguments,context){var object=instance,maxDepth,found,response;passedArguments=passedArguments||queryArguments;context=context||element;if(typeof query=="string"&&object!==undefined){query=query.split(/[\. ]/);maxDepth=query.length-1;$.each(query,(function(depth,value){var camelCaseValue=depth!=maxDepth?value+query[depth+1].charAt(0).toUpperCase()+query[depth+1].slice(1):query;if($.isPlainObject(object[camelCaseValue])&&depth!=maxDepth){object=object[camelCaseValue]}else if(object[camelCaseValue]!==undefined){found=object[camelCaseValue];return false}else if($.isPlainObject(object[value])&&depth!=maxDepth){object=object[value]}else if(object[value]!==undefined){found=object[value];return false}else{return false}}))}if($.isFunction(found)){response=found.apply(context,passedArguments)}else if(found!==undefined){response=found}if(Array.isArray(returnedValue)){returnedValue.push(response)}else if(returnedValue!==undefined){returnedValue=[returnedValue,response]}else if(response!==undefined){returnedValue=response}return found!==undefined?found:false}};module.initialize()}));return returnedValue!==undefined?returnedValue:this};$.fn.transition.exists={};$.fn.transition.settings={name:"Transition",silent:false,debug:false,verbose:false,performance:true,namespace:"transition",interval:0,reverse:"auto",onStart:function(){},onComplete:function(){},onShow:function(){},onBeforeShow:function(callback){callback.call(this)},onVisible:function(){},onHide:function(){},onHidden:function(){},onBeforeHide:function(callback){callback.call(this)},useFailSafe:true,failSafeDelay:100,allowRepeats:false,displayType:false,animation:"fade",duration:false,queue:true,skipInlineHidden:false,metadata:{displayType:"display"},className:{animating:"animating",disabled:"disabled",hidden:"hidden",inward:"in",loading:"loading",looping:"looping",outward:"out",transition:"transition",visible:"visible"},error:{noAnimation:"Element is no longer attached to DOM. Unable to animate.  Use silent setting to suppress this warning in production.",repeated:"That animation is already occurring, cancelling repeated animation",method:"The method you called is not defined",support:"This browser does not support CSS animations"}}})(jQuery,window,document);var games={rby:{id:"rby",title:"Red, Blue and Yellow",nameLimit:10,dexLimit:151,loaded:false,locations:[{name:"Starter",value:0},{name:"Pallet Town",value:1,german:"Alabastia",english:"Pallet Town"},{name:"Route 1",value:2,german:"Route 1",english:"Route 1"},{name:"Viridian City",value:3,german:"Vertania City",english:"Viridian City"},{name:"Route 22",value:4,german:"Route 22",english:"Route 22"},{name:"Route 2",value:5,german:"Route 2",english:"Route 2"},{name:"Viridian Forest",value:6,german:"Vertania-Wald",english:"Viridian Forest"},{name:"Route 3",value:7,german:"Route 3",english:"Route 3"},{name:"Route 4",value:8,german:"Route 4",english:"Route 4"},{name:"Mt. Moon",value:9,german:"Mondberg",english:"Mt. Moon"},{name:"Cerulean City",value:10,german:"Azuria City",english:"Cerulean City"},{name:"Route 24",value:11,german:"Route 24",english:"Route 24"},{name:"Route 25",value:12,german:"Route 25",english:"Route 25"},{name:"Route 5",value:13,german:"Route 5",english:"Route 5"},{name:"Route 6",value:14,german:"Route 6",english:"Route 6"},{name:"Vermillion City",value:15},{name:"Route 11",value:16,german:"Route 11",english:"Route 11"},{name:"Diglett's Cave",value:17,german:"Digdas Höhle",english:"Diglett's Cave"},{name:"Route 9",value:18,german:"Route 9",english:"Route 9"},{name:"Route 10",value:19,german:"Route 10",english:"Route 10"},{name:"Rock Tunnel",value:20,german:"Felstunnel",english:"Rock Tunnel"},{name:"Pokémon Tower",value:21,german:"Pokémon Tower",english:"Pokémon Tower"},{name:"Route 12",value:22,german:"Route 12",english:"Route 12"},{name:"Route 8",value:23,german:"Route 8",english:"Route 8"},{name:"Route 7",value:24,german:"Route 7",english:"Route 7"},{name:"Celadon City",value:25,german:"Prismania City",english:"Celadon City"},{name:"Route 16",value:26,german:"Route 16",english:"Route 16"},{name:"Route 17",value:27,german:"Route 17",english:"Route 17"},{name:"Route 18",value:28,german:"Route 18",english:"Route 18"},{name:"Fuschia City",value:29},{name:"Safari Zone",value:30,german:"Safari-Zone",english:"Safari Zone"},{name:"Route 15",value:31,german:"Route 15",english:"Route 15"},{name:"Route 14",value:32,german:"Route 14",english:"Route 14"},{name:"Route 13",value:33,german:"Route 13",english:"Route 13"},{name:"Power Plant",value:34,german:"Kraftwerk",english:"Power Plant"},{name:"Route 19",value:35,german:"Route 19",english:"Route 19"},{name:"Route 20",value:36,german:"Route 20",english:"Route 20"},{name:"Seafoam Islands",value:37,german:"Seeschauminseln",english:"Seafoam Islands"},{name:"Cinnabar Island",value:38,german:"Zinnoberinsel",english:"Cinnabar Island"},{name:"Pokémon Mansion",value:39,german:"Pokémon Mansion",english:"Pokémon Mansion"},{name:"Route 21",value:40,german:"Route 21",english:"Route 21"},{name:"Route 23",value:41,german:"Route 23",english:"Route 23"},{name:"Victory Road",value:42,german:"Siegesstraße",english:"Victory Road"},{name:"Cerulean Cave",value:43,german:"Azuria-Höhle",english:"Cerulean Cave"}]},gsc:{id:"gsc",title:"Gold, Silver and Crystal",nameLimit:10,dexLimit:251,loaded:false,locations:[{name:"Starter",value:0},{name:"New Bark Town",value:1,german:"Neuborkia",english:"New Bark Town"},{name:"Route 29",value:2,german:"Route 29",english:"Route 29"},{name:"Cherrygrove City",value:3,german:"Rosalia City",english:"Cherrygrove City"},{name:"Route 30",value:4,german:"Route 30",english:"Route 30"},{name:"Route 31",value:5,german:"Route 31",english:"Route 31"},{name:"Dark Cave",value:6,german:"Dunkelhöhle",english:"Dark Cave"},{name:"Violet City",value:7,german:"Viola City",english:"Violet City"},{name:"Sprout Tower",value:8,german:"Knofensa-Turm",english:"Sprout Tower"},{name:"Route 32",value:9,german:"Route 32",english:"Route 32"},{name:"Ruins of Alph",value:10,german:"Alph-Ruinen",english:"Ruins of Alph"},{name:"Union Cave",value:11,german:"Einheitstunnel",english:"Union Cave"},{name:"Route 33",value:12,german:"Route 33",english:"Route 33"},{name:"Azalea Town",value:13,german:"Azalea City",english:"Azalea Town"},{name:"Slowpoke Well",value:14,german:"Flegmon-Brunnen",english:"Slowpoke Well"},{name:"Ilex Forest",value:15,german:"Steineichenwald",english:"Ilex Forest"},{name:"Route 34",value:16,german:"Route 34",english:"Route 34"},{name:"Goldenrod City",value:17,german:"Dukatia City",english:"Goldenrod City"},{name:"Route 35",value:18,german:"Route 35",english:"Route 35"},{name:"National Park",value:19,german:"Nationalpark",english:"National Park"},{name:"Route 36",value:20,german:"Route 36",english:"Route 36"},{name:"Route 37",value:21,german:"Route 37",english:"Route 37"},{name:"Ecruteak City",value:22,german:"Teak City",english:"Ecruteak City"},{name:"Burned Tower",value:23,german:"Burned Tower",english:"Burned Tower"},{name:"Tin Tower",value:24},{name:"Route 38",value:25,german:"Route 38",english:"Route 38"},{name:"Route 39",value:26,german:"Route 39",english:"Route 39"},{name:"Olivine City",value:27,german:"Oliviana City",english:"Olivine City"},{name:"Route 40",value:28},{name:"Route 41",value:29},{name:"Whirl Islands",value:30,german:"Strudelinseln",english:"Whirl Islands"},{name:"Cianwood City",value:31,german:"Anemonia City",english:"Cianwood City"},{name:"Route 42",value:32,german:"Route 42",english:"Route 42"},{name:"Mt. Mortar",value:33,german:"Kesselberg",english:"Mt. Mortar"},{name:"Mahogany Town",value:34,german:"Mahagonia City",english:"Mahogany Town"},{name:"Rocket Hideout",value:35},{name:"Route 43",value:36,german:"Route 43",english:"Route 43"},{name:"Lake of Rage",value:37,german:"See des Zorns",english:"Lake of Rage"},{name:"Route 44",value:38,german:"Route 44",english:"Route 44"},{name:"Ice Path",value:39,german:"Eispfad",english:"Ice Path"},{name:"Blackthorn City",value:40,german:"Ebenholz City",english:"Blackthorn City"},{name:"Dragon's Den",value:41,german:"Drachenhöhle",english:"Dragon's Den"},{name:"Route 45",value:42,german:"Route 45",english:"Route 45"},{name:"Dark Cave 2",value:43},{name:"Route 46",value:44,german:"Route 46",english:"Route 46"},{name:"Route 27",value:45,german:"Route 27",english:"Route 27"},{name:"Tohjo Falls",value:46,german:"Tohjo-Fälle",english:"Tohjo Falls"},{name:"Route 26",value:47,german:"Route 26",english:"Route 26"},{name:"Victory Road",value:48,german:"Siegesstraße",english:"Victory Road"},{name:"Indigo Plateau",value:49,german:"Indigo Plateau",english:"Indigo Plateau"},{name:"Vermillion City",value:50},{name:"Route 6",value:51,german:"Route 6",english:"Route 6"},{name:"Saffron City",value:52,german:"Saffronia City",english:"Saffron City"},{name:"Route 5",value:53,german:"Route 5",english:"Route 5"},{name:"Route 7",value:54,german:"Route 7",english:"Route 7"},{name:"Route 8",value:55,german:"Route 8",english:"Route 8"},{name:"Route 10",value:56,german:"Route 10",english:"Route 10"},{name:"Rock Tunnel",value:57,german:"Felstunnel",english:"Rock Tunnel"},{name:"Route 9",value:58,german:"Route 9",english:"Route 9"},{name:"Cerulean City",value:59,german:"Azuria City",english:"Cerulean City"},{name:"Route 24",value:60,german:"Route 24",english:"Route 24"},{name:"Route 25",value:61,german:"Route 25",english:"Route 25"},{name:"Route 4",value:62,german:"Route 4",english:"Route 4"},{name:"Route 16",value:63,german:"Route 16",english:"Route 16"},{name:"Route 17",value:64,german:"Route 17",english:"Route 17"},{name:"Route 18",value:65,german:"Route 18",english:"Route 18"},{name:"Fuschia City",value:66},{name:"Route 15",value:67,german:"Route 15",english:"Route 15"},{name:"Route 14",value:68,german:"Route 14",english:"Route 14"},{name:"Route 13",value:69,german:"Route 13",english:"Route 13"},{name:"Route 12",value:70,german:"Route 12",english:"Route 12"},{name:"Route 11",value:71,german:"Route 11",english:"Route 11"},{name:"Diglett's Cave",value:72,german:"Digdas Höhle",english:"Diglett's Cave"},{name:"Route 2",value:73,german:"Route 2",english:"Route 2"},{name:"Pewter City",value:74,german:"Marmoria City",english:"Pewter City"},{name:"Route 3",value:75,german:"Route 3",english:"Route 3"},{name:"Mt. Moon",value:76,german:"Mondberg",english:"Mt. Moon"},{name:"Viridian City",value:77,german:"Vertania City",english:"Viridian City"},{name:"Route 1",value:78,german:"Route 1",english:"Route 1"},{name:"Pallet Town",value:79,german:"Alabastia",english:"Pallet Town"},{name:"Route 21",value:80,german:"Route 21",english:"Route 21"},{name:"Cinnabar Island",value:81,german:"Zinnoberinsel",english:"Cinnabar Island"},{name:"Route 20",value:82,german:"Route 20",english:"Route 20"},{name:"Route 19",value:83,german:"Route 19",english:"Route 19"},{name:"Route 22",value:84,german:"Route 22",english:"Route 22"},{name:"Route 28",value:85,german:"Route 28",english:"Route 28"},{name:"Mt. Silver",value:86,german:"Silberberg",english:"Mt. Silver"}]},rse:{id:"rse",title:"Ruby, Sapphire and Emerald",nameLimit:10,dexLimit:386,loaded:false,locations:[{name:"Starter",value:0},{name:"Littleroot Town",value:1,german:"Wurzelheim",english:"Littleroot Town"},{name:"Route 101",value:2,german:"Route 101",english:"Route 101"},{name:"Route 102",value:3,german:"Route 102",english:"Route 102"},{name:"Route 103",value:4,german:"Route 103",english:"Route 103"},{name:"Petalburg City",value:5,german:"Blütenburg City",english:"Petalburg City"},{name:"Route 104",value:6,german:"Route 104",english:"Route 104"},{name:"Petalburg Woods",value:7,german:"Blütenburgwald",english:"Petalburg Woods"},{name:"Rustboro City",value:8,german:"Metarost City",english:"Rustboro City"},{name:"Route 115",value:9,german:"Route 115",english:"Route 115"},{name:"Route 116",value:10,german:"Route 116",english:"Route 116"},{name:"Rusturf Tunnel",value:11,german:"Metaflurtunnel",english:"Rusturf Tunnel"},{name:"Dewford Town",value:12,german:"Faustauhaven",english:"Dewford Town"},{name:"Route 106",value:13,german:"Route 106",english:"Route 106"},{name:"Granite Cave",value:14,german:"Granithöhle",english:"Granite Cave"},{name:"Route 107",value:15,german:"Route 107",english:"Route 107"},{name:"Slateport City",value:16,german:"Graphitport City",english:"Slateport City"},{name:"Route 110",value:17,german:"Route 110",english:"Route 110"},{name:"Altering Cave",value:18,german:"Wandelhöhle",english:"Altering Cave"},{name:"New Mauville",value:19,german:"Neu Malvenfroh",english:"New Mauville"},{name:"Route 117",value:20,german:"Route 117",english:"Route 117"},{name:"Route 111",value:21,german:"Route 111",english:"Route 111"},{name:"Mirage Tower (Emerald)",value:22},{name:"Route 112",value:23,german:"Route 112",english:"Route 112"},{name:"Fiery Path",value:24,german:"Feuriger Pfad",english:"Fiery Path"},{name:"Route 113",value:25,german:"Route 113",english:"Route 113"},{name:"Route 114",value:26,german:"Route 114",english:"Route 114"},{name:"Desert Underpass (Emerald)",value:27},{name:"Meteor Falls",value:28,german:"Meteorfälle",english:"Meteor Falls"},{name:"Jagged Pass",value:29,german:"Steilpass",english:"Jagged Pass"},{name:"Lavaridge Town",value:30,german:"Bad Lavastadt",english:"Lavaridge Town"},{name:"Route 118",value:31,german:"Route 118",english:"Route 118"},{name:"Route 119",value:32,german:"Route 119",english:"Route 119"},{name:"Fortree City",value:33,german:"Baumhausen City",english:"Fortree City"},{name:"Route 120",value:34,german:"Route 120",english:"Route 120"},{name:"Route 121",value:35,german:"Route 121",english:"Route 121"},{name:"Safari Zone",value:36,german:"Safari-Zone",english:"Safari Zone"},{name:"Lilycove City",value:37,german:"Seegrasulb City",english:"Lilycove City"},{name:"Route 122",value:38,german:"Route 122",english:"Route 122"},{name:"Mt. Pyre",value:39,german:"Pyroberg",english:"Mt. Pyre"},{name:"Route 123",value:40,german:"Route 123",english:"Route 123"},{name:"Team Magma Hideout (Emerald)",value:41},{name:"Route 124",value:42,german:"Route 124",english:"Route 124"},{name:"Mossdeep City",value:43,german:"Moosbach City",english:"Mossdeep City"},{name:"Route 125",value:44,german:"Route 125",english:"Route 125"},{name:"Shoal Cave",value:45,german:"Küstenhöhle",english:"Shoal Cave"},{name:"Route 127",value:46,german:"Route 127",english:"Route 127"},{name:"Route 128",value:47,german:"Route 128",english:"Route 128"},{name:"Seafloor Cavern",value:48,german:"Tiefseehöhle",english:"Seafloor Cavern"},{name:"Route 126",value:49,german:"Route 126",english:"Route 126"},{name:"Sootopolis City",value:50,german:"Xeneroville",english:"Sootopolis City"},{name:"Cave of Origin",value:51,german:"Urzeithöhle",english:"Cave of Origin"},{name:"Route 129",value:52,german:"Route 129",english:"Route 129"},{name:"Route 130",value:53,german:"Route 130",english:"Route 130"},{name:"Route 131",value:54,german:"Route 131",english:"Route 131"},{name:"Sky Pillar",value:55,german:"Himmelturm",english:"Sky Pillar"},{name:"Pacifidlog Town",value:56,german:"Floßbrunn",english:"Pacifidlog Town"},{name:"Mirage Island",value:57,german:"Wundereiland",english:"Mirage Island"},{name:"Route 105",value:58,german:"Route 105",english:"Route 105"},{name:"Route 108",value:59,german:"Route 108",english:"Route 108"},{name:"Abandoned Ship",value:60,german:"Schiffswrack",english:"Abandoned Ship"},{name:"Route 109",value:61,german:"Route 109",english:"Route 109"},{name:"Route 132",value:62,german:"Route 132",english:"Route 132"},{name:"Route 133",value:63,german:"Route 133",english:"Route 133"},{name:"Route 134",value:64,german:"Route 134",english:"Route 134"},{name:"Ever Grande City",value:65,german:"Prachtpolis City",english:"Ever Grande City"},{name:"Victory Road",value:66,german:"Siegesstraße",english:"Victory Road"},{name:"S.S. Tidal",value:67,german:"MS Tide",english:"S.S. Tidal"},{name:"Battle Frontier",value:68,german:"Kampfzone",english:"Battle Frontier"},{name:"Artisan Cave",value:69,german:"Höhlenatelier",english:"Artisan Cave"}]},frlg:{id:"frlg",title:"FireRed and LeafGreen",nameLimit:10,dexLimit:386,loaded:false,locations:[{name:"Starter",value:0},{name:"Pallet Town",value:1,german:"Alabastia",english:"Pallet Town"},{name:"Route 1",value:2,german:"Route 1",english:"Route 1"},{name:"Viridian City",value:3,german:"Vertania City",english:"Viridian City"},{name:"Route 22",value:4,german:"Route 22",english:"Route 22"},{name:"Route 2",value:5,german:"Route 2",english:"Route 2"},{name:"Viridian Forest",value:6,german:"Vertania-Wald",english:"Viridian Forest"},{name:"Route 3",value:7,german:"Route 3",english:"Route 3"},{name:"Route 4",value:8,german:"Route 4",english:"Route 4"},{name:"Mt. Moon",value:9,german:"Mondberg",english:"Mt. Moon"},{name:"Cerulean City",value:10,german:"Azuria City",english:"Cerulean City"},{name:"Route 24",value:11,german:"Route 24",english:"Route 24"},{name:"Route 25",value:12,german:"Route 25",english:"Route 25"},{name:"Route 5",value:13,german:"Route 5",english:"Route 5"},{name:"Route 6",value:14,german:"Route 6",english:"Route 6"},{name:"Vermillion City",value:15},{name:"Route 11",value:16,german:"Route 11",english:"Route 11"},{name:"Diglett's Cave",value:17,german:"Digdas Höhle",english:"Diglett's Cave"},{name:"Route 9",value:18,german:"Route 9",english:"Route 9"},{name:"Route 10",value:19,german:"Route 10",english:"Route 10"},{name:"Rock Tunnel",value:20,german:"Felstunnel",english:"Rock Tunnel"},{name:"Pokémon Tower",value:21,german:"Pokémon Tower",english:"Pokémon Tower"},{name:"Route 12",value:22,german:"Route 12",english:"Route 12"},{name:"Route 8",value:23,german:"Route 8",english:"Route 8"},{name:"Route 7",value:24,german:"Route 7",english:"Route 7"},{name:"Celadon City",value:25,german:"Prismania City",english:"Celadon City"},{name:"Route 16",value:26,german:"Route 16",english:"Route 16"},{name:"Route 17",value:27,german:"Route 17",english:"Route 17"},{name:"Route 18",value:28,german:"Route 18",english:"Route 18"},{name:"Fuschia City",value:29},{name:"Safari Zone",value:30,german:"Safari-Zone",english:"Safari Zone"},{name:"Route 15",value:31,german:"Route 15",english:"Route 15"},{name:"Route 14",value:32,german:"Route 14",english:"Route 14"},{name:"Route 13",value:33,german:"Route 13",english:"Route 13"},{name:"Power Plant",value:34,german:"Kraftwerk",english:"Power Plant"},{name:"Route 19",value:35,german:"Route 19",english:"Route 19"},{name:"Route 20",value:36,german:"Route 20",english:"Route 20"},{name:"Seafoam Islands",value:37,german:"Seeschauminseln",english:"Seafoam Islands"},{name:"Cinnabar Island",value:38,german:"Zinnoberinsel",english:"Cinnabar Island"},{name:"Pokémon Mansion",value:39,german:"Pokémon Mansion",english:"Pokémon Mansion"},{name:"Route 21",value:40,german:"Route 21",english:"Route 21"},{name:"One Island",value:41,german:"Eiland Eins",english:"One Island"},{name:"Treasure Beach",value:42,german:"Schatzgestade",english:"Treasure Beach"},{name:"Kindle Road",value:43,german:"Glühweg",english:"Kindle Road"},{name:"Mt. Ember",value:44,german:"Glutberg",english:"Mt. Ember"},{name:"Cape Brink",value:45,german:"Kap Kante",english:"Cape Brink"},{name:"Three Isle Port",value:46,german:"Three Isle Port",english:"Three Isle Port"},{name:"Bond Bridge",value:47,german:"Bundbrücke",english:"Bond Bridge"},{name:"Berry Forest",value:48,german:"Beerenforst",english:"Berry Forest"},{name:"Route 23",value:49,german:"Route 23",english:"Route 23"},{name:"Victory Road",value:50,german:"Siegesstraße",english:"Victory Road"},{name:"Four Island",value:51,german:"Eiland Vier",english:"Four Island"},{name:"Icefall Cave",value:52,german:"Eiskaskadenhöhle",english:"Icefall Cave"},{name:"Five Island",value:53,german:"Eiland Fünf",english:"Five Island"},{name:"Five Isle Meadow",value:54,german:"Eiland 5-Weide",english:"Five Isle Meadow"},{name:"Memorial Pillar",value:55,german:"Gedenksäule",english:"Memorial Pillar"},{name:"Water Labyrinth",value:56,german:"Wasserirrgarten",english:"Water Labyrinth"},{name:"Resort Gorgeous",value:57,german:"Ferienparadies",english:"Resort Gorgeous"},{name:"Lost Cave",value:58,german:"Verlorene Höhle",english:"Lost Cave"},{name:"Water Path",value:59,german:"Wasserweg",english:"Water Path"},{name:"Green Path",value:60,german:"Grüner Pfad",english:"Green Path"},{name:"Pattern Bush",value:61,german:"Musterbuschwald",english:"Pattern Bush"},{name:"Outcast Island",value:62,german:"Fern-Eiland",english:"Outcast Island"},{name:"Altering Cave",value:63,german:"Wandelhöhle",english:"Altering Cave"},{name:"Ruin Valley",value:64,german:"Ruinental",english:"Ruin Valley"},{name:"Trainer Tower",value:65,german:"Trainerturm",english:"Trainer Tower"},{name:"Canyon Entrance",value:66,german:"Schluchteingang",english:"Canyon Entrance"},{name:"Seavault Canyon",value:67},{name:"Tanoby Ruins",value:68,german:"Tanibo-Ruinen",english:"Tanoby Ruins"},{name:"Cerulean Cave",value:69,german:"Azuria-Höhle",english:"Cerulean Cave"}]},dpp:{id:"dpp",title:"Diamond, Pearl and Platinum",nameLimit:10,dexLimit:493,loaded:false,locations:[{name:"Starter",value:0},{name:"Twinleaf Town",value:1,german:"Zweiblattdorf",english:"Twinleaf Town"},{name:"Route 201",value:2,german:"Route 201",english:"Route 201"},{name:"Lake Verity",value:3,german:"See der Wahrheit",english:"Lake Verity"},{name:"Route 202",value:4,german:"Route 202",english:"Route 202"},{name:"Route 203",value:5,german:"Route 203",english:"Route 203"},{name:"Oreburgh Gate",value:6,german:"Oreburgh Gate",english:"Oreburgh Gate"},{name:"Oreburgh City",value:7,german:"Erzelingen",english:"Oreburgh City"},{name:"Oreburgh Mine",value:8,german:"Oreburgh Mine",english:"Oreburgh Mine"},{name:"Route 207",value:9,german:"Route 207",english:"Route 207"},{name:"Route 204",value:10,german:"Route 204",english:"Route 204"},{name:"Ravaged Path",value:11,german:"Verwüsteter Pfad",english:"Ravaged Path"},{name:"Floaroma Meadow",value:12,german:"Auen von Flori",english:"Floaroma Meadow"},{name:"Route 205",value:13,german:"Route 205",english:"Route 205"},{name:"Valley Windworks",value:14,german:"Windkraftwerk",english:"Valley Windworks"},{name:"Eterna Forest",value:15,german:"Ewigwald",english:"Eterna Forest"},{name:"The Old Chateau",value:16},{name:"Eterna City",value:17,german:"Ewigenau",english:"Eterna City"},{name:"Route 206",value:18,german:"Route 206",english:"Route 206"},{name:"Wayward Cave",value:19,german:"Bizarre Höhle",english:"Wayward Cave"},{name:"Mt. Coronet",value:20,german:"Mt. Coronet",english:"Mt. Coronet"},{name:"Route 208",value:21,german:"Route 208",english:"Route 208"},{name:"Hearthome City",value:22,german:"Herzhofen",english:"Hearthome City"},{name:"Route 209",value:23,german:"Route 209",english:"Route 209"},{name:"The Lost Tower",value:24},{name:"Solaceon Ruins",value:25,german:"Solaceon Ruins",english:"Solaceon Ruins"},{name:"Route 210",value:26,german:"Route 210",english:"Route 210"},{name:"Route 215",value:27,german:"Route 215",english:"Route 215"},{name:"Veilstone City",value:28,german:"Schleiede",english:"Veilstone City"},{name:"Route 212",value:29,german:"Route 212",english:"Route 212"},{name:"Trophy Garden",value:30,german:"Trophäengarten",english:"Trophy Garden"},{name:"Pastoria City",value:31,german:"Weideburg",english:"Pastoria City"},{name:"Great Marsh",value:32,german:"Großmoor",english:"Great Marsh"},{name:"Route 213",value:33,german:"Route 213",english:"Route 213"},{name:"Valor Lakefront",value:34,german:"Valor Lakefront",english:"Valor Lakefront"},{name:"Lake Valor",value:35,german:"See der Kühnheit",english:"Lake Valor"},{name:"Route 214",value:36,german:"Route 214",english:"Route 214"},{name:"Ruin Maniac's Cave",value:37},{name:"Ruin Maniac's Tunnel",value:38},{name:"Celestic Town",value:39,german:"Elyses",english:"Celestic Town"},{name:"Fuego Ironworks",value:40,german:"Feuriohütte",english:"Fuego Ironworks"},{name:"Routes 219",value:41},{name:"Route 220",value:42},{name:"Route 221",value:43,german:"Route 221",english:"Route 221"},{name:"Route 218",value:44,german:"Route 218",english:"Route 218"},{name:"Canalave City",value:45,german:"Fleetburg",english:"Canalave City"},{name:"Iron Island",value:46,german:"Eiseninsel",english:"Iron Island"},{name:"Route 211",value:47,german:"Route 211",english:"Route 211"},{name:"Route 216",value:48,german:"Route 216",english:"Route 216"},{name:"Route 217",value:49,german:"Route 217",english:"Route 217"},{name:"Acuity Lakefront",value:50,german:"Acuity Lakefront",english:"Acuity Lakefront"},{name:"Lake Acuity",value:51,german:"See der Stärke",english:"Lake Acuity"},{name:"Snowpoint Temple",value:52,german:"Snowpoint Temple",english:"Snowpoint Temple"},{name:"Route 222",value:53,german:"Route 222",english:"Route 222"},{name:"Sunyshore City",value:54,german:"Sonnewik",english:"Sunyshore City"},{name:"Route 223",value:55},{name:"Pokémon League",value:56,german:"Pokémon League",english:"Pokémon League"},{name:"Victory Road",value:57,german:"Siegesstraße",english:"Victory Road"},{name:"Route 224",value:58,german:"Route 224",english:"Route 224"},{name:"Route 230",value:59},{name:"Route 229",value:60,german:"Route 229",english:"Route 229"},{name:"Resort Area",value:61,german:"Erholungsgebiet",english:"Resort Area"},{name:"Route 228",value:62,german:"Route 228",english:"Route 228"},{name:"Route 226",value:63},{name:"Route 227",value:64,german:"Route 227",english:"Route 227"},{name:"Stark Mountain",value:65,german:"Kahlberg",english:"Stark Mountain"},{name:"Route 225",value:66,german:"Route 225",english:"Route 225"},{name:"Sendoff Spring",value:67,german:"Scheidequelle",english:"Sendoff Spring"},{name:"Turnback Cave",value:68,german:"Höhle der Umkehr",english:"Turnback Cave"},{name:"Distortion World",value:69,german:"Zerrwelt",english:"Distortion World"},{name:"Spear Pillar",value:70,german:"Speersäule",english:"Spear Pillar"},{name:"Newmoon Island",value:71,german:"Neumond-Insel",english:"Newmoon Island"},{name:"Flower Paradise",value:72,german:"Blumenparadies",english:"Flower Paradise"},{name:"Hall of Origin",value:73,german:"Halle des Beginns",english:"Hall of Origin"}]},hgss:{id:"hgss",title:"HeartGold and SoulSilver",nameLimit:10,dexLimit:493,loaded:false,locations:[{name:"Starter",value:0},{name:"New Bark Town",value:1,german:"Neuborkia",english:"New Bark Town"},{name:"Route 29",value:2,german:"Route 29",english:"Route 29"},{name:"Cherrygrove City",value:3,german:"Rosalia City",english:"Cherrygrove City"},{name:"Route 30",value:4,german:"Route 30",english:"Route 30"},{name:"Route 31",value:5,german:"Route 31",english:"Route 31"},{name:"Dark Cave",value:6,german:"Dunkelhöhle",english:"Dark Cave"},{name:"Violet City",value:7,german:"Viola City",english:"Violet City"},{name:"Sprout Tower",value:8,german:"Knofensa-Turm",english:"Sprout Tower"},{name:"Route 32",value:9,german:"Route 32",english:"Route 32"},{name:"Ruins of Alph",value:10,german:"Alph-Ruinen",english:"Ruins of Alph"},{name:"Union Cave",value:11,german:"Einheitstunnel",english:"Union Cave"},{name:"Route 33",value:12,german:"Route 33",english:"Route 33"},{name:"Azalea Town",value:13,german:"Azalea City",english:"Azalea Town"},{name:"Slowpoke Well",value:14,german:"Flegmon-Brunnen",english:"Slowpoke Well"},{name:"Ilex Forest",value:15,german:"Steineichenwald",english:"Ilex Forest"},{name:"Route 34",value:16,german:"Route 34",english:"Route 34"},{name:"Goldenrod City",value:17,german:"Dukatia City",english:"Goldenrod City"},{name:"Route 35",value:18,german:"Route 35",english:"Route 35"},{name:"National Park",value:19,german:"Nationalpark",english:"National Park"},{name:"Route 36",value:20,german:"Route 36",english:"Route 36"},{name:"Route 37",value:21,german:"Route 37",english:"Route 37"},{name:"Ecruteak City",value:22,german:"Teak City",english:"Ecruteak City"},{name:"Burned Tower",value:23,german:"Burned Tower",english:"Burned Tower"},{name:"Bell Tower",value:24,german:"Glockenturm",english:"Bell Tower"},{name:"Route 38",value:25,german:"Route 38",english:"Route 38"},{name:"Route 39",value:26,german:"Route 39",english:"Route 39"},{name:"Olivine City",value:27,german:"Oliviana City",english:"Olivine City"},{name:"Route 40",value:28},{name:"Route 41",value:29},{name:"Whirl Islands",value:30,german:"Strudelinseln",english:"Whirl Islands"},{name:"Cianwood City",value:31,german:"Anemonia City",english:"Cianwood City"},{name:"Cliff Edge Gate",value:32,german:"Felsklippentor",english:"Cliff Edge Gate"},{name:"Route 47",value:33,german:"Route 47",english:"Route 47"},{name:"Cliff Cave",value:34,german:"Felsschlundhöhle",english:"Cliff Cave"},{name:"Route 48",value:35,german:"Route 48",english:"Route 48"},{name:"Safari Zone Gate",value:36,german:"Safari-Eingang",english:"Safari Zone Gate"},{name:"Safari Zone",value:37,german:"Safari-Zone",english:"Safari Zone"},{name:"Route 42",value:38,german:"Route 42",english:"Route 42"},{name:"Mt. Mortar",value:39,german:"Kesselberg",english:"Mt. Mortar"},{name:"Mahogany Town",value:40,german:"Mahagonia City",english:"Mahogany Town"},{name:"Rocket Hideout",value:41},{name:"Route 43",value:42,german:"Route 43",english:"Route 43"},{name:"Lake of Rage",value:43,german:"See des Zorns",english:"Lake of Rage"},{name:"Route 44",value:44,german:"Route 44",english:"Route 44"},{name:"Ice Path",value:45,german:"Eispfad",english:"Ice Path"},{name:"Blackthorn City",value:46,german:"Ebenholz City",english:"Blackthorn City"},{name:"Dragon's Den",value:47,german:"Drachenhöhle",english:"Dragon's Den"},{name:"Route 45",value:48,german:"Route 45",english:"Route 45"},{name:"Dark Cave 2",value:49},{name:"Route 46",value:50,german:"Route 46",english:"Route 46"},{name:"Route 27",value:51,german:"Route 27",english:"Route 27"},{name:"Tohjo Falls",value:52,german:"Tohjo-Fälle",english:"Tohjo Falls"},{name:"Route 26",value:53,german:"Route 26",english:"Route 26"},{name:"Victory Road",value:54,german:"Siegesstraße",english:"Victory Road"},{name:"Indigo Plateau",value:55,german:"Indigo Plateau",english:"Indigo Plateau"},{name:"Vermillion City",value:56},{name:"Route 6",value:57,german:"Route 6",english:"Route 6"},{name:"Saffron City",value:58,german:"Saffronia City",english:"Saffron City"},{name:"Route 5",value:59,german:"Route 5",english:"Route 5"},{name:"Route 7",value:60,german:"Route 7",english:"Route 7"},{name:"Route 8",value:61,german:"Route 8",english:"Route 8"},{name:"Route 10",value:62,german:"Route 10",english:"Route 10"},{name:"Power Plant",value:63,german:"Kraftwerk",english:"Power Plant"},{name:"Rock Tunnel",value:64,german:"Felstunnel",english:"Rock Tunnel"},{name:"Route 9",value:65,german:"Route 9",english:"Route 9"},{name:"Cerulean City",value:66,german:"Azuria City",english:"Cerulean City"},{name:"Route 24",value:67,german:"Route 24",english:"Route 24"},{name:"Route 25",value:68,german:"Route 25",english:"Route 25"},{name:"Route 4",value:69,german:"Route 4",english:"Route 4"},{name:"Route 16",value:70,german:"Route 16",english:"Route 16"},{name:"Route 17",value:71,german:"Route 17",english:"Route 17"},{name:"Route 18",value:72,german:"Route 18",english:"Route 18"},{name:"Fuschia City",value:73},{name:"Route 15",value:74,german:"Route 15",english:"Route 15"},{name:"Route 14",value:75,german:"Route 14",english:"Route 14"},{name:"Route 13",value:76,german:"Route 13",english:"Route 13"},{name:"Route 12",value:77,german:"Route 12",english:"Route 12"},{name:"Route 11",value:78,german:"Route 11",english:"Route 11"},{name:"Diglett's Cave",value:79,german:"Digdas Höhle",english:"Diglett's Cave"},{name:"Route 2",value:80,german:"Route 2",english:"Route 2"},{name:"Pewter City",value:81,german:"Marmoria City",english:"Pewter City"},{name:"Route 3",value:82,german:"Route 3",english:"Route 3"},{name:"Mt. Moon",value:83,german:"Mondberg",english:"Mt. Moon"},{name:"Viridian City",value:84,german:"Vertania City",english:"Viridian City"},{name:"Route 1",value:85,german:"Route 1",english:"Route 1"},{name:"Pallet Town",value:86,german:"Alabastia",english:"Pallet Town"},{name:"Route 21",value:87,german:"Route 21",english:"Route 21"},{name:"Cinnabar Island",value:88,german:"Zinnoberinsel",english:"Cinnabar Island"},{name:"Route 20",value:89,german:"Route 20",english:"Route 20"},{name:"Route 19",value:90,german:"Route 19",english:"Route 19"},{name:"Route 22",value:91,german:"Route 22",english:"Route 22"},{name:"Route 28",value:92,german:"Route 28",english:"Route 28"},{name:"Mt. Silver",value:93,german:"Silberberg",english:"Mt. Silver"},{name:"Cerulean Cave",value:94,german:"Azuria-Höhle",english:"Cerulean Cave"}]},bw:{id:"bw",title:"Black and White",nameLimit:10,dexLimit:649,loaded:false,locations:[{name:"Starter",value:0},{name:"Nuvema Town",value:1,german:"Avenitia",english:"Nuvema Town"},{name:"Route 1",value:2,german:"Route 1",english:"Route 1"},{name:"Accumula Town",value:3,german:"Gavina",english:"Accumula Town"},{name:"Route 2",value:4,german:"Route 2",english:"Route 2"},{name:"Striaton City",value:5,german:"Orion City",english:"Striaton City"},{name:"Dreamyard",value:6,german:"Traumbrache",english:"Dreamyard"},{name:"Route 3",value:7,german:"Route 3",english:"Route 3"},{name:"Wellspring Cave",value:8,german:"Grundwassersenke",english:"Wellspring Cave"},{name:"Nacrene City",value:9,german:"Septerna City",english:"Nacrene City"},{name:"Pinwheel Forest",value:10,german:"Ewigenwald",english:"Pinwheel Forest"},{name:"Castelia City",value:11,german:"Stratos City",english:"Castelia City"},{name:"Route 4",value:12,german:"Route 4",english:"Route 4"},{name:"Desert Resort",value:13,german:"Wüstenresort",english:"Desert Resort"},{name:"Relic Castle",value:14,german:"Alter Palast",english:"Relic Castle"},{name:"Route 16",value:15,german:"Route 16",english:"Route 16"},{name:"Route 5",value:16,german:"Route 5",english:"Route 5"},{name:"Driftveil Drawbridge",value:17,german:"Marea-Zugbrücke",english:"Driftveil Drawbridge"},{name:"Driftveil City",value:18,german:"Marea City",english:"Driftveil City"},{name:"Cold Storage",value:19,german:"Tiefkühlcontainer",english:"Cold Storage"},{name:"Route 6",value:20,german:"Route 6",english:"Route 6"},{name:"Mistralton Cave",value:21,german:"Panaero-Höhle",english:"Mistralton Cave"},{name:"Chargestone Cave",value:22,german:"Elektrolithhöhle",english:"Chargestone Cave"},{name:"Route 7",value:23,german:"Route 7",english:"Route 7"},{name:"Celestial Tower",value:24,german:"Turm des Himmels",english:"Celestial Tower"},{name:"Twist Mountain",value:25,german:"Wendelberg",english:"Twist Mountain"},{name:"Iccirus City",value:26},{name:"Dragonspiral Tower",value:27,german:"Drachenstiege",english:"Dragonspiral Tower"},{name:"Route 8",value:28,german:"Route 8",english:"Route 8"},{name:"Moor of Icirrus",value:29,german:"Moor von Nevaio",english:"Moor of Icirrus"},{name:"Route 9",value:30,german:"Route 9",english:"Route 9"},{name:"Route 10",value:31,german:"Route 10",english:"Route 10"},{name:"Victory Road",value:32,german:"Siegesstraße",english:"Victory Road"},{name:"Route 11",value:33,german:"Route 11",english:"Route 11"},{name:"Village Bridge",value:34,german:"Dorfbrücke",english:"Village Bridge"},{name:"Route 12",value:35,german:"Route 12",english:"Route 12"},{name:"Route 13",value:36,german:"Route 13",english:"Route 13"},{name:"Undella Town",value:37,german:"Ondula",english:"Undella Town"},{name:"Undella Bay",value:38,german:"Bucht von Ondula",english:"Undella Bay"},{name:"Route 14",value:39,german:"Route 14",english:"Route 14"},{name:"Abundant Shrine",value:40,german:"Schrein der Ernte",english:"Abundant Shrine"},{name:"White Forest",value:41,german:"Weiße Wald",english:"White Forest"},{name:"Route 15",value:42,german:"Route 15",english:"Route 15"},{name:"Marvelous Bridge",value:43,german:"Wunderbrücke",english:"Marvelous Bridge"},{name:"Lostlorn Forest",value:44,german:"Hain der Täuschung",english:"Lostlorn Forest"},{name:"Route 17",value:45,german:"Route 17",english:"Route 17"},{name:"Route 18",value:46,german:"Route 18",english:"Route 18"},{name:"P2 Laboratory",value:47,german:"P2-Labor",english:"P2 Laboratory"},{name:"Liberty Garden",value:48,german:"Freiheitsgarten",english:"Liberty Garden"}]},bw2:{id:"bw2",title:"Black 2 and White 2",nameLimit:10,dexLimit:649,loaded:false,locations:[{name:"Starter",value:0},{name:"Aspertia City",value:1,german:"Eventura City",english:"Aspertia City"},{name:"Route 19",value:2,german:"Route 19",english:"Route 19"},{name:"Floccesy Town",value:3,german:"Dausing",english:"Floccesy Town"},{name:"Route 20",value:4,german:"Route 20",english:"Route 20"},{name:"Floccesy Ranch",value:5,german:"Dausing-Hof",english:"Floccesy Ranch"},{name:"Aspertia Gym",value:6},{name:"Virbank City",value:7,german:"Vapydro City",english:"Virbank City"},{name:"Virbank Complex",value:8,german:"Vapydro-Werke",english:"Virbank Complex"},{name:"Castelia City",value:9,german:"Stratos City",english:"Castelia City"},{name:"Castelia Sewers",value:10,german:"Stratos-Kanalisation",english:"Castelia Sewers"},{name:"Relic Passage",value:11,german:"Alter Fluchtweg",english:"Relic Passage"},{name:"Route 4",value:12,german:"Route 4",english:"Route 4"},{name:"Desert Resort",value:13,german:"Wüstenresort",english:"Desert Resort"},{name:"Relic Castle",value:14,german:"Alter Palast",english:"Relic Castle"},{name:"Route 16",value:15,german:"Route 16",english:"Route 16"},{name:"Lostlorn Forest",value:16,german:"Hain der Täuschung",english:"Lostlorn Forest"},{name:"Route 5",value:17,german:"Route 5",english:"Route 5"},{name:"Driftveil Drawbridge",value:18,german:"Marea-Zugbrücke",english:"Driftveil Drawbridge"},{name:"Driftveil City",value:19,german:"Marea City",english:"Driftveil City"},{name:"Route 6",value:20,german:"Route 6",english:"Route 6"},{name:"Mistralton Cave",value:21,german:"Panaero-Höhle",english:"Mistralton Cave"},{name:"Chargestone Cave",value:22,german:"Elektrolithhöhle",english:"Chargestone Cave"},{name:"Route 7",value:23,german:"Route 7",english:"Route 7"},{name:"Celestial Tower",value:24,german:"Turm des Himmels",english:"Celestial Tower"},{name:"Reversal Mountain",value:25,german:"Janusberg",english:"Reversal Mountain"},{name:"Strange House",value:26,german:"Bizarro-Haus",english:"Strange House"},{name:"Undella Town",value:27,german:"Ondula",english:"Undella Town"},{name:"Undella Bay",value:28,german:"Bucht von Ondula",english:"Undella Bay"},{name:"Route 13",value:29,german:"Route 13",english:"Route 13"},{name:"Route 12",value:30,german:"Route 12",english:"Route 12"},{name:"Village Bridge",value:31,german:"Dorfbrücke",english:"Village Bridge"},{name:"Route 11",value:32,german:"Route 11",english:"Route 11"},{name:"Route 9",value:33,german:"Route 9",english:"Route 9"},{name:"Seaside Cave",value:34,german:"Strandgrotte",english:"Seaside Cave"},{name:"Route 21",value:35,german:"Route 21",english:"Route 21"},{name:"Humilau City",value:36,german:"Abidaya City",english:"Humilau City"},{name:"Route 22",value:37,german:"Route 22",english:"Route 22"},{name:"Giant Chasm",value:38,german:"Riesengrotte",english:"Giant Chasm"},{name:"Route 23",value:39,german:"Route 23",english:"Route 23"},{name:"Victory Road",value:40,german:"Siegesstraße",english:"Victory Road"},{name:"Old Victory Road",value:41},{name:"Marvelous Bridge",value:42,german:"Wunderbrücke",english:"Marvelous Bridge"},{name:"Route 15",value:43,german:"Route 15",english:"Route 15"},{name:"Route 14",value:44,german:"Route 14",english:"Route 14"},{name:"Abundant Shrine",value:45,german:"Schrein der Ernte",english:"Abundant Shrine"},{name:"Moor of Icirrus",value:46,german:"Moor von Nevaio",english:"Moor of Icirrus"},{name:"Icirrus City",value:47,german:"Nevaio City",english:"Icirrus City"},{name:"Dragonspiral Tower",value:48,german:"Drachenstiege",english:"Dragonspiral Tower"},{name:"Twist Mountain",value:49,german:"Wendelberg",english:"Twist Mountain"},{name:"Clay Tunnel",value:50,german:"Turner-Pfad",english:"Clay Tunnel"},{name:"Underground Ruins",value:51,german:"Unterirdische Ruine",english:"Underground Ruins"},{name:"Pinwheel Forest",value:52,german:"Ewigenwald",english:"Pinwheel Forest"},{name:"Nacrene City",value:53,german:"Septerna City",english:"Nacrene City"},{name:"Route 3",value:54,german:"Route 3",english:"Route 3"},{name:"Wellspring Cave",value:55,german:"Grundwassersenke",english:"Wellspring Cave"},{name:"Striaton City",value:56,german:"Orion City",english:"Striaton City"},{name:"Dreamyard",value:57,german:"Traumbrache",english:"Dreamyard"},{name:"Route 2",value:58,german:"Route 2",english:"Route 2"},{name:"Accumula Town",value:59,german:"Gavina",english:"Accumula Town"},{name:"Route 1",value:60,german:"Route 1",english:"Route 1"},{name:"Route 17",value:61,german:"Route 17",english:"Route 17"},{name:"Route 18",value:62,german:"Route 18",english:"Route 18"},{name:"P2 Laboratory",value:63,german:"P2-Labor",english:"P2 Laboratory"},{name:"Nature Preserve",value:64}]},xy:{id:"xy",title:"X and Y",nameLimit:12,dexLimit:721,loaded:false,locations:[{name:"Starter",value:0},{name:"Aquacorde Town",value:1,german:"Aquarellia",english:"Aquacorde Town"},{name:"Route 2",value:2,german:"Route 2",english:"Route 2"},{name:"Santalune Forest",value:3,german:"Nouvaria-Wald",english:"Santalune Forest"},{name:"Route 3",value:4,german:"Route 3",english:"Route 3"},{name:"Route 22",value:5,german:"Route 22",english:"Route 22"},{name:"Route 4",value:6,german:"Route 4",english:"Route 4"},{name:"Lumiose City",value:7,german:"Illumina City",english:"Lumiose City"},{name:"Route 5",value:8,german:"Route 5",english:"Route 5"},{name:"Route 6",value:9,german:"Route 6",english:"Route 6"},{name:"Parfum Palace",value:10,german:"Magnum-Opus-Palast",english:"Parfum Palace"},{name:"Route 7",value:11,german:"Route 7",english:"Route 7"},{name:"Battle Chateau",value:12,german:"Kampfschloss",english:"Battle Chateau"},{name:"Connecting Cave",value:13,german:"Geolinkhöhle",english:"Connecting Cave"},{name:"Route 8",value:14,german:"Route 8",english:"Route 8"},{name:"Ambrette Town",value:15,german:"Petrophia",english:"Ambrette Town"},{name:"Route 9",value:16,german:"Route 9",english:"Route 9"},{name:"Glittering Cave",value:17,german:"Leuchthöhle",english:"Glittering Cave"},{name:"Cyllage City",value:18,german:"Relievera City",english:"Cyllage City"},{name:"Route 10",value:19,german:"Route 10",english:"Route 10"},{name:"Route 11",value:20,german:"Route 11",english:"Route 11"},{name:"Reflection Cave",value:21,german:"Spiegelhöhle",english:"Reflection Cave"},{name:"Shalour City",value:22,german:"Yantara City",english:"Shalour City"},{name:"Tower of Mystery",value:23},{name:"Route 12",value:24,german:"Route 12",english:"Route 12"},{name:"Azure Bay",value:25,german:"Azurbucht",english:"Azure Bay"},{name:"Route 13",value:26,german:"Route 13",english:"Route 13"},{name:"Route 14",value:27,german:"Route 14",english:"Route 14"},{name:"Laverre City",value:28,german:"Romantia City",english:"Laverre City"},{name:"Route 15",value:29,german:"Route 15",english:"Route 15"},{name:"Lost Hotel",value:30,german:"Hotelruine",english:"Lost Hotel"},{name:"Route 16",value:31,german:"Route 16",english:"Route 16"},{name:"Frost Cavern",value:32,german:"Frosthöhle",english:"Frost Cavern"},{name:"Route 17",value:33,german:"Route 17",english:"Route 17"},{name:"Team Flare Secret HQ",value:34,german:"Flare-Geheimbasis",english:"Team Flare Secret HQ"},{name:"Route 18",value:35,german:"Route 18",english:"Route 18"},{name:"Couriway Town",value:36,german:"Mosaia",english:"Couriway Town"},{name:"Route 19",value:37,german:"Route 19",english:"Route 19"},{name:"Route 20",value:38,german:"Route 20",english:"Route 20"},{name:"Pokémon Village",value:39,german:"Pokémon Village",english:"Pokémon Village"},{name:"Route 21",value:40,german:"Route 21",english:"Route 21"},{name:"Victory Road",value:41,german:"Siegesstraße",english:"Victory Road"},{name:"Terminus Cave",value:42,german:"Omega-Höhle",english:"Terminus Cave"},{name:"Sea Spirit's Den",value:43},{name:"Friend Safari",value:44,german:"Kontaktsafari",english:"Friend Safari"}]},oras:{id:"oras",title:"Omega Ruby and Alpha Sapphire",nameLimit:12,dexLimit:721,loaded:false,locations:[{name:"Starter",value:0},{name:"Littleroot Town",value:1,german:"Wurzelheim",english:"Littleroot Town"},{name:"Route 101",value:2,german:"Route 101",english:"Route 101"},{name:"Route 102",value:3,german:"Route 102",english:"Route 102"},{name:"Route 103",value:4,german:"Route 103",english:"Route 103"},{name:"Petalburg City",value:5,german:"Blütenburg City",english:"Petalburg City"},{name:"Route 104",value:6,german:"Route 104",english:"Route 104"},{name:"Petalburg Woods",value:7,german:"Blütenburgwald",english:"Petalburg Woods"},{name:"Rustboro City",value:8,german:"Metarost City",english:"Rustboro City"},{name:"Route 115",value:9,german:"Route 115",english:"Route 115"},{name:"Route 116",value:10,german:"Route 116",english:"Route 116"},{name:"Rusturf Tunnel",value:11,german:"Metaflurtunnel",english:"Rusturf Tunnel"},{name:"Dewford Town",value:12,german:"Faustauhaven",english:"Dewford Town"},{name:"Route 106",value:13,german:"Route 106",english:"Route 106"},{name:"Granite Cave",value:14,german:"Granithöhle",english:"Granite Cave"},{name:"Route 107",value:15,german:"Route 107",english:"Route 107"},{name:"Slateport City",value:16,german:"Graphitport City",english:"Slateport City"},{name:"Route 110",value:17,german:"Route 110",english:"Route 110"},{name:"Altering Cave",value:18,german:"Wandelhöhle",english:"Altering Cave"},{name:"New Mauville",value:19,german:"Neu Malvenfroh",english:"New Mauville"},{name:"Route 117",value:20,german:"Route 117",english:"Route 117"},{name:"Route 111",value:21,german:"Route 111",english:"Route 111"},{name:"Route 112",value:22,german:"Route 112",english:"Route 112"},{name:"Fiery Path",value:23,german:"Feuriger Pfad",english:"Fiery Path"},{name:"Route 113",value:24,german:"Route 113",english:"Route 113"},{name:"Route 114",value:25,german:"Route 114",english:"Route 114"},{name:"Meteor Falls",value:26,german:"Meteorfälle",english:"Meteor Falls"},{name:"Jagged Pass",value:27,german:"Steilpass",english:"Jagged Pass"},{name:"Lavaridge Town",value:28,german:"Bad Lavastadt",english:"Lavaridge Town"},{name:"Route 118",value:29,german:"Route 118",english:"Route 118"},{name:"Southern Island",value:30,german:"Insel im Süden",english:"Southern Island"},{name:"Route 119",value:31,german:"Route 119",english:"Route 119"},{name:"Fortree City",value:32,german:"Baumhausen City",english:"Fortree City"},{name:"Route 120",value:33,german:"Route 120",english:"Route 120"},{name:"Route 121",value:34,german:"Route 121",english:"Route 121"},{name:"Safari Zone",value:35,german:"Safari-Zone",english:"Safari Zone"},{name:"Lilycove City",value:36,german:"Seegrasulb City",english:"Lilycove City"},{name:"Route 122",value:37,german:"Route 122",english:"Route 122"},{name:"Mt. Pyre",value:38,german:"Pyroberg",english:"Mt. Pyre"},{name:"Route 123",value:39,german:"Route 123",english:"Route 123"},{name:"Team Aqua/Magma Hideout Entrance",value:40},{name:"Route 124",value:41,german:"Route 124",english:"Route 124"},{name:"Mossdeep City",value:42,german:"Moosbach City",english:"Mossdeep City"},{name:"Route 125",value:43,german:"Route 125",english:"Route 125"},{name:"Shoal Cave",value:44,german:"Küstenhöhle",english:"Shoal Cave"},{name:"Route 127",value:45,german:"Route 127",english:"Route 127"},{name:"Route 128",value:46,german:"Route 128",english:"Route 128"},{name:"Seafloor Cavern",value:47,german:"Tiefseehöhle",english:"Seafloor Cavern"},{name:"Route 126",value:48,german:"Route 126",english:"Route 126"},{name:"Sootopolis City",value:49,german:"Xeneroville",english:"Sootopolis City"},{name:"Cave of Origin",value:50,german:"Urzeithöhle",english:"Cave of Origin"},{name:"Soaring",value:51},{name:"Route 129",value:52,german:"Route 129",english:"Route 129"},{name:"Route 130",value:53,german:"Route 130",english:"Route 130"},{name:"Route 131",value:54,german:"Route 131",english:"Route 131"},{name:"Sky Pillar",value:55,german:"Himmelturm",english:"Sky Pillar"},{name:"Pacifidlog Town",value:56,german:"Floßbrunn",english:"Pacifidlog Town"},{name:"Mirage Island",value:57,german:"Wundereiland",english:"Mirage Island"},{name:"Route 105",value:58,german:"Route 105",english:"Route 105"},{name:"Route 108",value:59,german:"Route 108",english:"Route 108"},{name:"Abandoned Ship",value:60,german:"Schiffswrack",english:"Abandoned Ship"},{name:"Route 109",value:61,german:"Route 109",english:"Route 109"},{name:"Route 132",value:62,german:"Route 132",english:"Route 132"},{name:"Route 133",value:63,german:"Route 133",english:"Route 133"},{name:"Route 134",value:64,german:"Route 134",english:"Route 134"},{name:"Ever Grande City",value:65,german:"Prachtpolis City",english:"Ever Grande City"},{name:"Victory Road",value:66,german:"Siegesstraße",english:"Victory Road"},{name:"S.S. Tidal",value:67,german:"MS Tide",english:"S.S. Tidal"},{name:"Pathless Plain",value:68,german:"Namenlose Ebene",english:"Pathless Plain"},{name:"Nameless Cavern",value:69,german:"Unerforschte Höhle",english:"Nameless Cavern"},{name:"Fabled Cave",value:70,german:"Rätselhafte Höhle",english:"Fabled Cave"},{name:"Gnarled Den",value:71,german:"Höhle der Spaltung",english:"Gnarled Den"},{name:"Trackless Forest",value:72,german:"Wilder Wald",english:"Trackless Forest"},{name:"Crescent Isle",value:73,german:"Sichelinsel",english:"Crescent Isle"},{name:"Battle Resort",value:74,german:"Battle Resort",english:"Battle Resort"},{name:"Mirage Cave",value:75,german:"Wunderhöhle",english:"Mirage Cave"},{name:"Mirage Forest",value:76,german:"Wunderwald",english:"Mirage Forest"},{name:"Mirage Island",value:77,german:"Wundereiland",english:"Mirage Island"},{name:"Mirage Mountain",value:78,german:"Wunderberg",english:"Mirage Mountain"}]},sm:{id:"sm",title:"Sun and Moon",nameLimit:12,dexLimit:802,loaded:false,locations:[{name:"Starter",value:0},{name:"Hau'oli Outskirts",value:1},{name:"Iki Town",value:2,german:"Lili'i",english:"Iki Town"},{name:"Route 1",value:3,german:"Route 1",english:"Route 1"},{name:"Melemele Sea",value:4,german:"Meer von Mele-Mele",english:"Melemele Sea"},{name:"Hau'oli City",value:5},{name:"Route 2",value:6,german:"Route 2",english:"Route 2"},{name:"Berry Fields",value:7,german:"Beerenfelder",english:"Berry Fields"},{name:"Verdant Cavern",value:8,german:"Vegetationshöhle",english:"Verdant Cavern"},{name:"Hau'oli Cemetery",value:9},{name:"Route 3",value:10,german:"Route 3",english:"Route 3"},{name:"Melemele Meadow",value:11,german:"Mele-Mele-Blumenmeer",english:"Melemele Meadow"},{name:"Seaward Cave",value:12,german:"Meereshöhle",english:"Seaward Cave"},{name:"Kala'e Bay",value:13},{name:"Ten Carat Hill",value:14,german:"Tenkarat-Hügel",english:"Ten Carat Hill"},{name:"Hano Beach",value:15,german:"Hanohano-Strand",english:"Hano Beach"},{name:"Route 4",value:16,german:"Route 4",english:"Route 4"},{name:"Paniola Town",value:17,german:"Ohana",english:"Paniola Town"},{name:"Paniola Ranch",value:18,german:"Ohana-Farm",english:"Paniola Ranch"},{name:"Route 5",value:19,german:"Route 5",english:"Route 5"},{name:"Brooklet Hill",value:20,german:"Plätscherhügel",english:"Brooklet Hill"},{name:"Route 6",value:21,german:"Route 6",english:"Route 6"},{name:"Route 7",value:22,german:"Route 7",english:"Route 7"},{name:"Wela Volcano Park",value:23,german:"Wela-Vulkanpark",english:"Wela Volcano Park"},{name:"Route 8",value:24,german:"Route 8",english:"Route 8"},{name:"Fossil Restoration Center",value:25},{name:"Lush Jungle",value:26,german:"Schattendschungel",english:"Lush Jungle"},{name:"Diglett's Tunnel",value:27},{name:"Route 9",value:28,german:"Route 9",english:"Route 9"},{name:"Konikoni City",value:29,german:"Konikoni City",english:"Konikoni City"},{name:"Memorial Hill",value:30,german:"Hügel des Gedenkens",english:"Memorial Hill"},{name:"Akala Outskirts",value:31,german:"Akala-Küstenstreifen",english:"Akala Outskirts"},{name:"Malie City",value:32,german:"Malihe City",english:"Malie City"},{name:"Malie Garden",value:33,german:"Malihe-Ziergarten",english:"Malie Garden"},{name:"Route 10",value:34,german:"Route 10",english:"Route 10"},{name:"Mount Hokulani",value:35,german:"Hokulani-Berg",english:"Mount Hokulani"},{name:"Route 11",value:36,german:"Route 11",english:"Route 11"},{name:"Route 12",value:37,german:"Route 12",english:"Route 12"},{name:"Secluded Shore",value:38,german:"Küste von Ula-Ula",english:"Secluded Shore"},{name:"Blush Mountain",value:39,german:"Glühberg",english:"Blush Mountain"},{name:"Route 13",value:40,german:"Route 13",english:"Route 13"},{name:"Haina Desert",value:41,german:"Haina-Wüste",english:"Haina Desert"},{name:"Tapu Village",value:42,german:"Dorf der Kapu",english:"Tapu Village"},{name:"Route 15",value:43,german:"Route 15",english:"Route 15"},{name:"Aether House",value:44},{name:"Route 14",value:45,german:"Route 14",english:"Route 14"},{name:"Thrifty Megamart",value:46,german:"Schnäppchenparadies",english:"Thrifty Megamart"},{name:"Route 16",value:47,german:"Route 16",english:"Route 16"},{name:"Ula'ula Meadow",value:48},{name:"Lake of the Moone/Sunne",value:49},{name:"Route 17",value:50,german:"Route 17",english:"Route 17"},{name:"Shady House",value:51,german:"Lottervilla",english:"Shady House"},{name:"Seafolk Village",value:52,german:"Dorf des Seevolkes",english:"Seafolk Village"},{name:"Poni Wilds",value:53,german:"Wildnis von Poni",english:"Poni Wilds"},{name:"Ancient Poni Path",value:54,german:"Alter Pfad von Poni",english:"Ancient Poni Path"},{name:"Poni Breaker Coast",value:55,german:"Felsenküste von Poni",english:"Poni Breaker Coast"},{name:"Exeggutor Island",value:56,german:"Kokowei-Eiland",english:"Exeggutor Island"},{name:"Vast Poni Canyon",value:57,german:"Canyon von Poni",english:"Vast Poni Canyon"},{name:"Altar of the Moone/Sunne",value:58},{name:"Mount Lanakila",value:59,german:"Mount Lanakila",english:"Mount Lanakila"},{name:"Poni Grove",value:60,german:"Wald von Poni",english:"Poni Grove"},{name:"Poni Plains",value:61,german:"Ebene von Poni",english:"Poni Plains"},{name:"Poni Meadow",value:62,german:"Poni-Blumenmeer",english:"Poni Meadow"},{name:"Resolution Cave",value:63,german:"Finalhöhle",english:"Resolution Cave"},{name:"Poni Coast",value:64,german:"Küste von Poni",english:"Poni Coast"},{name:"Poni Gauntlet",value:65,german:"Beschwerlicher Pfad",english:"Poni Gauntlet"},{name:"Ruins of Conflict",value:66,german:"Ruinen des Krieges",english:"Ruins of Conflict"},{name:"Ruins of Life",value:67,german:"Ruinen des Lebens",english:"Ruins of Life"},{name:"Ruins of Abundance",value:68,german:"Ruinen des Gedeihens",english:"Ruins of Abundance"},{name:"Ruins of Hope",value:69,german:"Ruinen der Heimkehr",english:"Ruins of Hope"}]},usum:{id:"usum",title:"Ultra Sun and Ultra Moon",nameLimit:12,dexLimit:807,loaded:false,locations:[{name:"Starter",value:0},{name:"Hau'oli Outskirts",value:1},{name:"Iki Town",value:2,german:"Lili'i",english:"Iki Town"},{name:"Route 1",value:3,german:"Route 1",english:"Route 1"},{name:"Melemele Sea",value:4,german:"Meer von Mele-Mele",english:"Melemele Sea"},{name:"Hau'oli City",value:5},{name:"Route 2",value:6,german:"Route 2",english:"Route 2"},{name:"Berry Fields",value:7,german:"Beerenfelder",english:"Berry Fields"},{name:"Verdant Cavern",value:8,german:"Vegetationshöhle",english:"Verdant Cavern"},{name:"Hau'oli Cemetery",value:9},{name:"Route 3",value:10,german:"Route 3",english:"Route 3"},{name:"Melemele Meadow",value:11,german:"Mele-Mele-Blumenmeer",english:"Melemele Meadow"},{name:"Seaward Cave",value:12,german:"Meereshöhle",english:"Seaward Cave"},{name:"Kala'e Bay",value:13},{name:"Ten Carat Hill",value:14,german:"Tenkarat-Hügel",english:"Ten Carat Hill"},{name:"Hano Beach",value:15,german:"Hanohano-Strand",english:"Hano Beach"},{name:"Route 4",value:16,german:"Route 4",english:"Route 4"},{name:"Paniola Town",value:17,german:"Ohana",english:"Paniola Town"},{name:"Paniola Ranch",value:18,german:"Ohana-Farm",english:"Paniola Ranch"},{name:"Route 5",value:19,german:"Route 5",english:"Route 5"},{name:"Brooklet Hill",value:20,german:"Plätscherhügel",english:"Brooklet Hill"},{name:"Route 6",value:21,german:"Route 6",english:"Route 6"},{name:"Route 7",value:22,german:"Route 7",english:"Route 7"},{name:"Wela Volcano Park",value:23,german:"Wela-Vulkanpark",english:"Wela Volcano Park"},{name:"Dividing Peak Tunnel",value:24},{name:"Route 8",value:25,german:"Route 8",english:"Route 8"},{name:"Fossil Restoration Center",value:26},{name:"Lush Jungle",value:27,german:"Schattendschungel",english:"Lush Jungle"},{name:"Diglett's Tunnel",value:28},{name:"Route 9",value:29,german:"Route 9",english:"Route 9"},{name:"Konikoni City",value:30,german:"Konikoni City",english:"Konikoni City"},{name:"Memorial Hill",value:31,german:"Hügel des Gedenkens",english:"Memorial Hill"},{name:"Akala Outskirts",value:32,german:"Akala-Küstenstreifen",english:"Akala Outskirts"},{name:"Malie City",value:33,german:"Malihe City",english:"Malie City"},{name:"Malie Garden",value:34,german:"Malihe-Ziergarten",english:"Malie Garden"},{name:"Route 10",value:35,german:"Route 10",english:"Route 10"},{name:"Mount Hokulani",value:36,german:"Hokulani-Berg",english:"Mount Hokulani"},{name:"Route 11",value:37,german:"Route 11",english:"Route 11"},{name:"Route 12",value:38,german:"Route 12",english:"Route 12"},{name:"Secluded Shore",value:39,german:"Küste von Ula-Ula",english:"Secluded Shore"},{name:"Blush Mountain",value:40,german:"Glühberg",english:"Blush Mountain"},{name:"Route 13",value:41,german:"Route 13",english:"Route 13"},{name:"Haina Desert",value:42,german:"Haina-Wüste",english:"Haina Desert"},{name:"Tapu Village",value:43,german:"Dorf der Kapu",english:"Tapu Village"},{name:"Route 15",value:44,german:"Route 15",english:"Route 15"},{name:"Aether House",value:45},{name:"Route 14",value:46,german:"Route 14",english:"Route 14"},{name:"Thrifty Megamart",value:47,german:"Schnäppchenparadies",english:"Thrifty Megamart"},{name:"Route 16",value:48,german:"Route 16",english:"Route 16"},{name:"Ula'ula Meadow",value:49},{name:"Lake of the Moone/Sunne",value:50},{name:"Route 17",value:51,german:"Route 17",english:"Route 17"},{name:"Shady House",value:52,german:"Lottervilla",english:"Shady House"},{name:"Seafolk Village",value:53,german:"Dorf des Seevolkes",english:"Seafolk Village"},{name:"Poni Wilds",value:54,german:"Wildnis von Poni",english:"Poni Wilds"},{name:"Ancient Poni Path",value:55,german:"Alter Pfad von Poni",english:"Ancient Poni Path"},{name:"Poni Breaker Coast",value:56,german:"Felsenküste von Poni",english:"Poni Breaker Coast"},{name:"Exeggutor Island",value:57,german:"Kokowei-Eiland",english:"Exeggutor Island"},{name:"Vast Poni Canyon",value:58,german:"Canyon von Poni",english:"Vast Poni Canyon"},{name:"Altar of the Moone/Sunne",value:59},{name:"Mount Lanakila",value:60,german:"Mount Lanakila",english:"Mount Lanakila"},{name:"Poni Grove",value:61,german:"Wald von Poni",english:"Poni Grove"},{name:"Poni Plains",value:62,german:"Ebene von Poni",english:"Poni Plains"},{name:"Poni Meadow",value:63,german:"Poni-Blumenmeer",english:"Poni Meadow"},{name:"Resolution Cave",value:64,german:"Finalhöhle",english:"Resolution Cave"},{name:"Poni Coast",value:65,german:"Küste von Poni",english:"Poni Coast"},{name:"Poni Gauntlet",value:66,german:"Beschwerlicher Pfad",english:"Poni Gauntlet"},{name:"Ruins of Conflict",value:67,german:"Ruinen des Krieges",english:"Ruins of Conflict"},{name:"Ruins of Life",value:68,german:"Ruinen des Lebens",english:"Ruins of Life"},{name:"Ruins of Abundance",value:69,german:"Ruinen des Gedeihens",english:"Ruins of Abundance"},{name:"Ruins of Hope",value:70,german:"Ruinen der Heimkehr",english:"Ruins of Hope"}]},swsh:{id:"swsh",title:"Sword and Shield",nameLimit:12,dexLimit:898,loaded:false,locations:[{name:"Starter",value:0},{name:"Slumbering Weald",value:1},{name:"Route 1",value:2,german:"Route 1",english:"Route 1"},{name:"Wedgehurst",value:3},{name:"Route 2",value:4,german:"Route 2",english:"Route 2"},{name:"Wild Area: Rolling Fields",value:5},{name:"Wild Area: Dappled Grove",value:6},{name:"Wild Area: West Lake Axewell",value:7},{name:"Wild Area: Watchtower Ruins",value:8},{name:"Wild Area: East Lake Axewell",value:9},{name:"Wild Area: South Lake Miloch",value:10},{name:"Wild Area: Giant's Seat",value:11},{name:"Wild Area: North Lake Miloch",value:12},{name:"Motostoke",value:13},{name:"Route 3",value:14,german:"Route 3",english:"Route 3"},{name:"Galar Mine",value:15},{name:"Route 4",value:16,german:"Route 4",english:"Route 4"},{name:"Route 5",value:17,german:"Route 5",english:"Route 5"},{name:"Hulbury",value:18},{name:"Galar Mine No. 2",value:19},{name:"Motostoke Outskirts",value:20},{name:"Motostoke Stadium",value:21},{name:"Wild Area: Motostoke Riverbank",value:22},{name:"Wild Area: Bridge Field",value:23},{name:"Wild Area: Stony Wilderness",value:24},{name:"Wild Area: Giant's Mirror",value:25},{name:"Wild Area: Dusty Bowl",value:26},{name:"Wild Area: Giant's Cap",value:27},{name:"Wild Area: Hammerlocke Hills",value:28},{name:"Wild Area: Lake of Outrage",value:29},{name:"Route 6",value:30,german:"Route 6",english:"Route 6"},{name:"Glimwood Tangle",value:31},{name:"Router 7",value:32},{name:"Route 8",value:33,german:"Route 8",english:"Route 8"},{name:"Route 9",value:34,german:"Route 9",english:"Route 9"},{name:"Wild Area: Axew's Eye",value:35},{name:"Isle of Armor: Fields of Honor",value:36},{name:"Isle of Armor: Soothing Wetlands",value:37},{name:"Isle of Armor: Forest of Focus",value:38},{name:"Isle of Armor: Challenge Beach",value:39},{name:"Isle of Armor: Brawlers' Cave",value:40},{name:"Isle of Armor: Challenge Road",value:41},{name:"Isle of Armor: Courageous Cavern",value:42},{name:"Isle of Armor: Loop Lagoon",value:43},{name:"Isle of Armor: Training Lowlands",value:44},{name:"Isle of Armor: Warm-Up Tunnel",value:45},{name:"Isle of Armor: Potbottom Desert",value:46},{name:"Isle of Armor: Workout Sea",value:47},{name:"Isle of Armor: Stepping-Stone Sea",value:48},{name:"Isle of Armor: Insular Sea",value:49},{name:"Isle of Armor: Honeycalm Sea",value:50},{name:"Isle of Armor: Honeycalm Island",value:51},{name:"Crown Tundra: Slippery Slope",value:52},{name:"Crown Tundra: Freezington",value:53},{name:"Crown Tundra: Max Lair",value:54},{name:"Crown Tundra: Frostpoint Field",value:55},{name:"Crown Tundra: Giant's Bed",value:56},{name:"Crown Tundra: Old Cemetery",value:57},{name:"Crown Tundra: Snowslide Slope",value:58},{name:"Crown Tundra: Tunnel to the Top",value:59},{name:"Crown Tundra: Path to the Peak",value:60},{name:"Crown Tundra: Crown Shrine",value:61},{name:"Crown Tundra: Giant's Foot",value:62},{name:"Crown Tundra: Roaring-Sea Caves",value:63},{name:"Crown Tundra: Frigrid Sea",value:64},{name:"Crown Tundra: Three-Point Pass",value:65},{name:"Crown Tundra: Ballimere Lake",value:66},{name:"Crown Tundra: Lakeside Cave",value:67},{name:"Crown Tundra: Dyna Tree Hill",value:68},{name:"Crown Tundra: Rock Peak Ruins",value:69},{name:"Crown Tundra: Iceberg Ruins",value:70},{name:"Crown Tundra: Iron Ruins",value:71},{name:"Crown Tundra: Split-Decision Ruins",value:72}]},sv:{id:"sv",title:"Scarlet and Violet",nameLimit:12,dexLimit:1008,loaded:false,locations:[{name:"Starter",value:0},{name:"Poco Path",value:1},{name:"Inlet Grotto",value:2},{name:"South Province: Area One",value:3},{name:"Pokémon League",value:4,german:"Pokémon League",english:"Pokémon League"},{name:"South Province: Area Two",value:5},{name:"South Province: Area Three",value:6},{name:"East Province: Area One",value:7},{name:"East Province: Area Two",value:8},{name:"South Province: Area Four",value:9},{name:"South Province: Area Five",value:10},{name:"West Province: Area One",value:11},{name:"Asado Desert",value:12},{name:"West Paldean Sea",value:13},{name:"West Province: Area Two",value:14},{name:"West Province: Area Three",value:15},{name:"East Province: Area Three",value:16},{name:"East Paldean Sea",value:17},{name:"Tagtree Thicket",value:18},{name:"South Province: Area Six",value:19},{name:"Alfornada Cavern",value:20},{name:"South Paldean Sea",value:21},{name:"Dalizapa Passage",value:22},{name:"Glaseado Mountain",value:23},{name:"North Province: Area Three",value:24},{name:"North Paldean Sea",value:25},{name:"North Province: Area One",value:26},{name:"North Province: Area Two",value:27},{name:"Socarrat Trail",value:28},{name:"Casseroya Lake",value:29},{name:"Area Zero",value:30}]},custom:{id:"custom",title:"Custom Game",nameLimit:12,dexLimit:1008,loaded:false,locations:[{name:"Starter",value:0}]}};const pkmnData=[{name:"Bulbasaur",value:"bulbasaur",icon:"bulbasaur",id:"1",exclude:["sv"]},{name:"Ivysaur",value:"ivysaur",icon:"ivysaur",id:"2",exclude:["sv"]},{name:"Venusaur",value:"venusaur",icon:"venusaur",id:"3",exclude:["sv"]},{name:"Charmander",value:"charmander",icon:"charmander",id:"4"},{name:"Charmeleon",value:"charmeleon",icon:"charmeleon",id:"5"},{name:"Charizard",value:"charizard",icon:"charizard",id:"6"},{name:"Squirtle",value:"squirtle",icon:"squirtle",id:"7",exclude:["sv"]},{name:"Wartortle",value:"wartortle",icon:"wartortle",id:"8",exclude:["sv"]},{name:"Blastoise",value:"blastoise",icon:"blastoise",id:"9",exclude:["sv"]},{name:"Caterpie",value:"caterpie",icon:"caterpie",id:"10",exclude:["sv"]},{name:"Metapod",value:"metapod",icon:"metapod",id:"11",exclude:["sv"]},{name:"Butterfree",value:"butterfree",icon:"butterfree",id:"12",exclude:["sv"]},{name:"Weedle",value:"weedle",icon:"weedle",id:"13",exclude:["swsh","sv"]},{name:"Kakuna",value:"kakuna",icon:"kakuna",id:"14",exclude:["swsh","sv"]},{name:"Beedrill",value:"beedrill",icon:"beedrill",id:"15",exclude:["swsh","sv"]},{name:"Pidgey",value:"pidgey",icon:"pidgey",id:"16",exclude:["swsh","sv"]},{name:"Pidgeotto",value:"pidgeotto",icon:"pidgeotto",id:"17",exclude:["swsh","sv"]},{name:"Pidgeot",value:"pidgeot",icon:"pidgeot",id:"18",exclude:["swsh","sv"]},{name:"Rattata",value:"rattata",icon:"rattata",id:"19",exclude:["swsh","sv"]},{name:"Raticate",value:"raticate",icon:"raticate",id:"20",exclude:["swsh","sv"]},{name:"Spearow",value:"spearow",icon:"spearow",id:"21",exclude:["swsh","sv"]},{name:"Fearow",value:"fearow",icon:"fearow",id:"22",exclude:["swsh","sv"]},{name:"Ekans",value:"ekans",icon:"ekans",id:"23",exclude:["swsh","sv"]},{name:"Arbok",value:"arbok",icon:"arbok",id:"24",exclude:["swsh","sv"]},{name:"Pikachu",value:"pikachu",icon:"pikachu",id:"25"},{name:"Raichu",value:"raichu",icon:"raichu",id:"26"},{name:"Sandshrew",value:"sandshrew",icon:"sandshrew",id:"27",exclude:["sv"]},{name:"Sandslash",value:"sandslash",icon:"sandslash",id:"28",exclude:["sv"]},{name:"Nidoran♀",value:"nidoran-f",icon:"nidoran-f",id:"29",exclude:["sv"]},{name:"Nidorina",value:"nidorina",icon:"nidorina",id:"30",exclude:["sv"]},{name:"Nidoqueen",value:"nidoqueen",icon:"nidoqueen",id:"31",exclude:["sv"]},{name:"Nidoran♂",value:"nidoran-m",icon:"nidoran-m",id:"32",exclude:["sv"]},{name:"Nidorino",value:"nidorino",icon:"nidorino",id:"33",exclude:["sv"]},{name:"Nidoking",value:"nidoking",icon:"nidoking",id:"34",exclude:["sv"]},{name:"Clefairy",value:"clefairy",icon:"clefairy",id:"35",exclude:["sv"]},{name:"Clefable",value:"clefable",icon:"clefable",id:"36",exclude:["sv"]},{name:"Vulpix",value:"vulpix",icon:"vulpix",id:"37",exclude:["sv"]},{name:"Ninetales",value:"ninetales",icon:"ninetales",id:"38",exclude:["sv"]},{name:"Jigglypuff",value:"jigglypuff",icon:"jigglypuff",id:"39"},{name:"Wigglytuff",value:"wigglytuff",icon:"wigglytuff",id:"40"},{name:"Zubat",value:"zubat",icon:"zubat",id:"41",exclude:["sv"]},{name:"Golbat",value:"golbat",icon:"golbat",id:"42",exclude:["sv"]},{name:"Oddish",value:"oddish",icon:"oddish",id:"43",exclude:["sv"]},{name:"Gloom",value:"gloom",icon:"gloom",id:"44",exclude:["sv"]},{name:"Vileplume",value:"vileplume",icon:"vileplume",id:"45",exclude:["sv"]},{name:"Paras",value:"paras",icon:"paras",id:"46",exclude:["swsh","sv"]},{name:"Parasect",value:"parasect",icon:"parasect",id:"47",exclude:["swsh","sv"]},{name:"Venonat",value:"venonat",icon:"venonat",id:"48",exclude:["swsh"]},{name:"Venomoth",value:"venomoth",icon:"venomoth",id:"49",exclude:["swsh"]},{name:"Diglett",value:"diglett",icon:"diglett",id:"50"},{name:"Dugtrio",value:"dugtrio",icon:"dugtrio",id:"51"},{name:"Meowth",value:"meowth",icon:"meowth",id:"52"},{name:"Persian",value:"persian",icon:"persian",id:"53"},{name:"Psyduck",value:"psyduck",icon:"psyduck",id:"54"},{name:"Golduck",value:"golduck",icon:"golduck",id:"55"},{name:"Mankey",value:"mankey",icon:"mankey",id:"56",exclude:["swsh"]},{name:"Primeape",value:"primeape",icon:"primeape",id:"57",exclude:["swsh"]},{name:"Growlithe",value:"growlithe",icon:"growlithe",id:"58"},{name:"Arcanine",value:"arcanine",icon:"arcanine",id:"59"},{name:"Poliwag",value:"poliwag",icon:"poliwag",id:"60",exclude:["sv"]},{name:"Poliwhirl",value:"poliwhirl",icon:"poliwhirl",id:"61",exclude:["sv"]},{name:"Poliwrath",value:"poliwrath",icon:"poliwrath",id:"62",exclude:["sv"]},{name:"Abra",value:"abra",icon:"abra",id:"63",exclude:["sv"]},{name:"Kadabra",value:"kadabra",icon:"kadabra",id:"64",exclude:["sv"]},{name:"Alakazam",value:"alakazam",icon:"alakazam",id:"65",exclude:["sv"]},{name:"Machop",value:"machop",icon:"machop",id:"66",exclude:["sv"]},{name:"Machoke",value:"machoke",icon:"machoke",id:"67",exclude:["sv"]},{name:"Machamp",value:"machamp",icon:"machamp",id:"68",exclude:["sv"]},{name:"Bellsprout",value:"bellsprout",icon:"bellsprout",id:"69",exclude:["swsh","sv"]},{name:"Weepinbell",value:"weepinbell",icon:"weepinbell",id:"70",exclude:["swsh","sv"]},{name:"Victreebel",value:"victreebel",icon:"victreebel",id:"71",exclude:["swsh","sv"]},{name:"Tentacool",value:"tentacool",icon:"tentacool",id:"72",exclude:["sv"]},{name:"Tentacruel",value:"tentacruel",icon:"tentacruel",id:"73",exclude:["sv"]},{name:"Geodude",value:"geodude",icon:"geodude",id:"74",exclude:["swsh","sv"]},{name:"Graveler",value:"graveler",icon:"graveler",id:"75",exclude:["swsh","sv"]},{name:"Golem",value:"golem",icon:"golem",id:"76",exclude:["swsh","sv"]},{name:"Ponyta",value:"ponyta",icon:"ponyta",id:"77",exclude:["sv"]},{name:"Rapidash",value:"rapidash",icon:"rapidash",id:"78",exclude:["sv"]},{name:"Slowpoke",value:"slowpoke",icon:"slowpoke",id:"79"},{name:"Slowbro",value:"slowbro",icon:"slowbro",id:"80"},{name:"Magnemite",value:"magnemite",icon:"magnemite",id:"81"},{name:"Magneton",value:"magneton",icon:"magneton",id:"82"},{name:"Farfetch'd",value:"farfetchd",icon:"farfetchd",id:"83",exclude:["sv"]},{name:"Doduo",value:"doduo",icon:"doduo",id:"84",exclude:["swsh","sv"]},{name:"Dodrio",value:"dodrio",icon:"dodrio",id:"85",exclude:["swsh","sv"]},{name:"Seel",value:"seel",icon:"seel",id:"86",exclude:["swsh","sv"]},{name:"Dewgong",value:"dewgong",icon:"dewgong",id:"87",exclude:["swsh","sv"]},{name:"Grimer",value:"grimer",icon:"grimer",id:"88",exclude:["swsh"]},{name:"Muk",value:"muk",icon:"muk",id:"89",exclude:["swsh"]},{name:"Shellder",value:"shellder",icon:"shellder",id:"90"},{name:"Cloyster",value:"cloyster",icon:"cloyster",id:"91"},{name:"Gastly",value:"gastly",icon:"gastly",id:"92"},{name:"Haunter",value:"haunter",icon:"haunter",id:"93"},{name:"Gengar",value:"gengar",icon:"gengar",id:"94"},{name:"Onix",value:"onix",icon:"onix",id:"95",exclude:["sv"]},{name:"Drowzee",value:"drowzee",icon:"drowzee",id:"96",exclude:["swsh"]},{name:"Hypno",value:"hypno",icon:"hypno",id:"97",exclude:["swsh"]},{name:"Krabby",value:"krabby",icon:"krabby",id:"98",exclude:["sv"]},{name:"Kingler",value:"kingler",icon:"kingler",id:"99",exclude:["sv"]},{name:"Voltorb",value:"voltorb",icon:"voltorb",id:"100",exclude:["swsh"]},{name:"Electrode",value:"electrode",icon:"electrode",id:"101",exclude:["swsh"]},{name:"Exeggcute",value:"exeggcute",icon:"exeggcute",id:"102",exclude:["sv"]},{name:"Exeggutor",value:"exeggutor",icon:"exeggutor",id:"103",exclude:["sv"]},{name:"Cubone",value:"cubone",icon:"cubone",id:"104",exclude:["sv"]},{name:"Marowak",value:"marowak",icon:"marowak",id:"105",exclude:["sv"]},{name:"Hitmonlee",value:"hitmonlee",icon:"hitmonlee",id:"106",exclude:["sv"]},{name:"Hitmonchan",value:"hitmonchan",icon:"hitmonchan",id:"107",exclude:["sv"]},{name:"Lickitung",value:"lickitung",icon:"lickitung",id:"108",exclude:["sv"]},{name:"Koffing",value:"koffing",icon:"koffing",id:"109",exclude:["sv"]},{name:"Weezing",value:"weezing",icon:"weezing",id:"110",exclude:["sv"]},{name:"Rhyhorn",value:"rhyhorn",icon:"rhyhorn",id:"111",exclude:["sv"]},{name:"Rhydon",value:"rhydon",icon:"rhydon",id:"112",exclude:["sv"]},{name:"Chansey",value:"chansey",icon:"chansey",id:"113"},{name:"Tangela",value:"tangela",icon:"tangela",id:"114",exclude:["sv"]},{name:"Kangaskhan",value:"kangaskhan",icon:"kangaskhan",id:"115",exclude:["sv"]},{name:"Horsea",value:"horsea",icon:"horsea",id:"116",exclude:["sv"]},{name:"Seadra",value:"seadra",icon:"seadra",id:"117",exclude:["sv"]},{name:"Goldeen",value:"goldeen",icon:"goldeen",id:"118",exclude:["sv"]},{name:"Seaking",value:"seaking",icon:"seaking",id:"119",exclude:["sv"]},{name:"Staryu",value:"staryu",icon:"staryu",id:"120",exclude:["sv"]},{name:"Starmie",value:"starmie",icon:"starmie",id:"121",exclude:["sv"]},{name:"Mr. Mime",value:"mr-mime",icon:"mr-mime",id:"122",exclude:["sv"]},{name:"Scyther",value:"scyther",icon:"scyther",id:"123"},{name:"Jynx",value:"jynx",icon:"jynx",id:"124",exclude:["sv"]},{name:"Electabuzz",value:"electabuzz",icon:"electabuzz",id:"125",exclude:["sv"]},{name:"Magmar",value:"magmar",icon:"magmar",id:"126",exclude:["sv"]},{name:"Pinsir",value:"pinsir",icon:"pinsir",id:"127",exclude:["sv"]},{name:"Tauros",value:"tauros",icon:"tauros",id:"128"},{name:"Magikarp",value:"magikarp",icon:"magikarp",id:"129"},{name:"Gyarados",value:"gyarados",icon:"gyarados",id:"130"},{name:"Lapras",value:"lapras",icon:"lapras",id:"131",exclude:["sv"]},{name:"Ditto",value:"ditto",icon:"ditto",id:"132"},{name:"Eevee",value:"eevee",icon:"eevee",id:"133"},{name:"Vaporeon",value:"vaporeon",icon:"vaporeon",id:"134"},{name:"Jolteon",value:"jolteon",icon:"jolteon",id:"135"},{name:"Flareon",value:"flareon",icon:"flareon",id:"136"},{name:"Porygon",value:"porygon",icon:"porygon",id:"137",exclude:["sv"]},{name:"Omanyte",value:"omanyte",icon:"omanyte",id:"138",exclude:["sv"]},{name:"Omastar",value:"omastar",icon:"omastar",id:"139",exclude:["sv"]},{name:"Kabuto",value:"kabuto",icon:"kabuto",id:"140",exclude:["sv"]},{name:"Kabutops",value:"kabutops",icon:"kabutops",id:"141",exclude:["sv"]},{name:"Aerodactyl",value:"aerodactyl",icon:"aerodactyl",id:"142",exclude:["sv"]},{name:"Snorlax",value:"snorlax",icon:"snorlax",id:"143",exclude:["sv"]},{name:"Articuno",value:"articuno",icon:"articuno",id:"144"},{name:"Zapdos",value:"zapdos",icon:"zapdos",id:"145"},{name:"Moltres",value:"moltres",icon:"moltres",id:"146"},{name:"Dratini",value:"dratini",icon:"dratini",id:"147"},{name:"Dragonair",value:"dragonair",icon:"dragonair",id:"148"},{name:"Dragonite",value:"dragonite",icon:"dragonite",id:"149"},{name:"Mewtwo",value:"mewtwo",icon:"mewtwo",id:"150"},{name:"Mew",value:"mew",icon:"mew",id:"151"},{name:"Chikorita",value:"chikorita",icon:"chikorita",id:"152",exclude:["swsh","sv"]},{name:"Bayleef",value:"bayleef",icon:"bayleef",id:"153",exclude:["swsh","sv"]},{name:"Meganium",value:"meganium",icon:"meganium",id:"154",exclude:["swsh","sv"]},{name:"Cyndaquil",value:"cyndaquil",icon:"cyndaquil",id:"155",exclude:["swsh"]},{name:"Quilava",value:"quilava",icon:"quilava",id:"156",exclude:["swsh"]},{name:"Typhlosion",value:"typhlosion",icon:"typhlosion",id:"157",exclude:["swsh"]},{name:"Totodile",value:"totodile",icon:"totodile",id:"158",exclude:["swsh","sv"]},{name:"Croconaw",value:"croconaw",icon:"croconaw",id:"159",exclude:["swsh","sv"]},{name:"Feraligatr",value:"feraligatr",icon:"feraligatr",id:"160",exclude:["swsh","sv"]},{name:"Sentret",value:"sentret",icon:"sentret",id:"161",exclude:["swsh","sv"]},{name:"Furret",value:"furret",icon:"furret",id:"162",exclude:["swsh","sv"]},{name:"Hoothoot",value:"hoothoot",icon:"hoothoot",id:"163",exclude:["sv"]},{name:"Noctowl",value:"noctowl",icon:"noctowl",id:"164",exclude:["sv"]},{name:"Ledyba",value:"ledyba",icon:"ledyba",id:"165",exclude:["swsh","sv"]},{name:"Ledian",value:"ledian",icon:"ledian",id:"166",exclude:["swsh","sv"]},{name:"Spinarak",value:"spinarak",icon:"spinarak",id:"167",exclude:["swsh","sv"]},{name:"Ariados",value:"ariados",icon:"ariados",id:"168",exclude:["swsh","sv"]},{name:"Crobat",value:"crobat",icon:"crobat",id:"169",exclude:["sv"]},{name:"Chinchou",value:"chinchou",icon:"chinchou",id:"170",exclude:["sv"]},{name:"Lanturn",value:"lanturn",icon:"lanturn",id:"171",exclude:["sv"]},{name:"Pichu",value:"pichu",icon:"pichu",id:"172"},{name:"Cleffa",value:"cleffa",icon:"cleffa",id:"173",exclude:["sv"]},{name:"Igglybuff",value:"igglybuff",icon:"igglybuff",id:"174"},{name:"Togepi",value:"togepi",icon:"togepi",id:"175",exclude:["sv"]},{name:"Togetic",value:"togetic",icon:"togetic",id:"176",exclude:["sv"]},{name:"Natu",value:"natu",icon:"natu",id:"177",exclude:["sv"]},{name:"Xatu",value:"xatu",icon:"xatu",id:"178",exclude:["sv"]},{name:"Mareep",value:"mareep",icon:"mareep",id:"179",exclude:["swsh"]},{name:"Flaaffy",value:"flaaffy",icon:"flaaffy",id:"180",exclude:["swsh"]},{name:"Ampharos",value:"ampharos",icon:"ampharos",id:"181",exclude:["swsh"]},{name:"Bellossom",value:"bellossom",icon:"bellossom",id:"182",exclude:["sv"]},{name:"Marill",value:"marill",icon:"marill",id:"183"},{name:"Azumarill",value:"azumarill",icon:"azumarill",id:"184"},{name:"Sudowoodo",value:"sudowoodo",icon:"sudowoodo",id:"185"},{name:"Politoed",value:"politoed",icon:"politoed",id:"186",exclude:["sv"]},{name:"Hoppip",value:"hoppip",icon:"hoppip",id:"187",exclude:["swsh"]},{name:"Skiploom",value:"skiploom",icon:"skiploom",id:"188",exclude:["swsh"]},{name:"Jumpluff",value:"jumpluff",icon:"jumpluff",id:"189",exclude:["swsh"]},{name:"Aipom",value:"aipom",icon:"aipom",id:"190",exclude:["swsh","sv"]},{name:"Sunkern",value:"sunkern",icon:"sunkern",id:"191",exclude:["swsh"]},{name:"Sunflora",value:"sunflora",icon:"sunflora",id:"192",exclude:["swsh"]},{name:"Yanma",value:"yanma",icon:"yanma",id:"193",exclude:["swsh","sv"]},{name:"Wooper",value:"wooper",icon:"wooper",id:"194"},{name:"Quagsire",value:"quagsire",icon:"quagsire",id:"195"},{name:"Espeon",value:"espeon",icon:"espeon",id:"196"},{name:"Umbreon",value:"umbreon",icon:"umbreon",id:"197"},{name:"Murkrow",value:"murkrow",icon:"murkrow",id:"198",exclude:["swsh"]},{name:"Slowking",value:"slowking",icon:"slowking",id:"199"},{name:"Misdreavus",value:"misdreavus",icon:"misdreavus",id:"200",exclude:["swsh"]},{name:"Unown",value:"unown",icon:"unown",id:"201",exclude:["swsh","sv"]},{name:"Wobbuffet",value:"wobbuffet",icon:"wobbuffet",id:"202",exclude:["sv"]},{name:"Girafarig",value:"girafarig",icon:"girafarig",id:"203",exclude:["swsh"]},{name:"Pineco",value:"pineco",icon:"pineco",id:"204",exclude:["swsh"]},{name:"Forretress",value:"forretress",icon:"forretress",id:"205",exclude:["swsh"]},{name:"Dunsparce",value:"dunsparce",icon:"dunsparce",id:"206"},{name:"Gligar",value:"gligar",icon:"gligar",id:"207",exclude:["swsh","sv"]},{name:"Steelix",value:"steelix",icon:"steelix",id:"208",exclude:["sv"]},{name:"Snubbull",value:"snubbull",icon:"snubbull",id:"209",exclude:["swsh","sv"]},{name:"Granbull",value:"granbull",icon:"granbull",id:"210",exclude:["swsh","sv"]},{name:"Qwilfish",value:"qwilfish",icon:"qwilfish",id:"211"},{name:"Scizor",value:"scizor",icon:"scizor",id:"212"},{name:"Shuckle",value:"shuckle",icon:"shuckle",id:"213",exclude:["sv"]},{name:"Heracross",value:"heracross",icon:"heracross",id:"214"},{name:"Sneasel",value:"sneasel",icon:"sneasel",id:"215"},{name:"Teddiursa",value:"teddiursa",icon:"teddiursa",id:"216",exclude:["swsh"]},{name:"Ursaring",value:"ursaring",icon:"ursaring",id:"217",exclude:["swsh"]},{name:"Slugma",value:"slugma",icon:"slugma",id:"218",exclude:["swsh","sv"]},{name:"Magcargo",value:"magcargo",icon:"magcargo",id:"219",exclude:["swsh","sv"]},{name:"Swinub",value:"swinub",icon:"swinub",id:"220",exclude:["sv"]},{name:"Piloswine",value:"piloswine",icon:"piloswine",id:"221",exclude:["sv"]},{name:"Corsola",value:"corsola",icon:"corsola",id:"222",exclude:["sv"]},{name:"Remoraid",value:"remoraid",icon:"remoraid",id:"223",exclude:["sv"]},{name:"Octillery",value:"octillery",icon:"octillery",id:"224",exclude:["sv"]},{name:"Delibird",value:"delibird",icon:"delibird",id:"225"},{name:"Mantine",value:"mantine",icon:"mantine",id:"226",exclude:["sv"]},{name:"Skarmory",value:"skarmory",icon:"skarmory",id:"227",exclude:["sv"]},{name:"Houndour",value:"houndour",icon:"houndour",id:"228",exclude:["swsh"]},{name:"Houndoom",value:"houndoom",icon:"houndoom",id:"229",exclude:["swsh"]},{name:"Kingdra",value:"kingdra",icon:"kingdra",id:"230",exclude:["sv"]},{name:"Phanpy",value:"phanpy",icon:"phanpy",id:"231",exclude:["swsh"]},{name:"Donphan",value:"donphan",icon:"donphan",id:"232",exclude:["swsh"]},{name:"Porygon2",value:"porygon2",icon:"porygon2",id:"233",exclude:["sv"]},{name:"Stantler",value:"stantler",icon:"stantler",id:"234",exclude:["swsh"]},{name:"Smeargle",value:"smeargle",icon:"smeargle",id:"235",exclude:["swsh","sv"]},{name:"Tyrogue",value:"tyrogue",icon:"tyrogue",id:"236",exclude:["sv"]},{name:"Hitmontop",value:"hitmontop",icon:"hitmontop",id:"237",exclude:["sv"]},{name:"Smoochum",value:"smoochum",icon:"smoochum",id:"238",exclude:["sv"]},{name:"Elekid",value:"elekid",icon:"elekid",id:"239",exclude:["sv"]},{name:"Magby",value:"magby",icon:"magby",id:"240",exclude:["sv"]},{name:"Miltank",value:"miltank",icon:"miltank",id:"241",exclude:["sv"]},{name:"Blissey",value:"blissey",icon:"blissey",id:"242"},{name:"Raikou",value:"raikou",icon:"raikou",id:"243",exclude:["sv"]},{name:"Entei",value:"entei",icon:"entei",id:"244",exclude:["sv"]},{name:"Suicune",value:"suicune",icon:"suicune",id:"245",exclude:["sv"]},{name:"Larvitar",value:"larvitar",icon:"larvitar",id:"246"},{name:"Pupitar",value:"pupitar",icon:"pupitar",id:"247"},{name:"Tyranitar",value:"tyranitar",icon:"tyranitar",id:"248"},{name:"Lugia",value:"lugia",icon:"lugia",id:"249",exclude:["sv"]},{name:"Ho-Oh",value:"ho-oh",icon:"ho-oh",id:"250",exclude:["sv"]},{name:"Celebi",value:"celebi",icon:"celebi",id:"251",exclude:["sv"]},{name:"Treecko",value:"treecko",icon:"treecko",id:"252",exclude:["sv"]},{name:"Grovyle",value:"grovyle",icon:"grovyle",id:"253",exclude:["sv"]},{name:"Sceptile",value:"sceptile",icon:"sceptile",id:"254",exclude:["sv"]},{name:"Torchic",value:"torchic",icon:"torchic",id:"255",exclude:["sv"]},{name:"Combusken",value:"combusken",icon:"combusken",id:"256",exclude:["sv"]},{name:"Blaziken",value:"blaziken",icon:"blaziken",id:"257",exclude:["sv"]},{name:"Mudkip",value:"mudkip",icon:"mudkip",id:"258",exclude:["sv"]},{name:"Marshtomp",value:"marshtomp",icon:"marshtomp",id:"259",exclude:["sv"]},{name:"Swampert",value:"swampert",icon:"swampert",id:"260",exclude:["sv"]},{name:"Poochyena",value:"poochyena",icon:"poochyena",id:"261",exclude:["swsh","sv"]},{name:"Mightyena",value:"mightyena",icon:"mightyena",id:"262",exclude:["swsh","sv"]},{name:"Zigzagoon",value:"zigzagoon",icon:"zigzagoon",id:"263",exclude:["sv"]},{name:"Linoone",value:"linoone",icon:"linoone",id:"264",exclude:["sv"]},{name:"Wurmple",value:"wurmple",icon:"wurmple",id:"265",exclude:["swsh","sv"]},{name:"Silcoon",value:"silcoon",icon:"silcoon",id:"266",exclude:["swsh","sv"]},{name:"Beautifly",value:"beautifly",icon:"beautifly",id:"267",exclude:["swsh","sv"]},{name:"Cascoon",value:"cascoon",icon:"cascoon",id:"268",exclude:["swsh","sv"]},{name:"Dustox",value:"dustox",icon:"dustox",id:"269",exclude:["swsh","sv"]},{name:"Lotad",value:"lotad",icon:"lotad",id:"270",exclude:["sv"]},{name:"Lombre",value:"lombre",icon:"lombre",id:"271",exclude:["sv"]},{name:"Ludicolo",value:"ludicolo",icon:"ludicolo",id:"272",exclude:["sv"]},{name:"Seedot",value:"seedot",icon:"seedot",id:"273",exclude:["sv"]},{name:"Nuzleaf",value:"nuzleaf",icon:"nuzleaf",id:"274",exclude:["sv"]},{name:"Shiftry",value:"shiftry",icon:"shiftry",id:"275",exclude:["sv"]},{name:"Taillow",value:"taillow",icon:"taillow",id:"276",exclude:["swsh","sv"]},{name:"Swellow",value:"swellow",icon:"swellow",id:"277",exclude:["swsh","sv"]},{name:"Wingull",value:"wingull",icon:"wingull",id:"278"},{name:"Pelipper",value:"pelipper",icon:"pelipper",id:"279"},{name:"Ralts",value:"ralts",icon:"ralts",id:"280"},{name:"Kirlia",value:"kirlia",icon:"kirlia",id:"281"},{name:"Gardevoir",value:"gardevoir",icon:"gardevoir",id:"282"},{name:"Surskit",value:"surskit",icon:"surskit",id:"283",exclude:["swsh"]},{name:"Masquerain",value:"masquerain",icon:"masquerain",id:"284",exclude:["swsh"]},{name:"Shroomish",value:"shroomish",icon:"shroomish",id:"285",exclude:["swsh"]},{name:"Breloom",value:"breloom",icon:"breloom",id:"286",exclude:["swsh"]},{name:"Slakoth",value:"slakoth",icon:"slakoth",id:"287",exclude:["swsh"]},{name:"Vigoroth",value:"vigoroth",icon:"vigoroth",id:"288",exclude:["swsh"]},{name:"Slaking",value:"slaking",icon:"slaking",id:"289",exclude:["swsh"]},{name:"Nincada",value:"nincada",icon:"nincada",id:"290",exclude:["sv"]},{name:"Ninjask",value:"ninjask",icon:"ninjask",id:"291",exclude:["sv"]},{name:"Shedinja",value:"shedinja",icon:"shedinja",id:"292",exclude:["sv"]},{name:"Whismur",value:"whismur",icon:"whismur",id:"293",exclude:["sv"]},{name:"Loudred",value:"loudred",icon:"loudred",id:"294",exclude:["sv"]},{name:"Exploud",value:"exploud",icon:"exploud",id:"295",exclude:["sv"]},{name:"Makuhita",value:"makuhita",icon:"makuhita",id:"296",exclude:["swsh"]},{name:"Hariyama",value:"hariyama",icon:"hariyama",id:"297",exclude:["swsh"]},{name:"Azurill",value:"azurill",icon:"azurill",id:"298"},{name:"Nosepass",value:"nosepass",icon:"nosepass",id:"299",exclude:["swsh","sv"]},{name:"Skitty",value:"skitty",icon:"skitty",id:"300",exclude:["swsh","sv"]},{name:"Delcatty",value:"delcatty",icon:"delcatty",id:"301",exclude:["swsh","sv"]},{name:"Sableye",value:"sableye",icon:"sableye",id:"302"},{name:"Mawile",value:"mawile",icon:"mawile",id:"303",exclude:["sv"]},{name:"Aron",value:"aron",icon:"aron",id:"304",exclude:["sv"]},{name:"Lairon",value:"lairon",icon:"lairon",id:"305",exclude:["sv"]},{name:"Aggron",value:"aggron",icon:"aggron",id:"306",exclude:["sv"]},{name:"Meditite",value:"meditite",icon:"meditite",id:"307",exclude:["swsh"]},{name:"Medicham",value:"medicham",icon:"medicham",id:"308",exclude:["swsh"]},{name:"Electrike",value:"electrike",icon:"electrike",id:"309",exclude:["sv"]},{name:"Manectric",value:"manectric",icon:"manectric",id:"310",exclude:["sv"]},{name:"Plusle",value:"plusle",icon:"plusle",id:"311",exclude:["swsh","sv"]},{name:"Minun",value:"minun",icon:"minun",id:"312",exclude:["swsh","sv"]},{name:"Volbeat",value:"volbeat",icon:"volbeat",id:"313",exclude:["swsh","sv"]},{name:"Illumise",value:"illumise",icon:"illumise",id:"314",exclude:["swsh","sv"]},{name:"Roselia",value:"roselia",icon:"roselia",id:"315",exclude:["sv"]},{name:"Gulpin",value:"gulpin",icon:"gulpin",id:"316",exclude:["swsh"]},{name:"Swalot",value:"swalot",icon:"swalot",id:"317",exclude:["swsh"]},{name:"Carvanha",value:"carvanha",icon:"carvanha",id:"318",exclude:["sv"]},{name:"Sharpedo",value:"sharpedo",icon:"sharpedo",id:"319",exclude:["sv"]},{name:"Wailmer",value:"wailmer",icon:"wailmer",id:"320",exclude:["sv"]},{name:"Wailord",value:"wailord",icon:"wailord",id:"321",exclude:["sv"]},{name:"Numel",value:"numel",icon:"numel",id:"322",exclude:["swsh"]},{name:"Camerupt",value:"camerupt",icon:"camerupt",id:"323",exclude:["swsh"]},{name:"Torkoal",value:"torkoal",icon:"torkoal",id:"324"},{name:"Spoink",value:"spoink",icon:"spoink",id:"325",exclude:["swsh"]},{name:"Grumpig",value:"grumpig",icon:"grumpig",id:"326",exclude:["swsh"]},{name:"Spinda",value:"spinda",icon:"spinda",id:"327",exclude:["swsh","sv"]},{name:"Trapinch",value:"trapinch",icon:"trapinch",id:"328",exclude:["sv"]},{name:"Vibrava",value:"vibrava",icon:"vibrava",id:"329",exclude:["sv"]},{name:"Flygon",value:"flygon",icon:"flygon",id:"330",exclude:["sv"]},{name:"Cacnea",value:"cacnea",icon:"cacnea",id:"331",exclude:["swsh"]},{name:"Cacturne",value:"cacturne",icon:"cacturne",id:"332",exclude:["swsh"]},{name:"Swablu",value:"swablu",icon:"swablu",id:"333"},{name:"Altaria",value:"altaria",icon:"altaria",id:"334"},{name:"Zangoose",value:"zangoose",icon:"zangoose",id:"335",exclude:["swsh"]},{name:"Seviper",value:"seviper",icon:"seviper",id:"336",exclude:["swsh"]},{name:"Lunatone",value:"lunatone",icon:"lunatone",id:"337",exclude:["sv"]},{name:"Solrock",value:"solrock",icon:"solrock",id:"338",exclude:["sv"]},{name:"Barboach",value:"barboach",icon:"barboach",id:"339"},{name:"Whiscash",value:"whiscash",icon:"whiscash",id:"340"},{name:"Corphish",value:"corphish",icon:"corphish",id:"341",exclude:["sv"]},{name:"Crawdaunt",value:"crawdaunt",icon:"crawdaunt",id:"342",exclude:["sv"]},{name:"Baltoy",value:"baltoy",icon:"baltoy",id:"343",exclude:["sv"]},{name:"Claydol",value:"claydol",icon:"claydol",id:"344",exclude:["sv"]},{name:"Lileep",value:"lileep",icon:"lileep",id:"345",exclude:["sv"]},{name:"Cradily",value:"cradily",icon:"cradily",id:"346",exclude:["sv"]},{name:"Anorith",value:"anorith",icon:"anorith",id:"347",exclude:["sv"]},{name:"Armaldo",value:"armaldo",icon:"armaldo",id:"348",exclude:["sv"]},{name:"Feebas",value:"feebas",icon:"feebas",id:"349",exclude:["sv"]},{name:"Milotic",value:"milotic",icon:"milotic",id:"350",exclude:["sv"]},{name:"Castform",value:"castform",icon:"castform",id:"351",exclude:["swsh","sv"]},{name:"Kecleon",value:"kecleon",icon:"kecleon",id:"352",exclude:["swsh","sv"]},{name:"Shuppet",value:"shuppet",icon:"shuppet",id:"353",exclude:["swsh"]},{name:"Banette",value:"banette",icon:"banette",id:"354",exclude:["swsh"]},{name:"Duskull",value:"duskull",icon:"duskull",id:"355",exclude:["sv"]},{name:"Dusclops",value:"dusclops",icon:"dusclops",id:"356",exclude:["sv"]},{name:"Tropius",value:"tropius",icon:"tropius",id:"357",exclude:["swsh"]},{name:"Chimecho",value:"chimecho",icon:"chimecho",id:"358",exclude:["swsh","sv"]},{name:"Absol",value:"absol",icon:"absol",id:"359",exclude:["sv"]},{name:"Wynaut",value:"wynaut",icon:"wynaut",id:"360",exclude:["sv"]},{name:"Snorunt",value:"snorunt",icon:"snorunt",id:"361"},{name:"Glalie",value:"glalie",icon:"glalie",id:"362"},{name:"Spheal",value:"spheal",icon:"spheal",id:"363",exclude:["sv"]},{name:"Sealeo",value:"sealeo",icon:"sealeo",id:"364",exclude:["sv"]},{name:"Walrein",value:"walrein",icon:"walrein",id:"365",exclude:["sv"]},{name:"Clamperl",value:"clamperl",icon:"clamperl",id:"366",exclude:["swsh","sv"]},{name:"Huntail",value:"huntail",icon:"huntail",id:"367",exclude:["swsh","sv"]},{name:"Gorebyss",value:"gorebyss",icon:"gorebyss",id:"368",exclude:["swsh","sv"]},{name:"Relicanth",value:"relicanth",icon:"relicanth",id:"369",exclude:["sv"]},{name:"Luvdisc",value:"luvdisc",icon:"luvdisc",id:"370",exclude:["swsh"]},{name:"Bagon",value:"bagon",icon:"bagon",id:"371"},{name:"Shelgon",value:"shelgon",icon:"shelgon",id:"372"},{name:"Salamence",value:"salamence",icon:"salamence",id:"373"},{name:"Beldum",value:"beldum",icon:"beldum",id:"374",exclude:["sv"]},{name:"Metang",value:"metang",icon:"metang",id:"375",exclude:["sv"]},{name:"Metagross",value:"metagross",icon:"metagross",id:"376",exclude:["sv"]},{name:"Regirock",value:"regirock",icon:"regirock",id:"377",exclude:["sv"]},{name:"Regice",value:"regice",icon:"regice",id:"378",exclude:["sv"]},{name:"Registeel",value:"registeel",icon:"registeel",id:"379",exclude:["sv"]},{name:"Latias",value:"latias",icon:"latias",id:"380",exclude:["sv"]},{name:"Latios",value:"latios",icon:"latios",id:"381",exclude:["sv"]},{name:"Kyogre",value:"kyogre",icon:"kyogre",id:"382"},{name:"Groudon",value:"groudon",icon:"groudon",id:"383"},{name:"Rayquaza",value:"rayquaza",icon:"rayquaza",id:"384"},{name:"Jirachi",value:"jirachi",icon:"jirachi",id:"385",exclude:["sv"]},{name:"Deoxys",value:"deoxys",icon:"deoxys",id:"386",exclude:["swsh","sv"]},{name:"Turtwig",value:"turtwig",icon:"turtwig",id:"387",exclude:["swsh","sv"]},{name:"Grotle",value:"grotle",icon:"grotle",id:"388",exclude:["swsh","sv"]},{name:"Torterra",value:"torterra",icon:"torterra",id:"389",exclude:["swsh","sv"]},{name:"Chimchar",value:"chimchar",icon:"chimchar",id:"390",exclude:["swsh","sv"]},{name:"Monferno",value:"monferno",icon:"monferno",id:"391",exclude:["swsh","sv"]},{name:"Infernape",value:"infernape",icon:"infernape",id:"392",exclude:["swsh","sv"]},{name:"Piplup",value:"piplup",icon:"piplup",id:"393",exclude:["swsh","sv"]},{name:"Prinplup",value:"prinplup",icon:"prinplup",id:"394",exclude:["swsh","sv"]},{name:"Empoleon",value:"empoleon",icon:"empoleon",id:"395",exclude:["swsh","sv"]},{name:"Starly",value:"starly",icon:"starly",id:"396",exclude:["swsh"]},{name:"Staravia",value:"staravia",icon:"staravia",id:"397",exclude:["swsh"]},{name:"Staraptor",value:"staraptor",icon:"staraptor",id:"398",exclude:["swsh"]},{name:"Bidoof",value:"bidoof",icon:"bidoof",id:"399",exclude:["swsh","sv"]},{name:"Bibarel",value:"bibarel",icon:"bibarel",id:"400",exclude:["swsh","sv"]},{name:"Kricketot",value:"kricketot",icon:"kricketot",id:"401",exclude:["swsh"]},{name:"Kricketune",value:"kricketune",icon:"kricketune",id:"402",exclude:["swsh"]},{name:"Shinx",value:"shinx",icon:"shinx",id:"403"},{name:"Luxio",value:"luxio",icon:"luxio",id:"404"},{name:"Luxray",value:"luxray",icon:"luxray",id:"405"},{name:"Budew",value:"budew",icon:"budew",id:"406",exclude:["sv"]},{name:"Roserade",value:"roserade",icon:"roserade",id:"407",exclude:["sv"]},{name:"Cranidos",value:"cranidos",icon:"cranidos",id:"408",exclude:["swsh","sv"]},{name:"Rampardos",value:"rampardos",icon:"rampardos",id:"409",exclude:["swsh","sv"]},{name:"Shieldon",value:"shieldon",icon:"shieldon",id:"410",exclude:["swsh","sv"]},{name:"Bastiodon",value:"bastiodon",icon:"bastiodon",id:"411",exclude:["swsh","sv"]},{name:"Burmy",value:"burmy",icon:"burmy",id:"412",exclude:["swsh","sv"]},{name:"Wormadam",value:"wormadam",icon:"wormadam",id:"413",exclude:["swsh","sv"]},{name:"Mothim",value:"mothim",icon:"mothim",id:"414",exclude:["swsh","sv"]},{name:"Combee",value:"combee",icon:"combee",id:"415"},{name:"Vespiquen",value:"vespiquen",icon:"vespiquen",id:"416"},{name:"Pachirisu",value:"pachirisu",icon:"pachirisu",id:"417",exclude:["swsh"]},{name:"Buizel",value:"buizel",icon:"buizel",id:"418",exclude:["swsh"]},{name:"Floatzel",value:"floatzel",icon:"floatzel",id:"419",exclude:["swsh"]},{name:"Cherubi",value:"cherubi",icon:"cherubi",id:"420",exclude:["sv"]},{name:"Cherrim",value:"cherrim",icon:"cherrim",id:"421",exclude:["sv"]},{name:"Shellos",value:"shellos",icon:"shellos",id:"422"},{name:"Gastrodon",value:"gastrodon",icon:"gastrodon",id:"423"},{name:"Ambipom",value:"ambipom",icon:"ambipom",id:"424",exclude:["swsh","sv"]},{name:"Drifloon",value:"drifloon",icon:"drifloon",id:"425"},{name:"Drifblim",value:"drifblim",icon:"drifblim",id:"426"},{name:"Buneary",value:"buneary",icon:"buneary",id:"427",exclude:["sv"]},{name:"Lopunny",value:"lopunny",icon:"lopunny",id:"428",exclude:["sv"]},{name:"Mismagius",value:"mismagius",icon:"mismagius",id:"429",exclude:["swsh"]},{name:"Honchkrow",value:"honchkrow",icon:"honchkrow",id:"430",exclude:["swsh"]},{name:"Glameow",value:"glameow",icon:"glameow",id:"431",exclude:["swsh","sv"]},{name:"Purugly",value:"purugly",icon:"purugly",id:"432",exclude:["swsh","sv"]},{name:"Chingling",value:"chingling",icon:"chingling",id:"433",exclude:["swsh","sv"]},{name:"Stunky",value:"stunky",icon:"stunky",id:"434"},{name:"Skuntank",value:"skuntank",icon:"skuntank",id:"435"},{name:"Bronzor",value:"bronzor",icon:"bronzor",id:"436"},{name:"Bronzong",value:"bronzong",icon:"bronzong",id:"437"},{name:"Bonsly",value:"bonsly",icon:"bonsly",id:"438"},{name:"Mime Jr.",value:"mime-jr",icon:"mime-jr",id:"439",exclude:["sv"]},{name:"Happiny",value:"happiny",icon:"happiny",id:"440"},{name:"Chatot",value:"chatot",icon:"chatot",id:"441",exclude:["swsh","sv"]},{name:"Spiritomb",value:"spiritomb",icon:"spiritomb",id:"442"},{name:"Gible",value:"gible",icon:"gible",id:"443"},{name:"Gabite",value:"gabite",icon:"gabite",id:"444"},{name:"Garchomp",value:"garchomp",icon:"garchomp",id:"445"},{name:"Munchlax",value:"munchlax",icon:"munchlax",id:"446",exclude:["sv"]},{name:"Riolu",value:"riolu",icon:"riolu",id:"447"},{name:"Lucario",value:"lucario",icon:"lucario",id:"448"},{name:"Hippopotas",value:"hippopotas",icon:"hippopotas",id:"449"},{name:"Hippowdon",value:"hippowdon",icon:"hippowdon",id:"450"},{name:"Skorupi",value:"skorupi",icon:"skorupi",id:"451",exclude:["sv"]},{name:"Drapion",value:"drapion",icon:"drapion",id:"452",exclude:["sv"]},{name:"Croagunk",value:"croagunk",icon:"croagunk",id:"453"},{name:"Toxicroak",value:"toxicroak",icon:"toxicroak",id:"454"},{name:"Carnivine",value:"carnivine",icon:"carnivine",id:"455",exclude:["swsh","sv"]},{name:"Finneon",value:"finneon",icon:"finneon",id:"456",exclude:["swsh"]},{name:"Lumineon",value:"lumineon",icon:"lumineon",id:"457",exclude:["swsh"]},{name:"Mantyke",value:"mantyke",icon:"mantyke",id:"458",exclude:["sv"]},{name:"Snover",value:"snover",icon:"snover",id:"459"},{name:"Abomasnow",value:"abomasnow",icon:"abomasnow",id:"460"},{name:"Weavile",value:"weavile",icon:"weavile",id:"461"},{name:"Magnezone",value:"magnezone",icon:"magnezone",id:"462"},{name:"Lickilicky",value:"lickilicky",icon:"lickilicky",id:"463",exclude:["sv"]},{name:"Rhyperior",value:"rhyperior",icon:"rhyperior",id:"464",exclude:["sv"]},{name:"Tangrowth",value:"tangrowth",icon:"tangrowth",id:"465",exclude:["sv"]},{name:"Electivire",value:"electivire",icon:"electivire",id:"466",exclude:["sv"]},{name:"Magmortar",value:"magmortar",icon:"magmortar",id:"467",exclude:["sv"]},{name:"Togekiss",value:"togekiss",icon:"togekiss",id:"468",exclude:["sv"]},{name:"Yanmega",value:"yanmega",icon:"yanmega",id:"469",exclude:["swsh","sv"]},{name:"Leafeon",value:"leafeon",icon:"leafeon",id:"470"},{name:"Glaceon",value:"glaceon",icon:"glaceon",id:"471"},{name:"Gliscor",value:"gliscor",icon:"gliscor",id:"472",exclude:["swsh","sv"]},{name:"Mamoswine",value:"mamoswine",icon:"mamoswine",id:"473",exclude:["sv"]},{name:"Porygon-Z",value:"porygon-z",icon:"porygon-z",id:"474",exclude:["sv"]},{name:"Gallade",value:"gallade",icon:"gallade",id:"475"},{name:"Probopass",value:"probopass",icon:"probopass",id:"476",exclude:["swsh","sv"]},{name:"Dusknoir",value:"dusknoir",icon:"dusknoir",id:"477",exclude:["sv"]},{name:"Froslass",value:"froslass",icon:"froslass",id:"478"},{name:"Rotom",value:"rotom",icon:"rotom",id:"479"},{name:"Uxie",value:"uxie",icon:"uxie",id:"480"},{name:"Mesprit",value:"mesprit",icon:"mesprit",id:"481"},{name:"Azelf",value:"azelf",icon:"azelf",id:"482"},{name:"Dialga",value:"dialga",icon:"dialga",id:"483"},{name:"Palkia",value:"palkia",icon:"palkia",id:"484"},{name:"Heatran",value:"heatran",icon:"heatran",id:"485"},{name:"Regigigas",value:"regigigas",icon:"regigigas",id:"486",exclude:["sv"]},{name:"Giratina",value:"giratina",icon:"giratina",id:"487"},{name:"Cresselia",value:"cresselia",icon:"cresselia",id:"488"},{name:"Phione",value:"phione",icon:"phione",id:"489",exclude:["swsh","sv"]},{name:"Manaphy",value:"manaphy",icon:"manaphy",id:"490",exclude:["swsh","sv"]},{name:"Darkrai",value:"darkrai",icon:"darkrai",id:"491",exclude:["swsh","sv"]},{name:"Shaymin",value:"shaymin",icon:"shaymin",id:"492",exclude:["swsh","sv"]},{name:"Arceus",value:"arceus",icon:"arceus",id:"493",exclude:["swsh"]},{name:"Victini",value:"victini",icon:"victini",id:"494",exclude:["sv"]},{name:"Snivy",value:"snivy",icon:"snivy",id:"495",exclude:["swsh","sv"]},{name:"Servine",value:"servine",icon:"servine",id:"496",exclude:["swsh","sv"]},{name:"Serperior",value:"serperior",icon:"serperior",id:"497",exclude:["swsh","sv"]},{name:"Tepig",value:"tepig",icon:"tepig",id:"498",exclude:["swsh","sv"]},{name:"Pignite",value:"pignite",icon:"pignite",id:"499",exclude:["swsh","sv"]},{name:"Emboar",value:"emboar",icon:"emboar",id:"500",exclude:["swsh","sv"]},{name:"Oshawott",value:"oshawott",icon:"oshawott",id:"501",exclude:["swsh"]},{name:"Dewott",value:"dewott",icon:"dewott",id:"502",exclude:["swsh"]},{name:"Samurott",value:"samurott",icon:"samurott",id:"503",exclude:["swsh"]},{name:"Patrat",value:"patrat",icon:"patrat",id:"504",exclude:["swsh","sv"]},{name:"Watchog",value:"watchog",icon:"watchog",id:"505",exclude:["swsh","sv"]},{name:"Lillipup",value:"lillipup",icon:"lillipup",id:"506",exclude:["sv"]},{name:"Herdier",value:"herdier",icon:"herdier",id:"507",exclude:["sv"]},{name:"Stoutland",value:"stoutland",icon:"stoutland",id:"508",exclude:["sv"]},{name:"Purrloin",value:"purrloin",icon:"purrloin",id:"509",exclude:["sv"]},{name:"Liepard",value:"liepard",icon:"liepard",id:"510",exclude:["sv"]},{name:"Pansage",value:"pansage",icon:"pansage",id:"511",exclude:["swsh","sv"]},{name:"Simisage",value:"simisage",icon:"simisage",id:"512",exclude:["swsh","sv"]},{name:"Pansear",value:"pansear",icon:"pansear",id:"513",exclude:["swsh","sv"]},{name:"Simisear",value:"simisear",icon:"simisear",id:"514",exclude:["swsh","sv"]},{name:"Panpour",value:"panpour",icon:"panpour",id:"515",exclude:["swsh","sv"]},{name:"Simipour",value:"simipour",icon:"simipour",id:"516",exclude:["swsh","sv"]},{name:"Munna",value:"munna",icon:"munna",id:"517",exclude:["sv"]},{name:"Musharna",value:"musharna",icon:"musharna",id:"518",exclude:["sv"]},{name:"Pidove",value:"pidove",icon:"pidove",id:"519",exclude:["sv"]},{name:"Tranquill",value:"tranquill",icon:"tranquill",id:"520",exclude:["sv"]},{name:"Unfezant",value:"unfezant",icon:"unfezant",id:"521",exclude:["sv"]},{name:"Blitzle",value:"blitzle",icon:"blitzle",id:"522",exclude:["swsh","sv"]},{name:"Zebstrika",value:"zebstrika",icon:"zebstrika",id:"523",exclude:["swsh","sv"]},{name:"Roggenrola",value:"roggenrola",icon:"roggenrola",id:"524",exclude:["sv"]},{name:"Boldore",value:"boldore",icon:"boldore",id:"525",exclude:["sv"]},{name:"Gigalith",value:"gigalith",icon:"gigalith",id:"526",exclude:["sv"]},{name:"Woobat",value:"woobat",icon:"woobat",id:"527",exclude:["sv"]},{name:"Swoobat",value:"swoobat",icon:"swoobat",id:"528",exclude:["sv"]},{name:"Drilbur",value:"drilbur",icon:"drilbur",id:"529",exclude:["sv"]},{name:"Excadrill",value:"excadrill",icon:"excadrill",id:"530",exclude:["sv"]},{name:"Audino",value:"audino",icon:"audino",id:"531",exclude:["sv"]},{name:"Timburr",value:"timburr",icon:"timburr",id:"532",exclude:["sv"]},{name:"Gurdurr",value:"gurdurr",icon:"gurdurr",id:"533",exclude:["sv"]},{name:"Conkeldurr",value:"conkeldurr",icon:"conkeldurr",id:"534",exclude:["sv"]},{name:"Tympole",value:"tympole",icon:"tympole",id:"535",exclude:["sv"]},{name:"Palpitoad",value:"palpitoad",icon:"palpitoad",id:"536",exclude:["sv"]},{name:"Seismitoad",value:"seismitoad",icon:"seismitoad",id:"537",exclude:["sv"]},{name:"Throh",value:"throh",icon:"throh",id:"538",exclude:["sv"]},{name:"Sawk",value:"sawk",icon:"sawk",id:"539",exclude:["sv"]},{name:"Sewaddle",value:"sewaddle",icon:"sewaddle",id:"540",exclude:["swsh","sv"]},{name:"Swadloon",value:"swadloon",icon:"swadloon",id:"541",exclude:["swsh","sv"]},{name:"Leavanny",value:"leavanny",icon:"leavanny",id:"542",exclude:["swsh","sv"]},{name:"Venipede",value:"venipede",icon:"venipede",id:"543",exclude:["sv"]},{name:"Whirlipede",value:"whirlipede",icon:"whirlipede",id:"544",exclude:["sv"]},{name:"Scolipede",value:"scolipede",icon:"scolipede",id:"545",exclude:["sv"]},{name:"Cottonee",value:"cottonee",icon:"cottonee",id:"546",exclude:["sv"]},{name:"Whimsicott",value:"whimsicott",icon:"whimsicott",id:"547",exclude:["sv"]},{name:"Petilil",value:"petilil",icon:"petilil",id:"548"},{name:"Lilligant",value:"lilligant",icon:"lilligant",id:"549"},{name:"Basculin",value:"basculin",icon:"basculin",id:"550"},{name:"Sandile",value:"sandile",icon:"sandile",id:"551"},{name:"Krokorok",value:"krokorok",icon:"krokorok",id:"552"},{name:"Krookodile",value:"krookodile",icon:"krookodile",id:"553"},{name:"Darumaka",value:"darumaka",icon:"darumaka",id:"554",exclude:["sv"]},{name:"Darmanitan",value:"darmanitan",icon:"darmanitan",id:"555",exclude:["sv"]},{name:"Maractus",value:"maractus",icon:"maractus",id:"556",exclude:["sv"]},{name:"Dwebble",value:"dwebble",icon:"dwebble",id:"557",exclude:["sv"]},{name:"Crustle",value:"crustle",icon:"crustle",id:"558",exclude:["sv"]},{name:"Scraggy",value:"scraggy",icon:"scraggy",id:"559",exclude:["sv"]},{name:"Scrafty",value:"scrafty",icon:"scrafty",id:"560",exclude:["sv"]},{name:"Sigilyph",value:"sigilyph",icon:"sigilyph",id:"561",exclude:["sv"]},{name:"Yamask",value:"yamask",icon:"yamask",id:"562",exclude:["sv"]},{name:"Cofagrigus",value:"cofagrigus",icon:"cofagrigus",id:"563",exclude:["sv"]},{name:"Tirtouga",value:"tirtouga",icon:"tirtouga",id:"564",exclude:["sv"]},{name:"Carracosta",value:"carracosta",icon:"carracosta",id:"565",exclude:["sv"]},{name:"Archen",value:"archen",icon:"archen",id:"566",exclude:["sv"]},{name:"Archeops",value:"archeops",icon:"archeops",id:"567",exclude:["sv"]},{name:"Trubbish",value:"trubbish",icon:"trubbish",id:"568",exclude:["sv"]},{name:"Garbodor",value:"garbodor",icon:"garbodor",id:"569",exclude:["sv"]},{name:"Zorua",value:"zorua",icon:"zorua",id:"570"},{name:"Zoroark",value:"zoroark",icon:"zoroark",id:"571"},{name:"Minccino",value:"minccino",icon:"minccino",id:"572",exclude:["sv"]},{name:"Cinccino",value:"cinccino",icon:"cinccino",id:"573",exclude:["sv"]},{name:"Gothita",value:"gothita",icon:"gothita",id:"574"},{name:"Gothorita",value:"gothorita",icon:"gothorita",id:"575"},{name:"Gothitelle",value:"gothitelle",icon:"gothitelle",id:"576"},{name:"Solosis",value:"solosis",icon:"solosis",id:"577",exclude:["sv"]},{name:"Duosion",value:"duosion",icon:"duosion",id:"578",exclude:["sv"]},{name:"Reuniclus",value:"reuniclus",icon:"reuniclus",id:"579",exclude:["sv"]},{name:"Ducklett",value:"ducklett",icon:"ducklett",id:"580",exclude:["swsh","sv"]},{name:"Swanna",value:"swanna",icon:"swanna",id:"581",exclude:["swsh","sv"]},{name:"Vanillite",value:"vanillite",icon:"vanillite",id:"582",exclude:["sv"]},{name:"Vanillish",value:"vanillish",icon:"vanillish",id:"583",exclude:["sv"]},{name:"Vanilluxe",value:"vanilluxe",icon:"vanilluxe",id:"584",exclude:["sv"]},{name:"Deerling",value:"deerling",icon:"deerling",id:"585",exclude:["swsh"]},{name:"Sawsbuck",value:"sawsbuck",icon:"sawsbuck",id:"586",exclude:["swsh"]},{name:"Emolga",value:"emolga",icon:"emolga",id:"587",exclude:["sv"]},{name:"Karrablast",value:"karrablast",icon:"karrablast",id:"588",exclude:["sv"]},{name:"Escavalier",value:"escavalier",icon:"escavalier",id:"589",exclude:["sv"]},{name:"Foongus",value:"foongus",icon:"foongus",id:"590"},{name:"Amoonguss",value:"amoonguss",icon:"amoonguss",id:"591"},{name:"Frillish",value:"frillish",icon:"frillish",id:"592",exclude:["sv"]},{name:"Jellicent",value:"jellicent",icon:"jellicent",id:"593",exclude:["sv"]},{name:"Alomomola",value:"alomomola",icon:"alomomola",id:"594",exclude:["swsh"]},{name:"Joltik",value:"joltik",icon:"joltik",id:"595",exclude:["sv"]},{name:"Galvantula",value:"galvantula",icon:"galvantula",id:"596",exclude:["sv"]},{name:"Ferroseed",value:"ferroseed",icon:"ferroseed",id:"597",exclude:["sv"]},{name:"Ferrothorn",value:"ferrothorn",icon:"ferrothorn",id:"598",exclude:["sv"]},{name:"Klink",value:"klink",icon:"klink",id:"599",exclude:["sv"]},{name:"Klang",value:"klang",icon:"klang",id:"600",exclude:["sv"]},{name:"Klinklang",value:"klinklang",icon:"klinklang",id:"601",exclude:["sv"]},{name:"Tynamo",value:"tynamo",icon:"tynamo",id:"602",exclude:["swsh"]},{name:"Eelektrik",value:"eelektrik",icon:"eelektrik",id:"603",exclude:["swsh"]},{name:"Eelektross",value:"eelektross",icon:"eelektross",id:"604",exclude:["swsh"]},{name:"Elgyem",value:"elgyem",icon:"elgyem",id:"605",exclude:["sv"]},{name:"Beheeyem",value:"beheeyem",icon:"beheeyem",id:"606",exclude:["sv"]},{name:"Litwick",value:"litwick",icon:"litwick",id:"607",exclude:["sv"]},{name:"Lampent",value:"lampent",icon:"lampent",id:"608",exclude:["sv"]},{name:"Chandelure",value:"chandelure",icon:"chandelure",id:"609",exclude:["sv"]},{name:"Axew",value:"axew",icon:"axew",id:"610"},{name:"Fraxure",value:"fraxure",icon:"fraxure",id:"611"},{name:"Haxorus",value:"haxorus",icon:"haxorus",id:"612"},{name:"Cubchoo",value:"cubchoo",icon:"cubchoo",id:"613"},{name:"Beartic",value:"beartic",icon:"beartic",id:"614"},{name:"Cryogonal",value:"cryogonal",icon:"cryogonal",id:"615"},{name:"Shelmet",value:"shelmet",icon:"shelmet",id:"616",exclude:["sv"]},{name:"Accelgor",value:"accelgor",icon:"accelgor",id:"617",exclude:["sv"]},{name:"Stunfisk",value:"stunfisk",icon:"stunfisk",id:"618",exclude:["sv"]},{name:"Mienfoo",value:"mienfoo",icon:"mienfoo",id:"619",exclude:["sv"]},{name:"Mienshao",value:"mienshao",icon:"mienshao",id:"620",exclude:["sv"]},{name:"Druddigon",value:"druddigon",icon:"druddigon",id:"621",exclude:["sv"]},{name:"Golett",value:"golett",icon:"golett",id:"622",exclude:["sv"]},{name:"Golurk",value:"golurk",icon:"golurk",id:"623",exclude:["sv"]},{name:"Pawniard",value:"pawniard",icon:"pawniard",id:"624"},{name:"Bisharp",value:"bisharp",icon:"bisharp",id:"625"},{name:"Bouffalant",value:"bouffalant",icon:"bouffalant",id:"626",exclude:["sv"]},{name:"Rufflet",value:"rufflet",icon:"rufflet",id:"627"},{name:"Braviary",value:"braviary",icon:"braviary",id:"628"},{name:"Vullaby",value:"vullaby",icon:"vullaby",id:"629",exclude:["sv"]},{name:"Mandibuzz",value:"mandibuzz",icon:"mandibuzz",id:"630",exclude:["sv"]},{name:"Heatmor",value:"heatmor",icon:"heatmor",id:"631",exclude:["sv"]},{name:"Durant",value:"durant",icon:"durant",id:"632",exclude:["sv"]},{name:"Deino",value:"deino",icon:"deino",id:"633"},{name:"Zweilous",value:"zweilous",icon:"zweilous",id:"634"},{name:"Hydreigon",value:"hydreigon",icon:"hydreigon",id:"635"},{name:"Larvesta",value:"larvesta",icon:"larvesta",id:"636"},{name:"Volcarona",value:"volcarona",icon:"volcarona",id:"637"},{name:"Cobalion",value:"cobalion",icon:"cobalion",id:"638",exclude:["sv"]},{name:"Terrakion",value:"terrakion",icon:"terrakion",id:"639",exclude:["sv"]},{name:"Virizion",value:"virizion",icon:"virizion",id:"640",exclude:["sv"]},{name:"Tornadus",value:"tornadus",icon:"tornadus",id:"641"},{name:"Thundurus",value:"thundurus",icon:"thundurus",id:"642"},{name:"Reshiram",value:"reshiram",icon:"reshiram",id:"643",exclude:["sv"]},{name:"Zekrom",value:"zekrom",icon:"zekrom",id:"644",exclude:["sv"]},{name:"Landorus",value:"landorus",icon:"landorus",id:"645"},{name:"Kyurem",value:"kyurem",icon:"kyurem",id:"646",exclude:["sv"]},{name:"Keldeo",value:"keldeo",icon:"keldeo",id:"647",exclude:["sv"]},{name:"Meloetta",value:"meloetta",icon:"meloetta",id:"648",exclude:["swsh"]},{name:"Genesect",value:"genesect",icon:"genesect",id:"649",exclude:["sv"]},{name:"Chespin",value:"chespin",icon:"chespin",id:"650",exclude:["swsh"]},{name:"Quilladin",value:"quilladin",icon:"quilladin",id:"651",exclude:["swsh"]},{name:"Chesnaught",value:"chesnaught",icon:"chesnaught",id:"652",exclude:["swsh"]},{name:"Fennekin",value:"fennekin",icon:"fennekin",id:"653",exclude:["swsh"]},{name:"Braixen",value:"braixen",icon:"braixen",id:"654",exclude:["swsh"]},{name:"Delphox",value:"delphox",icon:"delphox",id:"655",exclude:["swsh"]},{name:"Froakie",value:"froakie",icon:"froakie",id:"656",exclude:["swsh"]},{name:"Frogadier",value:"frogadier",icon:"frogadier",id:"657",exclude:["swsh"]},{name:"Greninja",value:"greninja",icon:"greninja",id:"658",exclude:["swsh"]},{name:"Bunnelby",value:"bunnelby",icon:"bunnelby",id:"659",exclude:["sv"]},{name:"Diggersby",value:"diggersby",icon:"diggersby",id:"660",exclude:["sv"]},{name:"Fletchling",value:"fletchling",icon:"fletchling",id:"661"},{name:"Fletchinder",value:"fletchinder",icon:"fletchinder",id:"662"},{name:"Talonflame",value:"talonflame",icon:"talonflame",id:"663"},{name:"Scatterbug",value:"scatterbug",icon:"scatterbug",id:"664",exclude:["swsh"]},{name:"Spewpa",value:"spewpa",icon:"spewpa",id:"665",exclude:["swsh"]},{name:"Vivillon",value:"vivillon",icon:"vivillon",id:"666",exclude:["swsh"]},{name:"Litleo",value:"litleo",icon:"litleo",id:"667",exclude:["swsh"]},{name:"Pyroar",value:"pyroar",icon:"pyroar",id:"668",exclude:["swsh"]},{name:"Flabébé",value:"flabebe",icon:"flabebe",id:"669",exclude:["swsh"]},{name:"Floette",value:"floette",icon:"floette",id:"670",exclude:["swsh"]},{name:"Florges",value:"florges",icon:"florges",id:"671",exclude:["swsh"]},{name:"Skiddo",value:"skiddo",icon:"skiddo",id:"672",exclude:["swsh"]},{name:"Gogoat",value:"gogoat",icon:"gogoat",id:"673",exclude:["swsh"]},{name:"Pancham",value:"pancham",icon:"pancham",id:"674",exclude:["sv"]},{name:"Pangoro",value:"pangoro",icon:"pangoro",id:"675",exclude:["sv"]},{name:"Furfrou",value:"furfrou",icon:"furfrou",id:"676",exclude:["swsh","sv"]},{name:"Espurr",value:"espurr",icon:"espurr",id:"677",exclude:["sv"]},{name:"Meowstic",value:"meowstic",icon:"meowstic",id:"678",exclude:["sv"]},{name:"Honedge",value:"honedge",icon:"honedge",id:"679",exclude:["sv"]},{name:"Doublade",value:"doublade",icon:"doublade",id:"680",exclude:["sv"]},{name:"Aegislash",value:"aegislash",icon:"aegislash",id:"681",exclude:["sv"]},{name:"Spritzee",value:"spritzee",icon:"spritzee",id:"682",exclude:["sv"]},{name:"Aromatisse",value:"aromatisse",icon:"aromatisse",id:"683",exclude:["sv"]},{name:"Swirlix",value:"swirlix",icon:"swirlix",id:"684",exclude:["sv"]},{name:"Slurpuff",value:"slurpuff",icon:"slurpuff",id:"685",exclude:["sv"]},{name:"Inkay",value:"inkay",icon:"inkay",id:"686",exclude:["sv"]},{name:"Malamar",value:"malamar",icon:"malamar",id:"687",exclude:["sv"]},{name:"Binacle",value:"binacle",icon:"binacle",id:"688",exclude:["sv"]},{name:"Barbaracle",value:"barbaracle",icon:"barbaracle",id:"689",exclude:["sv"]},{name:"Skrelp",value:"skrelp",icon:"skrelp",id:"690"},{name:"Dragalge",value:"dragalge",icon:"dragalge",id:"691"},{name:"Clauncher",value:"clauncher",icon:"clauncher",id:"692"},{name:"Clawitzer",value:"clawitzer",icon:"clawitzer",id:"693"},{name:"Helioptile",value:"helioptile",icon:"helioptile",id:"694",exclude:["sv"]},{name:"Heliolisk",value:"heliolisk",icon:"heliolisk",id:"695",exclude:["sv"]},{name:"Tyrunt",value:"tyrunt",icon:"tyrunt",id:"696",exclude:["sv"]},{name:"Tyrantrum",value:"tyrantrum",icon:"tyrantrum",id:"697",exclude:["sv"]},{name:"Amaura",value:"amaura",icon:"amaura",id:"698",exclude:["sv"]},{name:"Aurorus",value:"aurorus",icon:"aurorus",id:"699",exclude:["sv"]},{name:"Sylveon",value:"sylveon",icon:"sylveon",id:"700"},{name:"Hawlucha",value:"hawlucha",icon:"hawlucha",id:"701"},{name:"Dedenne",value:"dedenne",icon:"dedenne",id:"702"},{name:"Carbink",value:"carbink",icon:"carbink",id:"703"},{name:"Goomy",value:"goomy",icon:"goomy",id:"704"},{name:"Sliggoo",value:"sliggoo",icon:"sliggoo",id:"705"},{name:"Goodra",value:"goodra",icon:"goodra",id:"706"},{name:"Klefki",value:"klefki",icon:"klefki",id:"707"},{name:"Phantump",value:"phantump",icon:"phantump",id:"708",exclude:["sv"]},{name:"Trevenant",value:"trevenant",icon:"trevenant",id:"709",exclude:["sv"]},{name:"Pumpkaboo",value:"pumpkaboo",icon:"pumpkaboo",id:"710",exclude:["sv"]},{name:"Gourgeist",value:"gourgeist",icon:"gourgeist",id:"711",exclude:["sv"]},{name:"Bergmite",value:"bergmite",icon:"bergmite",id:"712"},{name:"Avalugg",value:"avalugg",icon:"avalugg",id:"713"},{name:"Noibat",value:"noibat",icon:"noibat",id:"714"},{name:"Noivern",value:"noivern",icon:"noivern",id:"715"},{name:"Xerneas",value:"xerneas",icon:"xerneas",id:"716",exclude:["sv"]},{name:"Yveltal",value:"yveltal",icon:"yveltal",id:"717",exclude:["sv"]},{name:"Zygarde",value:"zygarde",icon:"zygarde",id:"718",exclude:["sv"]},{name:"Diancie",value:"diancie",icon:"diancie",id:"719"},{name:"Hoopa",value:"hoopa",icon:"hoopa",id:"720",exclude:["swsh"]},{name:"Volcanion",value:"volcanion",icon:"volcanion",id:"721"},{name:"Rowlet",value:"rowlet",icon:"rowlet",id:"722"},{name:"Dartrix",value:"dartrix",icon:"dartrix",id:"723"},{name:"Decidueye",value:"decidueye",icon:"decidueye",id:"724"},{name:"Litten",value:"litten",icon:"litten",id:"725",exclude:["sv"]},{name:"Torracat",value:"torracat",icon:"torracat",id:"726",exclude:["sv"]},{name:"Incineroar",value:"incineroar",icon:"incineroar",id:"727",exclude:["sv"]},{name:"Popplio",value:"popplio",icon:"popplio",id:"728",exclude:["sv"]},{name:"Brionne",value:"brionne",icon:"brionne",id:"729",exclude:["sv"]},{name:"Primarina",value:"primarina",icon:"primarina",id:"730",exclude:["sv"]},{name:"Pikipek",value:"pikipek",icon:"pikipek",id:"731",exclude:["swsh","sv"]},{name:"Trumbeak",value:"trumbeak",icon:"trumbeak",id:"732",exclude:["swsh","sv"]},{name:"Toucannon",value:"toucannon",icon:"toucannon",id:"733",exclude:["swsh","sv"]},{name:"Yungoos",value:"yungoos",icon:"yungoos",id:"734",exclude:["swsh"]},{name:"Gumshoos",value:"gumshoos",icon:"gumshoos",id:"735",exclude:["swsh"]},{name:"Grubbin",value:"grubbin",icon:"grubbin",id:"736",exclude:["sv"]},{name:"Charjabug",value:"charjabug",icon:"charjabug",id:"737",exclude:["sv"]},{name:"Vikavolt",value:"vikavolt",icon:"vikavolt",id:"738",exclude:["sv"]},{name:"Crabrawler",value:"crabrawler",icon:"crabrawler",id:"739",exclude:["swsh"]},{name:"Crabominable",value:"crabominable",icon:"crabominable",id:"740",exclude:["swsh"]},{name:"Oricorio",value:"oricorio",icon:"oricorio",id:"741",exclude:["swsh"]},{name:"Cutiefly",value:"cutiefly",icon:"cutiefly",id:"742",exclude:["sv"]},{name:"Ribombee",value:"ribombee",icon:"ribombee",id:"743",exclude:["sv"]},{name:"Rockruff",value:"rockruff",icon:"rockruff",id:"744"},{name:"Lycanroc",value:"lycanroc",icon:"lycanroc",id:"745"},{name:"Wishiwashi",value:"wishiwashi",icon:"wishiwashi",id:"746",exclude:["sv"]},{name:"Mareanie",value:"mareanie",icon:"mareanie",id:"747"},{name:"Toxapex",value:"toxapex",icon:"toxapex",id:"748"},{name:"Mudbray",value:"mudbray",icon:"mudbray",id:"749"},{name:"Mudsdale",value:"mudsdale",icon:"mudsdale",id:"750"},{name:"Dewpider",value:"dewpider",icon:"dewpider",id:"751",exclude:["sv"]},{name:"Araquanid",value:"araquanid",icon:"araquanid",id:"752",exclude:["sv"]},{name:"Fomantis",value:"fomantis",icon:"fomantis",id:"753"},{name:"Lurantis",value:"lurantis",icon:"lurantis",id:"754"},{name:"Morelull",value:"morelull",icon:"morelull",id:"755",exclude:["sv"]},{name:"Shiinotic",value:"shiinotic",icon:"shiinotic",id:"756",exclude:["sv"]},{name:"Salandit",value:"salandit",icon:"salandit",id:"757"},{name:"Salazzle",value:"salazzle",icon:"salazzle",id:"758"},{name:"Stufful",value:"stufful",icon:"stufful",id:"759",exclude:["sv"]},{name:"Bewear",value:"bewear",icon:"bewear",id:"760",exclude:["sv"]},{name:"Bounsweet",value:"bounsweet",icon:"bounsweet",id:"761"},{name:"Steenee",value:"steenee",icon:"steenee",id:"762"},{name:"Tsareena",value:"tsareena",icon:"tsareena",id:"763"},{name:"Comfey",value:"comfey",icon:"comfey",id:"764",exclude:["sv"]},{name:"Oranguru",value:"oranguru",icon:"oranguru",id:"765"},{name:"Passimian",value:"passimian",icon:"passimian",id:"766"},{name:"Wimpod",value:"wimpod",icon:"wimpod",id:"767",exclude:["sv"]},{name:"Golisopod",value:"golisopod",icon:"golisopod",id:"768",exclude:["sv"]},{name:"Sandygast",value:"sandygast",icon:"sandygast",id:"769"},{name:"Palossand",value:"palossand",icon:"palossand",id:"770"},{name:"Pyukumuku",value:"pyukumuku",icon:"pyukumuku",id:"771",exclude:["sv"]},{name:"Type: Null",value:"type-null",icon:"type-null",id:"772",exclude:["sv"]},{name:"Silvally",value:"silvally",icon:"silvally",id:"773",exclude:["sv"]},{name:"Minior",value:"minior",icon:"minior",id:"774",exclude:["swsh","sv"]},{name:"Komala",value:"komala",icon:"komala",id:"775",exclude:["swsh"]},{name:"Turtonator",value:"turtonator",icon:"turtonator",id:"776",exclude:["sv"]},{name:"Togedemaru",value:"togedemaru",icon:"togedemaru",id:"777",exclude:["sv"]},{name:"Mimikyu",value:"mimikyu",icon:"mimikyu",id:"778"},{name:"Bruxish",value:"bruxish",icon:"bruxish",id:"779",exclude:["swsh"]},{name:"Drampa",value:"drampa",icon:"drampa",id:"780",exclude:["sv"]},{name:"Dhelmise",value:"dhelmise",icon:"dhelmise",id:"781",exclude:["sv"]},{name:"Jangmo-o",value:"jangmo-o",icon:"jangmo-o",id:"782",exclude:["sv"]},{name:"Hakamo-o",value:"hakamo-o",icon:"hakamo-o",id:"783",exclude:["sv"]},{name:"Kommo-o",value:"kommo-o",icon:"kommo-o",id:"784",exclude:["sv"]},{name:"Tapu Koko",value:"tapu-koko",icon:"tapu-koko",id:"785",exclude:["sv"]},{name:"Tapu Lele",value:"tapu-lele",icon:"tapu-lele",id:"786",exclude:["sv"]},{name:"Tapu Bulu",value:"tapu-bulu",icon:"tapu-bulu",id:"787",exclude:["sv"]},{name:"Tapu Fini",value:"tapu-fini",icon:"tapu-fini",id:"788",exclude:["sv"]},{name:"Cosmog",value:"cosmog",icon:"cosmog",id:"789",exclude:["sv"]},{name:"Cosmoem",value:"cosmoem",icon:"cosmoem",id:"790",exclude:["sv"]},{name:"Solgaleo",value:"solgaleo",icon:"solgaleo",id:"791",exclude:["sv"]},{name:"Lunala",value:"lunala",icon:"lunala",id:"792",exclude:["sv"]},{name:"Nihilego",value:"nihilego",icon:"nihilego",id:"793",exclude:["sv"]},{name:"Buzzwole",value:"buzzwole",icon:"buzzwole",id:"794",exclude:["sv"]},{name:"Pheromosa",value:"pheromosa",icon:"pheromosa",id:"795",exclude:["sv"]},{name:"Xurkitree",value:"xurkitree",icon:"xurkitree",id:"796",exclude:["sv"]},{name:"Celesteela",value:"celesteela",icon:"celesteela",id:"797",exclude:["sv"]},{name:"Kartana",value:"kartana",icon:"kartana",id:"798",exclude:["sv"]},{name:"Guzzlord",value:"guzzlord",icon:"guzzlord",id:"799",exclude:["sv"]},{name:"Necrozma",value:"necrozma",icon:"necrozma",id:"800",exclude:["sv"]},{name:"Magearna",value:"magearna",icon:"magearna",id:"801"},{name:"Marshadow",value:"marshadow",icon:"marshadow",id:"802",exclude:["sv"]},{name:"Poipole",value:"poipole",icon:"poipole",id:"803",exclude:["sv"]},{name:"Naganadel",value:"naganadel",icon:"naganadel",id:"804",exclude:["sv"]},{name:"Stakataka",value:"stakataka",icon:"stakataka",id:"805",exclude:["sv"]},{name:"Blacephalon",value:"blacephalon",icon:"blacephalon",id:"806",exclude:["sv"]},{name:"Zeraora",value:"zeraora",icon:"zeraora",id:"807",exclude:["sv"]},{name:"Meltan",value:"meltan",icon:"meltan",id:"808",exclude:["sv"]},{name:"Melmetal",value:"melmetal",icon:"melmetal",id:"809",exclude:["sv"]},{name:"Grookey",value:"grookey",icon:"grookey",id:"810"},{name:"Thwackey",value:"thwackey",icon:"thwackey",id:"811"},{name:"Rillaboom",value:"rillaboom",icon:"rillaboom",id:"812"},{name:"Scorbunny",value:"scorbunny",icon:"scorbunny",id:"813"},{name:"Raboot",value:"raboot",icon:"raboot",id:"814"},{name:"Cinderace",value:"cinderace",icon:"cinderace",id:"815"},{name:"Sobble",value:"sobble",icon:"sobble",id:"816"},{name:"Drizzile",value:"drizzile",icon:"drizzile",id:"817"},{name:"Inteleon",value:"inteleon",icon:"inteleon",id:"818"},{name:"Skwovet",value:"skwovet",icon:"skwovet",id:"819"},{name:"Greedent",value:"greedent",icon:"greedent",id:"820"},{name:"Rookidee",value:"rookidee",icon:"rookidee",id:"821"},{name:"Corvisquire",value:"corvisquire",icon:"corvisquire",id:"822"},{name:"Corviknight",value:"corviknight",icon:"corviknight",id:"823"},{name:"Blipbug",value:"blipbug",icon:"blipbug",id:"824",exclude:["sv"]},{name:"Dottler",value:"dottler",icon:"dottler",id:"825",exclude:["sv"]},{name:"Orbeetle",value:"orbeetle",icon:"orbeetle",id:"826",exclude:["sv"]},{name:"Nickit",value:"nickit",icon:"nickit",id:"827",exclude:["sv"]},{name:"Thievul",value:"thievul",icon:"thievul",id:"828",exclude:["sv"]},{name:"Gossifleur",value:"gossifleur",icon:"gossifleur",id:"829",exclude:["sv"]},{name:"Eldegoss",value:"eldegoss",icon:"eldegoss",id:"830",exclude:["sv"]},{name:"Wooloo",value:"wooloo",icon:"wooloo",id:"831",exclude:["sv"]},{name:"Dubwool",value:"dubwool",icon:"dubwool",id:"832",exclude:["sv"]},{name:"Chewtle",value:"chewtle",icon:"chewtle",id:"833"},{name:"Drednaw",value:"drednaw",icon:"drednaw",id:"834"},{name:"Yamper",value:"yamper",icon:"yamper",id:"835",exclude:["sv"]},{name:"Boltund",value:"boltund",icon:"boltund",id:"836",exclude:["sv"]},{name:"Rolycoly",value:"rolycoly",icon:"rolycoly",id:"837"},{name:"Carkol",value:"carkol",icon:"carkol",id:"838"},{name:"Coalossal",value:"coalossal",icon:"coalossal",id:"839"},{name:"Applin",value:"applin",icon:"applin",id:"840"},{name:"Flapple",value:"flapple",icon:"flapple",id:"841"},{name:"Appletun",value:"appletun",icon:"appletun",id:"842"},{name:"Silicobra",value:"silicobra",icon:"silicobra",id:"843"},{name:"Sandaconda",value:"sandaconda",icon:"sandaconda",id:"844"},{name:"Cramorant",value:"cramorant",icon:"cramorant",id:"845",exclude:["sv"]},{name:"Arrokuda",value:"arrokuda",icon:"arrokuda",id:"846"},{name:"Barraskewda",value:"barraskewda",icon:"barraskewda",id:"847"},{name:"Toxel",value:"toxel",icon:"toxel",id:"848"},{name:"Toxtricity",value:"toxtricity",icon:"toxtricity",id:"849"},{name:"Sizzlipede",value:"sizzlipede",icon:"sizzlipede",id:"850",exclude:["sv"]},{name:"Centiskorch",value:"centiskorch",icon:"centiskorch",id:"851",exclude:["sv"]},{name:"Clobbopus",value:"clobbopus",icon:"clobbopus",id:"852",exclude:["sv"]},{name:"Grapploct",value:"grapploct",icon:"grapploct",id:"853",exclude:["sv"]},{name:"Sinistea",value:"sinistea",icon:"sinistea",id:"854"},{name:"Polteageist",value:"polteageist",icon:"polteageist",id:"855"},{name:"Hatenna",value:"hatenna",icon:"hatenna",id:"856"},{name:"Hattrem",value:"hattrem",icon:"hattrem",id:"857"},{name:"Hatterene",value:"hatterene",icon:"hatterene",id:"858"},{name:"Impidimp",value:"impidimp",icon:"impidimp",id:"859"},{name:"Morgrem",value:"morgrem",icon:"morgrem",id:"860"},{name:"Grimmsnarl",value:"grimmsnarl",icon:"grimmsnarl",id:"861"},{name:"Obstagoon",value:"obstagoon",icon:"obstagoon",id:"862",exclude:["sv"]},{name:"Perrserker",value:"perrserker",icon:"perrserker",id:"863"},{name:"Cursola",value:"cursola",icon:"cursola",id:"864",exclude:["sv"]},{name:"Sirfetch'd",value:"sirfetchd",icon:"sirfetchd",id:"865",exclude:["sv"]},{name:"Mr. Rime",value:"mr-rime",icon:"mr-rime",id:"866",exclude:["sv"]},{name:"Runerigus",value:"runerigus",icon:"runerigus",id:"867",exclude:["sv"]},{name:"Milcery",value:"milcery",icon:"milcery",id:"868",exclude:["sv"]},{name:"Alcremie",value:"alcremie",icon:"alcremie",id:"869",exclude:["sv"]},{name:"Falinks",value:"falinks",icon:"falinks",id:"870"},{name:"Pincurchin",value:"pincurchin",icon:"pincurchin",id:"871"},{name:"Snom",value:"snom",icon:"snom",id:"872"},{name:"Frosmoth",value:"frosmoth",icon:"frosmoth",id:"873"},{name:"Stonjourner",value:"stonjourner",icon:"stonjourner",id:"874"},{name:"Eiscue",value:"eiscue",icon:"eiscue",id:"875"},{name:"Indeedee",value:"indeedee",icon:"indeedee",id:"876"},{name:"Morpeko",value:"morpeko",icon:"morpeko",id:"877",exclude:["sv"]},{name:"Cufant",value:"cufant",icon:"cufant",id:"878"},{name:"Copperajah",value:"copperajah",icon:"copperajah",id:"879"},{name:"Dracozolt",value:"dracozolt",icon:"dracozolt",id:"880",exclude:["sv"]},{name:"Arctozolt",value:"arctozolt",icon:"arctozolt",id:"881",exclude:["sv"]},{name:"Dracovish",value:"dracovish",icon:"dracovish",id:"882",exclude:["sv"]},{name:"Arctovish",value:"arctovish",icon:"arctovish",id:"883",exclude:["sv"]},{name:"Duraludon",value:"duraludon",icon:"duraludon",id:"884",exclude:["sv"]},{name:"Dreepy",value:"dreepy",icon:"dreepy",id:"885"},{name:"Drakloak",value:"drakloak",icon:"drakloak",id:"886"},{name:"Dragapult",value:"dragapult",icon:"dragapult",id:"887"},{name:"Zacian",value:"zacian",icon:"zacian",id:"888"},{name:"Zamazenta",value:"zamazenta",icon:"zamazenta",id:"889"},{name:"Eternatus",value:"eternatus",icon:"eternatus",id:"890"},{name:"Kubfu",value:"kubfu",icon:"kubfu",id:"891"},{name:"Urshifu",value:"urshifu",icon:"urshifu",id:"892"},{name:"Zarude",value:"zarude",icon:"zarude",id:"893"},{name:"Regieleki",value:"regieleki",icon:"regieleki",id:"894"},{name:"Regidrago",value:"regidrago",icon:"regidrago",id:"895"},{name:"Glastrier",value:"glastrier",icon:"glastrier",id:"896"},{name:"Spectrier",value:"spectrier",icon:"spectrier",id:"897"},{name:"Calyrex",value:"calyrex",icon:"calyrex",id:"898"},{name:"Wyrdeer",value:"wyrdeer",icon:"wyrdeer",id:"899"},{name:"Kleavor",value:"kleavor",icon:"kleavor",id:"900"},{name:"Ursaluna",value:"ursaluna",icon:"ursaluna",id:"901"},{name:"Basculegion",value:"basculegion",icon:"basculegion",id:"902"},{name:"Sneasler",value:"sneasler",icon:"sneasler",id:"903"},{name:"Overqwil",value:"overqwil",icon:"overqwil",id:"904"},{name:"Enamorus",value:"enamorus",icon:"enamorus",id:"905"},{name:"Sprigatito",value:"sprigatito",icon:"sprigatito"},{name:"Floragato",value:"floragato",icon:"floragato"},{name:"Meowscarada",value:"meowscarada",icon:"meowscarada"},{name:"Fuecoco",value:"fuecoco",icon:"fuecoco"},{name:"Crocalor",value:"crocalor",icon:"crocalor"},{name:"Skeledirge",value:"skeledirge",icon:"skeledirge"},{name:"Quaxly",value:"quaxly",icon:"quaxly"},{name:"Quaxwell",value:"quaxwell",icon:"quaxwell"},{name:"Quaquaval",value:"quaquaval",icon:"quaquaval"},{name:"Lechonk",value:"lechonk",icon:"lechonk"},{name:"Oinkologne",value:"oinkologne",icon:"oinkologne"},{name:"Tarountula",value:"tarountula",icon:"tarountula"},{name:"Spidops",value:"spidops",icon:"spidops"},{name:"Nymble",value:"nymble",icon:"nymble"},{name:"Lokix",value:"lokix",icon:"lokix"},{name:"Pawmi",value:"pawmi",icon:"pawmi"},{name:"Pawmo",value:"pawmo",icon:"pawmo"},{name:"Pawmot",value:"pawmot",icon:"pawmot"},{name:"Tandemaus",value:"tandemaus",icon:"tandemaus"},{name:"Maushold",value:"maushold",icon:"maushold"},{name:"Fidough",value:"fidough",icon:"fidough"},{name:"Dachsbun",value:"dachsbun",icon:"dachsbun"},{name:"Smoliv",value:"smoliv",icon:"smoliv"},{name:"Dolliv",value:"dolliv",icon:"dolliv"},{name:"Arboliva",value:"arboliva",icon:"arboliva"},{name:"Squawkabilly",value:"squawkabilly",icon:"squawkabilly"},{name:"Nacli",value:"nacli",icon:"nacli"},{name:"Naclstack",value:"naclstack",icon:"naclstack"},{name:"Garganacl",value:"garganacl",icon:"garganacl"},{name:"Charcadet",value:"charcadet",icon:"charcadet"},{name:"Armarouge",value:"armarouge",icon:"armarouge"},{name:"Ceruledge",value:"ceruledge",icon:"ceruledge"},{name:"Tadbulb",value:"tadbulb",icon:"tadbulb"},{name:"Bellibolt",value:"bellibolt",icon:"bellibolt"},{name:"Wattrel",value:"wattrel",icon:"wattrel"},{name:"Kilowattrel",value:"kilowattrel",icon:"kilowattrel"},{name:"Maschiff",value:"maschiff",icon:"maschiff"},{name:"Mabosstiff",value:"mabosstiff",icon:"mabosstiff"},{name:"Shroodle",value:"shroodle",icon:"shroodle"},{name:"Grafaiai",value:"grafaiai",icon:"grafaiai"},{name:"Bramblin",value:"bramblin",icon:"bramblin"},{name:"Brambleghast",value:"brambleghast",icon:"brambleghast"},{name:"Toedscool",value:"toedscool",icon:"toedscool"},{name:"Toedscruel",value:"toedscruel",icon:"toedscruel"},{name:"Klawf",value:"klawf",icon:"klawf"},{name:"Capsakid",value:"capsakid",icon:"capsakid"},{name:"Scovillain",value:"scovillain",icon:"scovillain"},{name:"Rellor",value:"rellor",icon:"rellor"},{name:"Rabsca",value:"rabsca",icon:"rabsca"},{name:"Flittle",value:"flittle",icon:"flittle"},{name:"Espathra",value:"espathra",icon:"espathra"},{name:"Tinkatink",value:"tinkatink",icon:"tinkatink"},{name:"Tinkatuff",value:"tinkatuff",icon:"tinkatuff"},{name:"Tinkaton",value:"tinkaton",icon:"tinkaton"},{name:"Wiglett",value:"wiglett",icon:"wiglett"},{name:"Wugtrio",value:"wugtrio",icon:"wugtrio"},{name:"Bombirdier",value:"bombirdier",icon:"bombirdier"},{name:"Finizen",value:"finizen",icon:"finizen"},{name:"Palafin",value:"palafin",icon:"palafin"},{name:"Varoom",value:"varoom",icon:"varoom"},{name:"Revavroom",value:"revavroom",icon:"revavroom"},{name:"Cyclizar",value:"cyclizar",icon:"cyclizar"},{name:"Orthworm",value:"orthworm",icon:"orthworm"},{name:"Glimmet",value:"glimmet",icon:"glimmet"},{name:"Glimmora",value:"glimmora",icon:"glimmora"},{name:"Greavard",value:"greavard",icon:"greavard"},{name:"Houndstone",value:"houndstone",icon:"houndstone"},{name:"Flamigo",value:"flamigo",icon:"flamigo"},{name:"Cetoddle",value:"cetoddle",icon:"cetoddle"},{name:"Cetitan",value:"cetitan",icon:"cetitan"},{name:"Veluza",value:"veluza",icon:"veluza"},{name:"Dondozo",value:"dondozo",icon:"dondozo"},{name:"Tatsugiri",value:"tatsugiri",icon:"tatsugiri"},{name:"Annihilape",value:"annihilape",icon:"annihilape"},{name:"Clodsire",value:"clodsire",icon:"clodsire"},{name:"Farigiraf",value:"farigiraf",icon:"farigiraf"},{name:"Dudunsparce",value:"dudunsparce",icon:"dudunsparce"},{name:"Kingambit",value:"kingambit",icon:"kingambit"},{name:"Great Tusk",value:"greattusk",icon:"greattusk"},{name:"Scream Tail",value:"screamtail",icon:"screamtail"},{name:"Brute Bonnet",value:"brutebonnet",icon:"brutebonnet"},{name:"Flutter Mane",value:"fluttermane",icon:"fluttermane"},{name:"Slither Wing",value:"slitherwing",icon:"slitherwing"},{name:"Sandy Shocks",value:"sandyshocks",icon:"sandyshocks"},{name:"Iron Treads",value:"irontreads",icon:"irontreads"},{name:"Iron Bundle",value:"ironbundle",icon:"ironbundle"},{name:"Iron Hands",value:"ironhands",icon:"ironhands"},{name:"Iron Jugulis",value:"ironjugulis",icon:"ironjugulis"},{name:"Iron Moth",value:"ironmoth",icon:"ironmoth"},{name:"Iron Thorns",value:"ironthorns",icon:"ironthorns"},{name:"Frigibax",value:"frigibax",icon:"frigibax"},{name:"Arctibax",value:"arctibax",icon:"arctibax"},{name:"Baxcalibur",value:"baxcalibur",icon:"baxcalibur"},{name:"Gimmighoul",value:"gimmighoul",icon:"gimmighoul"},{name:"Gholdengo",value:"gholdengo",icon:"gholdengo"},{name:"Wo-Chien",value:"wo-chien",icon:"wo-chien"},{name:"Chien-Pao",value:"chien-pao",icon:"chien-pao"},{name:"Ting-Lu",value:"ting-lu",icon:"ting-lu"},{name:"Chi-Yu",value:"chi-yu",icon:"chi-yu"},{name:"Roaring Moon",value:"roaringmoon",icon:"roaringmoon"},{name:"Iron Valiant",value:"ironvaliant",icon:"ironvaliant"},{name:"Koraidon",value:"koraidon",icon:"koraidon"},{name:"Miraidon",value:"miraidon",icon:"miraidon"}];const nameTranslations={1:{english:"Bulbasaur",german:"Bisasam"},2:{english:"Ivysaur",german:"Bisaknosp"},3:{english:"Venusaur",german:"Bisaflor"},4:{english:"Charmander",german:"Glumanda"},5:{english:"Charmeleon",german:"Glutexo"},6:{english:"Charizard",german:"Glurak"},7:{english:"Squirtle",german:"Schiggy"},8:{english:"Wartortle",german:"Schillok"},9:{english:"Blastoise",german:"Turtok"},10:{english:"Caterpie",german:"Raupy"},11:{english:"Metapod",german:"Safcon"},12:{english:"Butterfree",german:"Smettbo"},13:{english:"Weedle",german:"Hornliu"},14:{english:"Kakuna",german:"Kokuna"},15:{english:"Beedrill",german:"Bibor"},16:{english:"Pidgey",german:"Taubsi"},17:{english:"Pidgeotto",german:"Tauboga"},18:{english:"Pidgeot",german:"Tauboss"},19:{english:"Rattata",german:"Rattfratz"},20:{english:"Raticate",german:"Rattikarl"},21:{english:"Spearow",german:"Habitak"},22:{english:"Fearow",german:"Ibitak"},23:{english:"Ekans",german:"Rettan"},24:{english:"Arbok",german:"Arbok"},25:{english:"Pikachu",german:"Pikachu"},26:{english:"Raichu",german:"Raichu"},27:{english:"Sandshrew",german:"Sandan"},28:{english:"Sandslash",german:"Sandamer"},29:{english:"Nidoran♀",german:"Nidoran♀"},30:{english:"Nidorina",german:"Nidorina"},31:{english:"Nidoqueen",german:"Nidoqueen"},32:{english:"Nidoran♂",german:"Nidoran♂"},33:{english:"Nidorino",german:"Nidorino"},34:{english:"Nidoking",german:"Nidoking"},35:{english:"Clefairy",german:"Piepi"},36:{english:"Clefable",german:"Pixi"},37:{english:"Vulpix",german:"Vulpix"},38:{english:"Ninetales",german:"Vulnona"},39:{english:"Jigglypuff",german:"Pummeluff"},40:{english:"Wigglytuff",german:"Knuddeluff"},41:{english:"Zubat",german:"Zubat"},42:{english:"Golbat",german:"Golbat"},43:{english:"Oddish",german:"Myrapla"},44:{english:"Gloom",german:"Duflor"},45:{english:"Vileplume",german:"Giflor"},46:{english:"Paras",german:"Paras"},47:{english:"Parasect",german:"Parasek"},48:{english:"Venonat",german:"Bluzuk"},49:{english:"Venomoth",german:"Omot"},50:{english:"Diglett",german:"Digda"},51:{english:"Dugtrio",german:"Digdri"},52:{english:"Meowth",german:"Mauzi"},53:{english:"Persian",german:"Snobilikat"},54:{english:"Psyduck",german:"Enton"},55:{english:"Golduck",german:"Entoron"},56:{english:"Mankey",german:"Menki"},57:{english:"Primeape",german:"Rasaff"},58:{english:"Growlithe",german:"Fukano"},59:{english:"Arcanine",german:"Arkani"},60:{english:"Poliwag",german:"Quapsel"},61:{english:"Poliwhirl",german:"Quaputzi"},62:{english:"Poliwrath",german:"Quappo"},63:{english:"Abra",german:"Abra"},64:{english:"Kadabra",german:"Kadabra"},65:{english:"Alakazam",german:"Simsala"},66:{english:"Machop",german:"Machollo"},67:{english:"Machoke",german:"Maschock"},68:{english:"Machamp",german:"Machomei"},69:{english:"Bellsprout",german:"Knofensa"},70:{english:"Weepinbell",german:"Ultrigaria"},71:{english:"Victreebel",german:"Sarzenia"},72:{english:"Tentacool",german:"Tentacha"},73:{english:"Tentacruel",german:"Tentoxa"},74:{english:"Geodude",german:"Kleinstein"},75:{english:"Graveler",german:"Georok"},76:{english:"Golem",german:"Geowaz"},77:{english:"Ponyta",german:"Ponita"},78:{english:"Rapidash",german:"Gallopa"},79:{english:"Slowpoke",german:"Flegmon"},80:{english:"Slowbro",german:"Lahmus"},81:{english:"Magnemite",german:"Magnetilo"},82:{english:"Magneton",german:"Magneton"},83:{english:"Farfetch’d",german:"Porenta"},84:{english:"Doduo",german:"Dodu"},85:{english:"Dodrio",german:"Dodri"},86:{english:"Seel",german:"Jurob"},87:{english:"Dewgong",german:"Jugong"},88:{english:"Grimer",german:"Sleima"},89:{english:"Muk",german:"Sleimok"},90:{english:"Shellder",german:"Muschas"},91:{english:"Cloyster",german:"Austos"},92:{english:"Gastly",german:"Nebulak"},93:{english:"Haunter",german:"Alpollo"},94:{english:"Gengar",german:"Gengar"},95:{english:"Onix",german:"Onix"},96:{english:"Drowzee",german:"Traumato"},97:{english:"Hypno",german:"Hypno"},98:{english:"Krabby",german:"Krabby"},99:{english:"Kingler",german:"Kingler"},100:{english:"Voltorb",german:"Voltobal"},101:{english:"Electrode",german:"Lektrobal"},102:{english:"Exeggcute",german:"Owei"},103:{english:"Exeggutor",german:"Kokowei"},104:{english:"Cubone",german:"Tragosso"},105:{english:"Marowak",german:"Knogga"},106:{english:"Hitmonlee",german:"Kicklee"},107:{english:"Hitmonchan",german:"Nockchan"},108:{english:"Lickitung",german:"Schlurp"},109:{english:"Koffing",german:"Smogon"},110:{english:"Weezing",german:"Smogmog"},111:{english:"Rhyhorn",german:"Rihorn"},112:{english:"Rhydon",german:"Rizeros"},113:{english:"Chansey",german:"Chaneira"},114:{english:"Tangela",german:"Tangela"},115:{english:"Kangaskhan",german:"Kangama"},116:{english:"Horsea",german:"Seeper"},117:{english:"Seadra",german:"Seemon"},118:{english:"Goldeen",german:"Goldini"},119:{english:"Seaking",german:"Golking"},120:{english:"Staryu",german:"Sterndu"},121:{english:"Starmie",german:"Starmie"},122:{english:"Mr. Mime",german:"Pantimos"},123:{english:"Scyther",german:"Sichlor"},124:{english:"Jynx",german:"Rossana"},125:{english:"Electabuzz",german:"Elektek"},126:{english:"Magmar",german:"Magmar"},127:{english:"Pinsir",german:"Pinsir"},128:{english:"Tauros",german:"Tauros"},129:{english:"Magikarp",german:"Karpador"},130:{english:"Gyarados",german:"Garados"},131:{english:"Lapras",german:"Lapras"},132:{english:"Ditto",german:"Ditto"},133:{english:"Eevee",german:"Evoli"},134:{english:"Vaporeon",german:"Aquana"},135:{english:"Jolteon",german:"Blitza"},136:{english:"Flareon",german:"Flamara"},137:{english:"Porygon",german:"Porygon"},138:{english:"Omanyte",german:"Amonitas"},139:{english:"Omastar",german:"Amoroso"},140:{english:"Kabuto",german:"Kabuto"},141:{english:"Kabutops",german:"Kabutops"},142:{english:"Aerodactyl",german:"Aerodactyl"},143:{english:"Snorlax",german:"Relaxo"},144:{english:"Articuno",german:"Arktos"},145:{english:"Zapdos",german:"Zapdos"},146:{english:"Moltres",german:"Lavados"},147:{english:"Dratini",german:"Dratini"},148:{english:"Dragonair",german:"Dragonir"},149:{english:"Dragonite",german:"Dragoran"},150:{english:"Mewtwo",german:"Mewtu"},151:{english:"Mew",german:"Mew"},152:{english:"Chikorita",german:"Endivie"},153:{english:"Bayleef",german:"Lorblatt"},154:{english:"Meganium",german:"Meganie"},155:{english:"Cyndaquil",german:"Feurigel"},156:{english:"Quilava",german:"Igelavar"},157:{english:"Typhlosion",german:"Tornupto"},158:{english:"Totodile",german:"Karnimani"},159:{english:"Croconaw",german:"Tyracroc"},160:{english:"Feraligatr",german:"Impergator"},161:{english:"Sentret",german:"Wiesor"},162:{english:"Furret",german:"Wiesenior"},163:{english:"Hoothoot",german:"Hoothoot"},164:{english:"Noctowl",german:"Noctuh"},165:{english:"Ledyba",german:"Ledyba"},166:{english:"Ledian",german:"Ledian"},167:{english:"Spinarak",german:"Webarak"},168:{english:"Ariados",german:"Ariados"},169:{english:"Crobat",german:"Iksbat"},170:{english:"Chinchou",german:"Lampi"},171:{english:"Lanturn",german:"Lanturn"},172:{english:"Pichu",german:"Pichu"},173:{english:"Cleffa",german:"Pii"},174:{english:"Igglybuff",german:"Fluffeluff"},175:{english:"Togepi",german:"Togepi"},176:{english:"Togetic",german:"Togetic"},177:{english:"Natu",german:"Natu"},178:{english:"Xatu",german:"Xatu"},179:{english:"Mareep",german:"Voltilamm"},180:{english:"Flaaffy",german:"Waaty"},181:{english:"Ampharos",german:"Ampharos"},182:{english:"Bellossom",german:"Blubella"},183:{english:"Marill",german:"Marill"},184:{english:"Azumarill",german:"Azumarill"},185:{english:"Sudowoodo",german:"Mogelbaum"},186:{english:"Politoed",german:"Quaxo"},187:{english:"Hoppip",german:"Hoppspross"},188:{english:"Skiploom",german:"Hubelupf"},189:{english:"Jumpluff",german:"Papungha"},190:{english:"Aipom",german:"Griffel"},191:{english:"Sunkern",german:"Sonnkern"},192:{english:"Sunflora",german:"Sonnflora"},193:{english:"Yanma",german:"Yanma"},194:{english:"Wooper",german:"Felino"},195:{english:"Quagsire",german:"Morlord"},196:{english:"Espeon",german:"Psiana"},197:{english:"Umbreon",german:"Nachtara"},198:{english:"Murkrow",german:"Kramurx"},199:{english:"Slowking",german:"Laschoking"},200:{english:"Misdreavus",german:"Traunfugil"},201:{english:"Unown",german:"Icognito"},202:{english:"Wobbuffet",german:"Woingenau"},203:{english:"Girafarig",german:"Girafarig"},204:{english:"Pineco",german:"Tannza"},205:{english:"Forretress",german:"Forstellka"},206:{english:"Dunsparce",german:"Dummisel"},207:{english:"Gligar",german:"Skorgla"},208:{english:"Steelix",german:"Stahlos"},209:{english:"Snubbull",german:"Snubbull"},210:{english:"Granbull",german:"Granbull"},211:{english:"Qwilfish",german:"Baldorfish"},212:{english:"Scizor",german:"Scherox"},213:{english:"Shuckle",german:"Pottrott"},214:{english:"Heracross",german:"Skaraborn"},215:{english:"Sneasel",german:"Sniebel"},216:{english:"Teddiursa",german:"Teddiursa"},217:{english:"Ursaring",german:"Ursaring"},218:{english:"Slugma",german:"Schneckmag"},219:{english:"Magcargo",german:"Magcargo"},220:{english:"Swinub",german:"Quiekel"},221:{english:"Piloswine",german:"Keifel"},222:{english:"Corsola",german:"Corasonn"},223:{english:"Remoraid",german:"Remoraid"},224:{english:"Octillery",german:"Octillery"},225:{english:"Delibird",german:"Botogel"},226:{english:"Mantine",german:"Mantax"},227:{english:"Skarmory",german:"Panzaeron"},228:{english:"Houndour",german:"Hunduster"},229:{english:"Houndoom",german:"Hundemon"},230:{english:"Kingdra",german:"Seedraking"},231:{english:"Phanpy",german:"Phanpy"},232:{english:"Donphan",german:"Donphan"},233:{english:"Porygon2",german:"Porygon2"},234:{english:"Stantler",german:"Damhirplex"},235:{english:"Smeargle",german:"Farbeagle"},236:{english:"Tyrogue",german:"Rabauz"},237:{english:"Hitmontop",german:"Kapoera"},238:{english:"Smoochum",german:"Kussilla"},239:{english:"Elekid",german:"Elekid"},240:{english:"Magby",german:"Magby"},241:{english:"Miltank",german:"Miltank"},242:{english:"Blissey",german:"Heiteira"},243:{english:"Raikou",german:"Raikou"},244:{english:"Entei",german:"Entei"},245:{english:"Suicune",german:"Suicune"},246:{english:"Larvitar",german:"Larvitar"},247:{english:"Pupitar",german:"Pupitar"},248:{english:"Tyranitar",german:"Despotar"},249:{english:"Lugia",german:"Lugia"},250:{english:"Ho-Oh",german:"Ho-Oh"},251:{english:"Celebi",german:"Celebi"},252:{english:"Treecko",german:"Geckarbor"},253:{english:"Grovyle",german:"Reptain"},254:{english:"Sceptile",german:"Gewaldro"},255:{english:"Torchic",german:"Flemmli"},256:{english:"Combusken",german:"Jungglut"},257:{english:"Blaziken",german:"Lohgock"},258:{english:"Mudkip",german:"Hydropi"},259:{english:"Marshtomp",german:"Moorabbel"},260:{english:"Swampert",german:"Sumpex"},261:{english:"Poochyena",german:"Fiffyen"},262:{english:"Mightyena",german:"Magnayen"},263:{english:"Zigzagoon",german:"Zigzachs"},264:{english:"Linoone",german:"Geradaks"},265:{english:"Wurmple",german:"Waumpel"},266:{english:"Silcoon",german:"Schaloko"},267:{english:"Beautifly",german:"Papinella"},268:{english:"Cascoon",german:"Panekon"},269:{english:"Dustox",german:"Pudox"},270:{english:"Lotad",german:"Loturzel"},271:{english:"Lombre",german:"Lombrero"},272:{english:"Ludicolo",german:"Kappalores"},273:{english:"Seedot",german:"Samurzel"},274:{english:"Nuzleaf",german:"Blanas"},275:{english:"Shiftry",german:"Tengulist"},276:{english:"Taillow",german:"Schwalbini"},277:{english:"Swellow",german:"Schwalboss"},278:{english:"Wingull",german:"Wingull"},279:{english:"Pelipper",german:"Pelipper"},280:{english:"Ralts",german:"Trasla"},281:{english:"Kirlia",german:"Kirlia"},282:{english:"Gardevoir",german:"Guardevoir"},283:{english:"Surskit",german:"Gehweiher"},284:{english:"Masquerain",german:"Maskeregen"},285:{english:"Shroomish",german:"Knilz"},286:{english:"Breloom",german:"Kapilz"},287:{english:"Slakoth",german:"Bummelz"},288:{english:"Vigoroth",german:"Muntier"},289:{english:"Slaking",german:"Letarking"},290:{english:"Nincada",german:"Nincada"},291:{english:"Ninjask",german:"Ninjask"},292:{english:"Shedinja",german:"Ninjatom"},293:{english:"Whismur",german:"Flurmel"},294:{english:"Loudred",german:"Krakeelo"},295:{english:"Exploud",german:"Krawumms"},296:{english:"Makuhita",german:"Makuhita"},297:{english:"Hariyama",german:"Hariyama"},298:{english:"Azurill",german:"Azurill"},299:{english:"Nosepass",german:"Nasgnet"},300:{english:"Skitty",german:"Eneco"},301:{english:"Delcatty",german:"Enekoro"},302:{english:"Sableye",german:"Zobiris"},303:{english:"Mawile",german:"Flunkifer"},304:{english:"Aron",german:"Stollunior"},305:{english:"Lairon",german:"Stollrak"},306:{english:"Aggron",german:"Stolloss"},307:{english:"Meditite",german:"Meditie"},308:{english:"Medicham",german:"Meditalis"},309:{english:"Electrike",german:"Frizelbliz"},310:{english:"Manectric",german:"Voltenso"},311:{english:"Plusle",german:"Plusle"},312:{english:"Minun",german:"Minun"},313:{english:"Volbeat",german:"Volbeat"},314:{english:"Illumise",german:"Illumise"},315:{english:"Roselia",german:"Roselia"},316:{english:"Gulpin",german:"Schluppuck"},317:{english:"Swalot",german:"Schlukwech"},318:{english:"Carvanha",german:"Kanivanha"},319:{english:"Sharpedo",german:"Tohaido"},320:{english:"Wailmer",german:"Wailmer"},321:{english:"Wailord",german:"Wailord"},322:{english:"Numel",german:"Camaub"},323:{english:"Camerupt",german:"Camerupt"},324:{english:"Torkoal",german:"Qurtel"},325:{english:"Spoink",german:"Spoink"},326:{english:"Grumpig",german:"Groink"},327:{english:"Spinda",german:"Pandir"},328:{english:"Trapinch",german:"Knacklion"},329:{english:"Vibrava",german:"Vibrava"},330:{english:"Flygon",german:"Libelldra"},331:{english:"Cacnea",german:"Tuska"},332:{english:"Cacturne",german:"Noktuska"},333:{english:"Swablu",german:"Wablu"},334:{english:"Altaria",german:"Altaria"},335:{english:"Zangoose",german:"Sengo"},336:{english:"Seviper",german:"Vipitis"},337:{english:"Lunatone",german:"Lunastein"},338:{english:"Solrock",german:"Sonnfel"},339:{english:"Barboach",german:"Schmerbe"},340:{english:"Whiscash",german:"Welsar"},341:{english:"Corphish",german:"Krebscorps"},342:{english:"Crawdaunt",german:"Krebutack"},343:{english:"Baltoy",german:"Puppance"},344:{english:"Claydol",german:"Lepumentas"},345:{english:"Lileep",german:"Liliep"},346:{english:"Cradily",german:"Wielie"},347:{english:"Anorith",german:"Anorith"},348:{english:"Armaldo",german:"Armaldo"},349:{english:"Feebas",german:"Barschwa"},350:{english:"Milotic",german:"Milotic"},351:{english:"Castform",german:"Formeo"},352:{english:"Kecleon",german:"Kecleon"},353:{english:"Shuppet",german:"Shuppet"},354:{english:"Banette",german:"Banette"},355:{english:"Duskull",german:"Zwirrlicht"},356:{english:"Dusclops",german:"Zwirrklop"},357:{english:"Tropius",german:"Tropius"},358:{english:"Chimecho",german:"Palimpalim"},359:{english:"Absol",german:"Absol"},360:{english:"Wynaut",german:"Isso"},361:{english:"Snorunt",german:"Schneppke"},362:{english:"Glalie",german:"Firnontor"},363:{english:"Spheal",german:"Seemops"},364:{english:"Sealeo",german:"Seejong"},365:{english:"Walrein",german:"Walraisa"},366:{english:"Clamperl",german:"Perlu"},367:{english:"Huntail",german:"Aalabyss"},368:{english:"Gorebyss",german:"Saganabyss"},369:{english:"Relicanth",german:"Relicanth"},370:{english:"Luvdisc",german:"Liebiskus"},371:{english:"Bagon",german:"Kindwurm"},372:{english:"Shelgon",german:"Draschel"},373:{english:"Salamence",german:"Brutalanda"},374:{english:"Beldum",german:"Tanhel"},375:{english:"Metang",german:"Metang"},376:{english:"Metagross",german:"Metagross"},377:{english:"Regirock",german:"Regirock"},378:{english:"Regice",german:"Regice"},379:{english:"Registeel",german:"Registeel"},380:{english:"Latias",german:"Latias"},381:{english:"Latios",german:"Latios"},382:{english:"Kyogre",german:"Kyogre"},383:{english:"Groudon",german:"Groudon"},384:{english:"Rayquaza",german:"Rayquaza"},385:{english:"Jirachi",german:"Jirachi"},386:{english:"Deoxys",german:"Deoxys"},387:{english:"Turtwig",german:"Chelast"},388:{english:"Grotle",german:"Chelcarain"},389:{english:"Torterra",german:"Chelterrar"},390:{english:"Chimchar",german:"Panflam"},391:{english:"Monferno",german:"Panpyro"},392:{english:"Infernape",german:"Panferno"},393:{english:"Piplup",german:"Plinfa"},394:{english:"Prinplup",german:"Pliprin"},395:{english:"Empoleon",german:"Impoleon"},396:{english:"Starly",german:"Staralili"},397:{english:"Staravia",german:"Staravia"},398:{english:"Staraptor",german:"Staraptor"},399:{english:"Bidoof",german:"Bidiza"},400:{english:"Bibarel",german:"Bidifas"},401:{english:"Kricketot",german:"Zirpurze"},402:{english:"Kricketune",german:"Zirpeise"},403:{english:"Shinx",german:"Sheinux"},404:{english:"Luxio",german:"Luxio"},405:{english:"Luxray",german:"Luxtra"},406:{english:"Budew",german:"Knospi"},407:{english:"Roserade",german:"Roserade"},408:{english:"Cranidos",german:"Koknodon"},409:{english:"Rampardos",german:"Rameidon"},410:{english:"Shieldon",german:"Schilterus"},411:{english:"Bastiodon",german:"Bollterus"},412:{english:"Burmy",german:"Burmy"},413:{english:"Wormadam",german:"Burmadame"},414:{english:"Mothim",german:"Moterpel"},415:{english:"Combee",german:"Wadribie"},416:{english:"Vespiquen",german:"Honweisel"},417:{english:"Pachirisu",german:"Pachirisu"},418:{english:"Buizel",german:"Bamelin"},419:{english:"Floatzel",german:"Bojelin"},420:{english:"Cherubi",german:"Kikugi"},421:{english:"Cherrim",german:"Kinoso"},422:{english:"Shellos",german:"Schalellos"},423:{english:"Gastrodon",german:"Gastrodon"},424:{english:"Ambipom",german:"Ambidiffel"},425:{english:"Drifloon",german:"Driftlon"},426:{english:"Drifblim",german:"Drifzepeli"},427:{english:"Buneary",german:"Haspiror"},428:{english:"Lopunny",german:"Schlapor"},429:{english:"Mismagius",german:"Traunmagil"},430:{english:"Honchkrow",german:"Kramshef"},431:{english:"Glameow",german:"Charmian"},432:{english:"Purugly",german:"Shnurgarst"},433:{english:"Chingling",german:"Klingplim"},434:{english:"Stunky",german:"Skunkapuh"},435:{english:"Skuntank",german:"Skuntank"},436:{english:"Bronzor",german:"Bronzel"},437:{english:"Bronzong",german:"Bronzong"},438:{english:"Bonsly",german:"Mobai"},439:{english:"Mime Jr.",german:"Pantimimi"},440:{english:"Happiny",german:"Wonneira"},441:{english:"Chatot",german:"Plaudagei"},442:{english:"Spiritomb",german:"Kryppuk"},443:{english:"Gible",german:"Kaumalat"},444:{english:"Gabite",german:"Knarksel"},445:{english:"Garchomp",german:"Knakrack"},446:{english:"Munchlax",german:"Mampfaxo"},447:{english:"Riolu",german:"Riolu"},448:{english:"Lucario",german:"Lucario"},449:{english:"Hippopotas",german:"Hippopotas"},450:{english:"Hippowdon",german:"Hippoterus"},451:{english:"Skorupi",german:"Pionskora"},452:{english:"Drapion",german:"Piondragi"},453:{english:"Croagunk",german:"Glibunkel"},454:{english:"Toxicroak",german:"Toxiquak"},455:{english:"Carnivine",german:"Venuflibis"},456:{english:"Finneon",german:"Finneon"},457:{english:"Lumineon",german:"Lumineon"},458:{english:"Mantyke",german:"Mantirps"},459:{english:"Snover",german:"Shnebedeck"},460:{english:"Abomasnow",german:"Rexblisar"},461:{english:"Weavile",german:"Snibunna"},462:{english:"Magnezone",german:"Magnezone"},463:{english:"Lickilicky",german:"Schlurplek"},464:{english:"Rhyperior",german:"Rihornior"},465:{english:"Tangrowth",german:"Tangoloss"},466:{english:"Electivire",german:"Elevoltek"},467:{english:"Magmortar",german:"Magbrant"},468:{english:"Togekiss",german:"Togekiss"},469:{english:"Yanmega",german:"Yanmega"},470:{english:"Leafeon",german:"Folipurba"},471:{english:"Glaceon",german:"Glaziola"},472:{english:"Gliscor",german:"Skorgro"},473:{english:"Mamoswine",german:"Mamutel"},474:{english:"Porygon-Z",german:"Porygon-Z"},475:{english:"Gallade",german:"Galagladi"},476:{english:"Probopass",german:"Voluminas"},477:{english:"Dusknoir",german:"Zwirrfinst"},478:{english:"Froslass",german:"Frosdedje"},479:{english:"Rotom",german:"Rotom"},480:{english:"Uxie",german:"Selfe"},481:{english:"Mesprit",german:"Vesprit"},482:{english:"Azelf",german:"Tobutz"},483:{english:"Dialga",german:"Dialga"},484:{english:"Palkia",german:"Palkia"},485:{english:"Heatran",german:"Heatran"},486:{english:"Regigigas",german:"Regigigas"},487:{english:"Giratina",german:"Giratina"},488:{english:"Cresselia",german:"Cresselia"},489:{english:"Phione",german:"Phione"},490:{english:"Manaphy",german:"Manaphy"},491:{english:"Darkrai",german:"Darkrai"},492:{english:"Shaymin",german:"Shaymin"},493:{english:"Arceus",german:"Arceus"},494:{english:"Victini",german:"Victini"},495:{english:"Snivy",german:"Serpifeu"},496:{english:"Servine",german:"Efoserp"},497:{english:"Serperior",german:"Serpiroyal"},498:{english:"Tepig",german:"Floink"},499:{english:"Pignite",german:"Ferkokel"},500:{english:"Emboar",german:"Flambirex"},501:{english:"Oshawott",german:"Ottaro"},502:{english:"Dewott",german:"Zwottronin"},503:{english:"Samurott",german:"Admurai"},504:{english:"Patrat",german:"Nagelotz"},505:{english:"Watchog",german:"Kukmarda"},506:{english:"Lillipup",german:"Yorkleff"},507:{english:"Herdier",german:"Terribark"},508:{english:"Stoutland",german:"Bissbark"},509:{english:"Purrloin",german:"Felilou"},510:{english:"Liepard",german:"Kleoparda"},511:{english:"Pansage",german:"Vegimak"},512:{english:"Simisage",german:"Vegichita"},513:{english:"Pansear",german:"Grillmak"},514:{english:"Simisear",german:"Grillchita"},515:{english:"Panpour",german:"Sodamak"},516:{english:"Simipour",german:"Sodachita"},517:{english:"Munna",german:"Somniam"},518:{english:"Musharna",german:"Somnivora"},519:{english:"Pidove",german:"Dusselgurr"},520:{english:"Tranquill",german:"Navitaub"},521:{english:"Unfezant",german:"Fasasnob"},522:{english:"Blitzle",german:"Elezeba"},523:{english:"Zebstrika",german:"Zebritz"},524:{english:"Roggenrola",german:"Kiesling"},525:{english:"Boldore",german:"Sedimantur"},526:{english:"Gigalith",german:"Brockoloss"},527:{english:"Woobat",german:"Fleknoil"},528:{english:"Swoobat",german:"Fletiamo"},529:{english:"Drilbur",german:"Rotomurf"},530:{english:"Excadrill",german:"Stalobor"},531:{english:"Audino",german:"Ohrdoch"},532:{english:"Timburr",german:"Praktibalk"},533:{english:"Gurdurr",german:"Strepoli"},534:{english:"Conkeldurr",german:"Meistagrif"},535:{english:"Tympole",german:"Schallquap"},536:{english:"Palpitoad",german:"Mebrana"},537:{english:"Seismitoad",german:"Branawarz"},538:{english:"Throh",german:"Jiutesto"},539:{english:"Sawk",german:"Karadonis"},540:{english:"Sewaddle",german:"Strawickl"},541:{english:"Swadloon",german:"Folikon"},542:{english:"Leavanny",german:"Matrifol"},543:{english:"Venipede",german:"Toxiped"},544:{english:"Whirlipede",german:"Rollum"},545:{english:"Scolipede",german:"Cerapendra"},546:{english:"Cottonee",german:"Waumboll"},547:{english:"Whimsicott",german:"Elfun"},548:{english:"Petilil",german:"Lilminip"},549:{english:"Lilligant",german:"Dressella"},550:{english:"Basculin",german:"Barschuft"},551:{english:"Sandile",german:"Ganovil"},552:{english:"Krokorok",german:"Rokkaiman"},553:{english:"Krookodile",german:"Rabigator"},554:{english:"Darumaka",german:"Flampion"},555:{english:"Darmanitan",german:"Flampivian"},556:{english:"Maractus",german:"Maracamba"},557:{english:"Dwebble",german:"Lithomith"},558:{english:"Crustle",german:"Castellith"},559:{english:"Scraggy",german:"Zurrokex"},560:{english:"Scrafty",german:"Irokex"},561:{english:"Sigilyph",german:"Symvolara"},562:{english:"Yamask",german:"Makabaja"},563:{english:"Cofagrigus",german:"Echnatoll"},564:{english:"Tirtouga",german:"Galapaflos"},565:{english:"Carracosta",german:"Karippas"},566:{english:"Archen",german:"Flapteryx"},567:{english:"Archeops",german:"Aeropteryx"},568:{english:"Trubbish",german:"Unratütox"},569:{english:"Garbodor",german:"Deponitox"},570:{english:"Zorua",german:"Zorua"},571:{english:"Zoroark",german:"Zoroark"},572:{english:"Minccino",german:"Picochilla"},573:{english:"Cinccino",german:"Chillabell"},574:{english:"Gothita",german:"Mollimorba"},575:{english:"Gothorita",german:"Hypnomorba"},576:{english:"Gothitelle",german:"Morbitesse"},577:{english:"Solosis",german:"Monozyto"},578:{english:"Duosion",german:"Mitodos"},579:{english:"Reuniclus",german:"Zytomega"},580:{english:"Ducklett",german:"Piccolente"},581:{english:"Swanna",german:"Swaroness"},582:{english:"Vanillite",german:"Gelatini"},583:{english:"Vanillish",german:"Gelatroppo"},584:{english:"Vanilluxe",german:"Gelatwino"},585:{english:"Deerling",german:"Sesokitz"},586:{english:"Sawsbuck",german:"Kronjuwild"},587:{english:"Emolga",german:"Emolga"},588:{english:"Karrablast",german:"Laukaps"},589:{english:"Escavalier",german:"Cavalanzas"},590:{english:"Foongus",german:"Tarnpignon"},591:{english:"Amoonguss",german:"Hutsassa"},592:{english:"Frillish",german:"Quabbel"},593:{english:"Jellicent",german:"Apoquallyp"},594:{english:"Alomomola",german:"Mamolida"},595:{english:"Joltik",german:"Wattzapf"},596:{english:"Galvantula",german:"Voltula"},597:{english:"Ferroseed",german:"Kastadur"},598:{english:"Ferrothorn",german:"Tentantel"},599:{english:"Klink",german:"Klikk"},600:{english:"Klang",german:"Kliklak"},601:{english:"Klinklang",german:"Klikdiklak"},602:{english:"Tynamo",german:"Zapplardin"},603:{english:"Eelektrik",german:"Zapplalek"},604:{english:"Eelektross",german:"Zapplarang"},605:{english:"Elgyem",german:"Pygraulon"},606:{english:"Beheeyem",german:"Megalon"},607:{english:"Litwick",german:"Lichtel"},608:{english:"Lampent",german:"Laternecto"},609:{english:"Chandelure",german:"Skelabra"},610:{english:"Axew",german:"Milza"},611:{english:"Fraxure",german:"Sharfax"},612:{english:"Haxorus",german:"Maxax"},613:{english:"Cubchoo",german:"Petznief"},614:{english:"Beartic",german:"Siberio"},615:{english:"Cryogonal",german:"Frigometri"},616:{english:"Shelmet",german:"Schnuthelm"},617:{english:"Accelgor",german:"Hydragil"},618:{english:"Stunfisk",german:"Flunschlik"},619:{english:"Mienfoo",german:"Lin-Fu"},620:{english:"Mienshao",german:"Wie-Shu"},621:{english:"Druddigon",german:"Shardrago"},622:{english:"Golett",german:"Golbit"},623:{english:"Golurk",german:"Golgantes"},624:{english:"Pawniard",german:"Gladiantri"},625:{english:"Bisharp",german:"Caesurio"},626:{english:"Bouffalant",german:"Bisofank"},627:{english:"Rufflet",german:"Geronimatz"},628:{english:"Braviary",german:"Washakwil"},629:{english:"Vullaby",german:"Skallyk"},630:{english:"Mandibuzz",german:"Grypheldis"},631:{english:"Heatmor",german:"Furnifraß"},632:{english:"Durant",german:"Fermicula"},633:{english:"Deino",german:"Kapuno"},634:{english:"Zweilous",german:"Duodino"},635:{english:"Hydreigon",german:"Trikephalo"},636:{english:"Larvesta",german:"Ignivor"},637:{english:"Volcarona",german:"Ramoth"},638:{english:"Cobalion",german:"Kobalium"},639:{english:"Terrakion",german:"Terrakium"},640:{english:"Virizion",german:"Viridium"},641:{english:"Tornadus",german:"Boreos"},642:{english:"Thundurus",german:"Voltolos"},643:{english:"Reshiram",german:"Reshiram"},644:{english:"Zekrom",german:"Zekrom"},645:{english:"Landorus",german:"Demeteros"},646:{english:"Kyurem",german:"Kyurem"},647:{english:"Keldeo",german:"Keldeo"},648:{english:"Meloetta",german:"Meloetta"},649:{english:"Genesect",german:"Genesect"},650:{english:"Chespin",german:"Igamaro"},651:{english:"Quilladin",german:"Igastarnish"},652:{english:"Chesnaught",german:"Brigaron"},653:{english:"Fennekin",german:"Fynx"},654:{english:"Braixen",german:"Rutena"},655:{english:"Delphox",german:"Fennexis"},656:{english:"Froakie",german:"Froxy"},657:{english:"Frogadier",german:"Amphizel"},658:{english:"Greninja",german:"Quajutsu"},659:{english:"Bunnelby",german:"Scoppel"},660:{english:"Diggersby",german:"Grebbit"},661:{english:"Fletchling",german:"Dartiri"},662:{english:"Fletchinder",german:"Dartignis"},663:{english:"Talonflame",german:"Fiaro"},664:{english:"Scatterbug",german:"Purmel"},665:{english:"Spewpa",german:"Puponcho"},666:{english:"Vivillon",german:"Vivillon"},667:{english:"Litleo",german:"Leufeo"},668:{english:"Pyroar",german:"Pyroleo"},669:{english:"Flabébé",german:"Flabébé"},670:{english:"Floette",german:"Floette"},671:{english:"Florges",german:"Florges"},672:{english:"Skiddo",german:"Mähikel"},673:{english:"Gogoat",german:"Chevrumm"},674:{english:"Pancham",german:"Pam-Pam"},675:{english:"Pangoro",german:"Pandagro"},676:{english:"Furfrou",german:"Coiffwaff"},677:{english:"Espurr",german:"Psiau"},678:{english:"Meowstic",german:"Psiaugon"},679:{english:"Honedge",german:"Gramokles"},680:{english:"Doublade",german:"Duokles"},681:{english:"Aegislash",german:"Durengard"},682:{english:"Spritzee",german:"Parfi"},683:{english:"Aromatisse",german:"Parfinesse"},684:{english:"Swirlix",german:"Flauschling"},685:{english:"Slurpuff",german:"Sabbaione"},686:{english:"Inkay",german:"Iscalar"},687:{english:"Malamar",german:"Calamanero"},688:{english:"Binacle",german:"Bithora"},689:{english:"Barbaracle",german:"Thanathora"},690:{english:"Skrelp",german:"Algitt"},691:{english:"Dragalge",german:"Tandrak"},692:{english:"Clauncher",german:"Scampisto"},693:{english:"Clawitzer",german:"Wummer"},694:{english:"Helioptile",german:"Eguana"},695:{english:"Heliolisk",german:"Elezard"},696:{english:"Tyrunt",german:"Balgoras"},697:{english:"Tyrantrum",german:"Monargoras"},698:{english:"Amaura",german:"Amarino"},699:{english:"Aurorus",german:"Amagarga"},700:{english:"Sylveon",german:"Feelinara"},701:{english:"Hawlucha",german:"Resladero"},702:{english:"Dedenne",german:"Dedenne"},703:{english:"Carbink",german:"Rocara"},704:{english:"Goomy",german:"Viscora"},705:{english:"Sliggoo",german:"Viscargot"},706:{english:"Goodra",german:"Viscogon"},707:{english:"Klefki",german:"Clavion"},708:{english:"Phantump",german:"Paragoni"},709:{english:"Trevenant",german:"Trombork"},710:{english:"Pumpkaboo",german:"Irrbis"},711:{english:"Gourgeist",german:"Pumpdjinn"},712:{english:"Bergmite",german:"Arktip"},713:{english:"Avalugg",german:"Arktilas"},714:{english:"Noibat",german:"eF-eM"},715:{english:"Noivern",german:"UHaFnir"},716:{english:"Xerneas",german:"Xerneas"},717:{english:"Yveltal",german:"Yveltal"},718:{english:"Zygarde",german:"Zygarde"},719:{english:"Diancie",german:"Diancie"},720:{english:"Hoopa",german:"Hoopa"},721:{english:"Volcanion",german:"Volcanion"},722:{english:"Rowlet",german:"Bauz"},723:{english:"Dartrix",german:"Arboretoss"},724:{english:"Decidueye",german:"Silvarro"},725:{english:"Litten",german:"Flamiau"},726:{english:"Torracat",german:"Miezunder"},727:{english:"Incineroar",german:"Fuegro"},728:{english:"Popplio",german:"Robball"},729:{english:"Brionne",german:"Marikeck"},730:{english:"Primarina",german:"Primarene"},731:{english:"Pikipek",german:"Peppeck"},732:{english:"Trumbeak",german:"Trompeck"},733:{english:"Toucannon",german:"Tukanon"},734:{english:"Yungoos",german:"Mangunior"},735:{english:"Gumshoos",german:"Manguspektor"},736:{english:"Grubbin",german:"Mabula"},737:{english:"Charjabug",german:"Akkup"},738:{english:"Vikavolt",german:"Donarion"},739:{english:"Crabrawler",german:"Krabbox"},740:{english:"Crabominable",german:"Krawell"},741:{english:"Oricorio",german:"Choreogel"},742:{english:"Cutiefly",german:"Wommel"},743:{english:"Ribombee",german:"Bandelby"},744:{english:"Rockruff",german:"Wuffels"},745:{english:"Lycanroc",german:"Wolwerock"},746:{english:"Wishiwashi",german:"Lusardin"},747:{english:"Mareanie",german:"Garstella"},748:{english:"Toxapex",german:"Aggrostella"},749:{english:"Mudbray",german:"Pampuli"},750:{english:"Mudsdale",german:"Pampross"},751:{english:"Dewpider",german:"Araqua"},752:{english:"Araquanid",german:"Aranestro"},753:{english:"Fomantis",german:"Imantis"},754:{english:"Lurantis",german:"Mantidea"},755:{english:"Morelull",german:"Bubungus"},756:{english:"Shiinotic",german:"Lamellux"},757:{english:"Salandit",german:"Molunk"},758:{english:"Salazzle",german:"Amfira"},759:{english:"Stufful",german:"Velursi"},760:{english:"Bewear",german:"Kosturso"},761:{english:"Bounsweet",german:"Frubberl"},762:{english:"Steenee",german:"Frubaila"},763:{english:"Tsareena",german:"Fruyal"},764:{english:"Comfey",german:"Curelei"},765:{english:"Oranguru",german:"Kommandutan"},766:{english:"Passimian",german:"Quartermak"},767:{english:"Wimpod",german:"Reißlaus"},768:{english:"Golisopod",german:"Tectass"},769:{english:"Sandygast",german:"Sankabuh"},770:{english:"Palossand",german:"Colossand"},771:{english:"Pyukumuku",german:"Gufa"},772:{english:"Type: Null",german:"Typ:Null"},773:{english:"Silvally",german:"Amigento"},774:{english:"Minior",german:"Meteno"},775:{english:"Komala",german:"Koalelu"},776:{english:"Turtonator",german:"Tortunator"},777:{english:"Togedemaru",german:"Togedemaru"},778:{english:"Mimikyu",german:"Mimigma"},779:{english:"Bruxish",german:"Knirfish"},780:{english:"Drampa",german:"Sen-Long"},781:{english:"Dhelmise",german:"Moruda"},782:{english:"Jangmo-o",german:"Miniras"},783:{english:"Hakamo-o",german:"Mediras"},784:{english:"Kommo-o",german:"Grandiras"},785:{english:"Tapu Koko",german:"Kapu-Riki"},786:{english:"Tapu Lele",german:"Kapu-Fala"},787:{english:"Tapu Bulu",german:"Kapu-Toro"},788:{english:"Tapu Fini",german:"Kapu-Kime"},789:{english:"Cosmog",german:"Cosmog"},790:{english:"Cosmoem",german:"Cosmovum"},791:{english:"Solgaleo",german:"Solgaleo"},792:{english:"Lunala",german:"Lunala"},793:{english:"Nihilego",german:"Anego"},794:{english:"Buzzwole",german:"Masskito"},795:{english:"Pheromosa",german:"Schabelle"},796:{english:"Xurkitree",german:"Voltriant"},797:{english:"Celesteela",german:"Kaguron"},798:{english:"Kartana",german:"Katagami"},799:{english:"Guzzlord",german:"Schlingking"},800:{english:"Necrozma",german:"Necrozma"},801:{english:"Magearna",german:"Magearna"},802:{english:"Marshadow",german:"Marshadow"},803:{english:"Poipole",german:"Venicro"},804:{english:"Naganadel",german:"Agoyon"},805:{english:"Stakataka",german:"Muramura"},806:{english:"Blacephalon",german:"Kopplosio"},807:{english:"Zeraora",german:"Zeraora"},808:{english:"Meltan",german:"Meltan"},809:{english:"Melmetal",german:"Melmetal"},810:{english:"Grookey",german:"Chimpep"},811:{english:"Thwackey",german:"Chimstix"},812:{english:"Rillaboom",german:"Gortrom"},813:{english:"Scorbunny",german:"Hopplo"},814:{english:"Raboot",german:"Kickerlo"},815:{english:"Cinderace",german:"Liberlo"},816:{english:"Sobble",german:"Memmeon"},817:{english:"Drizzile",german:"Phlegleon"},818:{english:"Inteleon",german:"Intelleon"},819:{english:"Skwovet",german:"Raffel"},820:{english:"Greedent",german:"Schlaraffel"},821:{english:"Rookidee",german:"Meikro"},822:{english:"Corvisquire",german:"Kranoviz"},823:{english:"Corviknight",german:"Krarmor"},824:{english:"Blipbug",german:"Sensect"},825:{english:"Dottler",german:"Keradar"},826:{english:"Orbeetle",german:"Maritellit"},827:{english:"Nickit",german:"Kleptifux"},828:{english:"Thievul",german:"Gaunux"},829:{english:"Gossifleur",german:"Cottini"},830:{english:"Eldegoss",german:"Cottomi"},831:{english:"Wooloo",german:"Wolly"},832:{english:"Dubwool",german:"Zwollock"},833:{english:"Chewtle",german:"Kamehaps"},834:{english:"Drednaw",german:"Kamalm"},835:{english:"Yamper",german:"Voldi"},836:{english:"Boltund",german:"Bellektro"},837:{english:"Rolycoly",german:"Klonkett"},838:{english:"Carkol",german:"Wagong"},839:{english:"Coalossal",german:"Montecarbo"},840:{english:"Applin",german:"Knapfel"},841:{english:"Flapple",german:"Drapfel"},842:{english:"Appletun",german:"Schlapfel"},843:{english:"Silicobra",german:"Salanga"},844:{english:"Sandaconda",german:"Sanaconda"},845:{english:"Cramorant",german:"Urgl"},846:{english:"Arrokuda",german:"Pikuda"},847:{english:"Barraskewda",german:"Barrakiefa"},848:{english:"Toxel",german:"Toxel"},849:{english:"Toxtricity",german:"Riffex"},850:{english:"Sizzlipede",german:"Thermopod"},851:{english:"Centiskorch",german:"Infernopod"},852:{english:"Clobbopus",german:"Klopptopus"},853:{english:"Grapploct",german:"Kaocto"},854:{english:"Sinistea",german:"Fatalitee"},855:{english:"Polteageist",german:"Mortipot"},856:{english:"Hatenna",german:"Brimova"},857:{english:"Hattrem",german:"Brimano"},858:{english:"Hatterene",german:"Silembrim"},859:{english:"Impidimp",german:"Bähmon"},860:{english:"Morgrem",german:"Pelzebub"},861:{english:"Grimmsnarl",german:"Olangaar"},862:{english:"Obstagoon",german:"Barrikadax"},863:{english:"Perrserker",german:"Mauzinger"},864:{english:"Cursola",german:"Gorgasonn"},865:{english:"Sirfetch’d",german:"Lauchzelot"},866:{english:"Mr. Rime",german:"Pantifrost"},867:{english:"Runerigus",german:"Oghnatoll"},868:{english:"Milcery",german:"Hokumil"},869:{english:"Alcremie",german:"Pokusan"},870:{english:"Falinks",german:"Legios"},871:{english:"Pincurchin",german:"Britzigel"},872:{english:"Snom",german:"Snomnom"},873:{english:"Frosmoth",german:"Mottineva"},874:{english:"Stonjourner",german:"Humanolith"},875:{english:"Eiscue",german:"Kubuin"},876:{english:"Indeedee",german:"Servol"},877:{english:"Morpeko",german:"Morpeko"},878:{english:"Cufant",german:"Kupfanti"},879:{english:"Copperajah",german:"Patinaraja"},880:{english:"Dracozolt",german:"Lectragon"},881:{english:"Arctozolt",german:"Lecryodon"},882:{english:"Dracovish",german:"Pescragon"},883:{english:"Arctovish",german:"Pescryodon"},884:{english:"Duraludon",german:"Duraludon"},885:{english:"Dreepy",german:"Grolldra"},886:{english:"Drakloak",german:"Phandra"},887:{english:"Dragapult",german:"Katapuldra"},888:{english:"Zacian",german:"Zacian"},889:{english:"Zamazenta",german:"Zamazenta"},890:{english:"Eternatus",german:"Endynalos"},891:{english:"Kubfu",german:"Dakuma"},892:{english:"Urshifu",german:"Wulaosu"},893:{english:"Zarude",german:"Zarude"},894:{english:"Regieleki",german:"Regieleki"},895:{english:"Regidrago",german:"Regidrago"},896:{english:"Glastrier",german:"Polaross"},897:{english:"Spectrier",german:"Phantoross"},898:{english:"Calyrex",german:"Coronospa"},899:{english:"Wyrdeer",german:"Damythir"},900:{english:"Kleavor",german:"Axantor"},901:{english:"Ursaluna",german:"Ursaluna"},902:{english:"Basculegion",german:"Salmagnis"},903:{english:"Sneasler",german:"Snieboss"},904:{english:"Overqwil",german:"Myriador"},905:{english:"Enamorus",german:"Cupidos"},906:{english:"Sprigatito",german:"Felori"},907:{english:"Floragato",german:"Feliospa"},908:{english:"Meowscarada",german:"Maskagato"},909:{english:"Fuecoco",german:"Krokel"},910:{english:"Crocalor",german:"Lokroko"},911:{english:"Skeledirge",german:"Skelokrok"},912:{english:"Quaxly",german:"Kwaks"},913:{english:"Quaxwell",german:"Fuentente"},914:{english:"Quaquaval",german:"Bailonda"},915:{english:"Lechonk",german:"Ferkuli"},916:{english:"Oinkologne",german:"Fragrunz"},917:{english:"Tarountula",german:"Tarundel"},918:{english:"Spidops",german:"Spinsidias"},919:{english:"Nymble",german:"Micrick"},920:{english:"Lokix",german:"Lextremo"},921:{english:"Pawmi",german:"Pamo"},922:{english:"Pawmo",german:"Pamamo"},923:{english:"Pawmot",german:"Pamomamo"},924:{english:"Tandemaus",german:"Zwieps"},925:{english:"Maushold",german:"Famieps"},926:{english:"Fidough",german:"Hefel"},927:{english:"Dachsbun",german:"Backel"},928:{english:"Smoliv",german:"Olini"},929:{english:"Dolliv",german:"Olivinio"},930:{english:"Arboliva",german:"Olithena"},931:{english:"Squawkabilly",german:"Krawalloro"},932:{english:"Nacli",german:"Geosali"},933:{english:"Naclstack",german:"Sedisal"},934:{english:"Garganacl",german:"Saltigant"},935:{english:"Charcadet",german:"Knarbon"},936:{english:"Armarouge",german:"Crimanzo"},937:{english:"Ceruledge",german:"Azugladis"},938:{english:"Tadbulb",german:"Blipp"},939:{english:"Bellibolt",german:"Wampitz"},940:{english:"Wattrel",german:"Voltrel"},941:{english:"Kilowattrel",german:"Voltrean"},942:{english:"Maschiff",german:"Mobtiff"},943:{english:"Mabosstiff",german:"Mastifioso"},944:{english:"Shroodle",german:"Sproxi"},945:{english:"Grafaiai",german:"Affiti"},946:{english:"Bramblin",german:"Weherba"},947:{english:"Brambleghast",german:"Horrerba"},948:{english:"Toedscool",german:"Tentagra"},949:{english:"Toedscruel",german:"Tenterra"},950:{english:"Klawf",german:"Klibbe"},951:{english:"Capsakid",german:"Chilingel"},952:{english:"Scovillain",german:"Halupenjo"},953:{english:"Rellor",german:"Relluk"},954:{english:"Rabsca",german:"Skarabaks"},955:{english:"Flittle",german:"Flattutu"},956:{english:"Espathra",german:"Psiopatra"},957:{english:"Tinkatink",german:"Forgita"},958:{english:"Tinkatuff",german:"Tafforgita"},959:{english:"Tinkaton",german:"Granforgita"},960:{english:"Wiglett",german:"Schligda"},961:{english:"Wugtrio",german:"Schligdri"},962:{english:"Bombirdier",german:"Adebom"},963:{english:"Finizen",german:"Normifin"},964:{english:"Palafin",german:"Delfinator"},965:{english:"Varoom",german:"Knattox"},966:{english:"Revavroom",german:"Knattatox"},967:{english:"Cyclizar",german:"Mopex"},968:{english:"Orthworm",german:"Schlurm"},969:{english:"Glimmet",german:"Lumispross"},970:{english:"Glimmora",german:"Lumiflora"},971:{english:"Greavard",german:"Gruff"},972:{english:"Houndstone",german:"Friedwuff"},973:{english:"Flamigo",german:"Flaminkno"},974:{english:"Cetoddle",german:"Flaniwal"},975:{english:"Cetitan",german:"Kolowal"},976:{english:"Veluza",german:"Agiluza"},977:{english:"Dondozo",german:"Heerashai"},978:{english:"Tatsugiri",german:"Nigiragi"},979:{english:"Annihilape",german:"Epitaff"},980:{english:"Clodsire",german:"Suelord"},981:{english:"Farigiraf",german:"Farigiraf"},982:{english:"Dudunsparce",german:"Dummimisel"},983:{english:"Kingambit",german:"Gladimperio"},984:{english:"Great Tusk",german:"Riesenzahn"},985:{english:"Scream Tail",german:"Brüllschweif"},986:{english:"Brute Bonnet",german:"Wutpilz"},987:{english:"Flutter Mane",german:"Flatterhaar"},988:{english:"Slither Wing",german:"Kriechflügel"},989:{english:"Sandy Shocks",german:"Sandfell"},990:{english:"Iron Treads",german:"Eisenrad"},991:{english:"Iron Bundle",german:"Eisenbündel"},992:{english:"Iron Hands",german:"Eisenhand"},993:{english:"Iron Jugulis",german:"Eisenhals"},994:{english:"Iron Moth",german:"Eisenfalter"},995:{english:"Iron Thorns",german:"Eisendorn"},996:{english:"Frigibax",german:"Frospino"},997:{english:"Arctibax",german:"Cryospino"},998:{english:"Baxcalibur",german:"Espinodon"},999:{english:"Gimmighoul",german:"Gierspenst"},1e3:{english:"Gholdengo",german:"Monetigo"},1001:{english:"Wo-Chien",german:"Chongjian"},1002:{english:"Chien-Pao",german:"Baojian"},1003:{english:"Ting-Lu",german:"Dinglu"},1004:{english:"Chi-Yu",german:"Yuyu"},1005:{english:"Roaring Moon",german:"Donnersichel"},1006:{english:"Iron Valiant",german:"Eisenkrieger"},1007:{english:"Koraidon",german:"Koraidon"},1008:{english:"Miraidon",german:"Miraidon"},1009:{english:"Walking Wake",german:"Windewoge"},1010:{english:"Iron Leaves",german:"Eisenblatt"},1011:{english:"Dipplin",german:"Sirapfel"},1012:{english:"Poltchageist",german:"Mortcha"},1013:{english:"Sinistcha",german:"Fatalitcha"},1014:{english:"Okidogi",german:"Boninu"},1015:{english:"Munkidori",german:"Benesaru"},1016:{english:"Fezandipiti",german:"Beatori"},1017:{english:"Ogerpon",german:"Ogerpon"},1018:{english:"Archaludon",german:"Briduradon"},1019:{english:"Hydrapple",german:"Hydrapfel"},1020:{english:"Gouging Fire",german:"Keilflamme"},1021:{english:"Raging Bolt",german:"Furienblitz"},1022:{english:"Iron Boulder",german:"Eisenfels"},1023:{english:"Iron Crown",german:"Eisenhaupt"},1024:{english:"Terapagos",german:"Terapagos"},1025:{english:"Pecharunt",german:"Infamomo"}};(function($){$.tablesort=function($table,settings){var self=this;this.$table=$table;this.$thead=this.$table.find("thead");this.settings=$.extend({},$.tablesort.defaults,settings);this.$sortCells=this.$thead.length>0?this.$thead.find("th:not(.no-sort)"):this.$table.find("th:not(.no-sort)");this.$sortCells.on("click.tablesort",(function(){self.sort($(this))}));this.index=null;this.$th=null;this.direction=null};$.tablesort.prototype={sort:function(th,direction){var start=new Date,self=this,table=this.$table,rowsContainer=table.find("tbody").length>0?table.find("tbody"):table,rows=rowsContainer.find("tr").has("td, th"),cells=rows.find(":nth-child("+(th.index()+1)+")").filter("td, th"),sortedMap=[];var unsortedValues=cells.map((function(idx,cell){return $(this).data().sortValue}));if(unsortedValues.length===0)return;if(this.index!==th.index()){this.direction="asc";this.index=th.index()}else if(direction!=="asc"&&direction!=="desc")this.direction=this.direction==="asc"?"desc":"asc";else this.direction=direction;direction=this.direction=="asc"?1:-1;self.$table.trigger("tablesort:start",[self]);self.$table.css("display");setTimeout((function(){self.$sortCells.removeClass(self.settings.asc+" "+self.settings.desc);for(var i=0,length=unsortedValues.length;i<length;i++){sortedMap.push({index:i,cell:cells[i],row:rows[i],value:unsortedValues[i]})}sortedMap.sort((function(a,b){return self.settings.compare(a.value,b.value,direction)*direction}));$.each(sortedMap,(function(i,entry){rowsContainer.append(entry.row)}));th.addClass(self.settings[self.direction]);self.$table.trigger("tablesort:complete",[self]);self.$table.css("display")}),unsortedValues.length>2e3?200:10)},destroy:function(){this.$sortCells.off("click.tablesort");this.$table.data("tablesort",null);return null}};$.tablesort.defaults={asc:"sorted ascending",desc:"sorted descending",compare:function(a,b,direction){if(a===""||a===null)return direction===1?1:-1;if(b===""||b===null)return direction===1?-1:1;if(a===b)return 0;return a<b?-1:1}};$.fn.tablesort=function(settings){var table,sortable,previous;return this.each((function(){table=$(this);previous=table.data("tablesort");if(previous){previous.destroy()}table.data("tablesort",new $.tablesort(table,settings))}))}})(window.jQuery);if(location.protocol==="https:"&&"serviceWorker"in navigator){try{navigator.serviceWorker.register("/nuzlocke-tracker/serviceworker.js",{scope:"/nuzlocke-tracker/"})}catch(e){console.error(e)}}if(!localStorage.getItem("selectedGame")){localStorage.setItem("selectedGame","rby")}let selectedGame=games[localStorage.getItem("selectedGame")]?localStorage.getItem("selectedGame"):"rby";function escapeHTML(str,jsContext){const string=new Option(str).innerHTML;if(jsContext){string.replace(/"/g,'"').replace(/'/g,"'").replace(/\n/g,"\\n").replace(/\/r/g,"\\r")}else{string.replace(/"/g,"&quot;")}return string}function renderMain(){let linksString="";let segmentsString="";for(const game in games){linksString+='<a class="item" data-tab="'+games[game].id+'">'+games[game].title+"</a>";segmentsString+='<div class="ui bottom attached segment tab" data-tab="'+games[game].id+'">'+'<div class="ui secondary stackable menu">'+'<div class="horizontally fitted item">'+'<h2 class="ui header">'+games[game].title+"</h2>"+"</div>"+'<div class="right horizontally fitted item">'+'<button class="ui basic fluid button addLocation"><i class="plus icon"></i>Add location</button>'+'<button class="ui basic icon button gameSettings" title="Game settings"><i class="settings icon"></i></button>'+"</div>"+"</div>"+'<table class="ui table sortable selectable">'+"<thead>"+"<tr>"+'<th class="center aligned four wide">Location</th>'+'<th class="center aligned four wide">Encounter</th>'+'<th class="center aligned four wide">Nickname</th>'+'<th class="center aligned three wide">Status</th>'+'<th class="center aligned no-sort one wide disabled"></th>'+"</tr>"+"</thead>"+'<tbody id="'+games[game].id+'-locations">'+"</tbody>"+"</table>"+"</div>"}return'<div class="ui stackable top attached borderless menu">'+'<div id="gameMenu" class="ui dropdown item">'+'<i class="sidebar icon"></i>'+"Games"+'<i class="dropdown icon"></i>'+'<div class="menu">'+linksString+"</div>"+"</div>"+'<div class="right horizontally fitted item dataControls">'+'<button id="saveData" class="ui green button"><i class="download icon"></i>Export</button>'+'<input id="fileLoader" accept=".json, application/json" type="file">'+'<label id="loadData" class="ui blue button fileInput" for="fileLoader"><i class="upload icon"></i>Import</label>'+'<button id="resetData" class="ui red button"><i class="remove icon"></i>Reset</button>'+"</div>"+"</div>"+segmentsString}function renderLocations(game,darkTheme){string="";game.locations.forEach(((location,index)=>{const locationValue=escapeHTML(location.value);const locationName=localStorage.getItem(game.id+location.value+"-name");const locationEncounter=localStorage.getItem(game.id+location.value+"-encounter");const locationNickname=localStorage.getItem(game.id+location.value+"-nickname");const locationStatus=localStorage.getItem(game.id+location.value+"-status");string+="<tr"+(location.order!==undefined?' class="customLocation"':"")+">"+'<td data-sort-value="'+index+'">'+escapeHTML(location.name)+"</td>"+'<td data-sort-value="'+(locationEncounter?escapeHTML(locationEncounter):"")+'">'+'<div data-name="'+(locationName?escapeHTML(locationName):"")+'" data-value="'+(locationEncounter?escapeHTML(locationEncounter):"")+'" id="'+game.id+locationValue+'-encounter" class="ui'+(darkTheme?" inverted":"")+' fluid search selection long dropdown encounter-picker" aria-label="'+location.name+' encounter">'+'<input value="'+(locationEncounter?escapeHTML(locationEncounter):"")+'" aria-label="'+location.name+' encounter" name="pokemon" type="hidden">'+'<i class="dropdown icon"></i>'+'<div class="default text">Encounter</div>'+'<div class="menu"></div>'+"</div>"+"</td>"+'<td data-sort-value="'+(locationNickname?escapeHTML(locationNickname):"")+'">'+'<div class="ui'+(darkTheme?" inverted":"")+' fluid input">'+'<input autocomplete="off" maxlength="'+game.nameLimit+'" class="nickname-input" value="'+(locationNickname?escapeHTML(locationNickname):"")+'" id="'+game.id+locationValue+'-nickname" name="nickname" placeholder="Nickname" type="text" aria-label="'+location.name+' nickname">'+"</div>"+"</td>"+'<td data-sort-value="'+(locationStatus?escapeHTML(locationStatus):"")+'">'+'<div id="'+game.id+locationValue+'-status" class="ui'+(darkTheme?" inverted":"")+' fluid selection long dropdown" aria-label="'+location.name+' status">'+'<input value="'+(locationStatus?escapeHTML(locationStatus):"")+'" name="status" type="hidden">'+'<i class="dropdown icon"></i>'+'<div class="default text">Status</div>'+'<div class="menu">'+'<div class="item" data-value="captured"><i class="check icon"></i>Captured</div>'+'<div class="item" data-value="received"><i class="gift icon"></i>Received</div>'+'<div class="item" data-value="traded"><i class="exchange icon"></i>Traded</div>'+'<div class="item" data-value="missed"><i class="ban icon"></i>Missed</div>'+'<div class="item" data-value="stored"><i class="hdd icon"></i>Stored</div>'+'<div class="item" data-value="deceased"><i class="skull icon"></i>Deceased</div>'+"</div>"+"</div>"+"</td>"+'<td><div title="Delete" class="ui'+(darkTheme?" inverted":"")+' basic singleReset fluid icon button" data-location-id="'+locationValue+'"><i class="remove icon"></i></div></td>'+"</tr>"}));return string}function resetGame(game,removeLocations){games[selectedGame].locations.forEach((location=>{clearLocation(selectedGame+location.value)}));if(removeLocations){localStorage.removeItem(selectedGame+"-custom-locations");games[selectedGame].locations=games[selectedGame].locations.filter((location=>location.value[0]!=="c"))}}function filterByProperty(array,property){const values={};return array.filter((entry=>{const value=entry[property];if(values[value]!==undefined){return false}else{values[value]=true;return true}}))}function uploadFile(input){if(input.files&&input.files[0]){file=input.files[0];fr=new FileReader;fr.onload=()=>{try{const data=JSON.parse(fr.result);if(data&&data.hasOwnProperty("locations")){const locations=filterByProperty(data.locations,"id");resetGame(data.id,true);$("#disableDexLimit").prop("checked",data.settings&&data.settings.disableDexLimit);toggleDexLimit(data.id);if(data.customLocations.length){const customLocations=filterByProperty(data.customLocations,"value");localStorage.setItem(data.id+"-custom-locations",JSON.stringify(customLocations))}else{localStorage.removeItem(data.id+"-custom-locations")}locations.forEach((location=>{populateLocation(data.id,location)}));updateTab(data.id,true);if(localStorage.getItem("selectedGame")!==data.id){$("#gameMenu .menu").find('.item[data-tab="'+data.id+'"]').click()}}else{$("#errorMessage").removeClass("hidden");$("#messageHeader").text("Incorrect format");$("#messageContent").text("The uploaded file contains invalid data")}}catch(e){console.error(e);$("#errorMessage").removeClass("hidden");$("#messageHeader").text("Could not read file");$("#messageContent").text("The uploaded file was not recognized as valid JSON")}};fr.readAsText(file)}}function populateLocation(game,data){const id=game+data.id;const encounterElm=$("#"+id+"-encounter");const nicknameElm=$("#"+id+"-nickname");const statusElm=$("#"+id+"-status");if(data.encounter){encounterElm.dropdown("set value",data.encounter);encounterElm.dropdown("set text",'<i class="pkmn '+data.encounter+'"></i>'+data.name);encounterElm.data("name",data.name);localStorage.setItem(id+"-encounter",data.encounter);localStorage.setItem(id+"-name",data.name)}else{encounterElm.closest("td").data("sortValue","");encounterElm.dropdown("clear");localStorage.removeItem(id+"-encounter");localStorage.removeItem(id+"-name")}if(data.nickname){nicknameElm.val(data.nickname);localStorage.setItem(id+"-nickname",data.nickname)}else{nicknameElm.val("").closest("td").data("sortValue","");localStorage.removeItem(id+"-nickname")}if(data.status){statusElm.dropdown("set selected",data.status);localStorage.setItem(id+"-status",data.status)}else{statusElm.closest("td").data("sortValue","");statusElm.dropdown("clear");localStorage.removeItem(id+"-status")}}function clearLocation(id){const encounter=id+"-encounter";const nickname=id+"-nickname";const status=id+"-status";const name=id+"-name";$("#"+encounter).dropdown("clear");$("#"+encounter).closest("td").data("sortValue","");$("#"+nickname).val("").closest("td").data("sortValue","");$("#"+status).dropdown("clear");$("#"+status).closest("td").data("sortValue","");localStorage.removeItem(encounter);localStorage.removeItem(nickname);localStorage.removeItem(status);localStorage.removeItem(name)}function sortLocations(game){const locations=games[game].locations.filter((location=>location.value[0]!=="c"));let customLocations=JSON.parse(localStorage.getItem(game+"-custom-locations")||"[]");let initialLength=customLocations.length;if(initialLength){customLocations.sort(((a,b)=>a.order<b.order?-1:a.order>b.order?1:0));while(customLocations.length!==0){const locationRemoval=[];initialLength=customLocations.length;customLocations.forEach(((customLocation,index)=>{const insertIndex=locations.findIndex((e=>e.value==customLocation.order));if(insertIndex!==-1){locations.splice(insertIndex+1,0,customLocations[index]);locationRemoval.push(customLocation.value)}}));customLocations=customLocations.filter((location=>!locationRemoval.includes(location.value)));if(initialLength===customLocations.length){break}}}games[game].locations=locations}function toggleDexLimit(tab){const value=$("#disableDexLimit").prop("checked");if(value){localStorage.setItem(tab+"-disable-dex-limit",true)}else{localStorage.removeItem(tab+"-disable-dex-limit")}}function translatePage(){const language=localStorage.getItem("language");if(language){translatePokemon(language);translateLocations(language)}}function translatePokemon(language){pkmnData.forEach((pokemon=>{if(pokemon===undefined||nameTranslations==undefined||nameTranslations[pokemon.id]==undefined||nameTranslations[pokemon.id][language]==undefined){return}pokemon.name=nameTranslations[pokemon.id][language]}))}function translateLocations(language){if(games==undefined){return}gamesKeys=Object.keys(games);gamesKeys.forEach((game=>{games[game].locations.forEach((location=>{if(location===undefined||location[language]===undefined||location[language]===""){return}location.name=location[language]}))}))}translatePage();function initTab(tab){$("#"+tab+"-locations .ui.dropdown").dropdown({onChange:function(value,name){$(this).closest("td").data("sortValue",value);localStorage.setItem($(this).prop("id"),value)}});$("#"+tab+"-locations .encounter-picker").dropdown({onChange:function(value,name){const regex=new RegExp(/[^>]*$/,"i");const elm=$(this);if(value&&name){elm.closest("td").data("sortValue",value);elm.data("name",name);localStorage.setItem(elm.prop("id").slice(0,-9)+"name",regex.exec(name));localStorage.setItem(elm.prop("id"),value);elm.find(".search").blur()}},onShow:function(){const value=$(this).dropdown("get value");$(this).dropdown("change values",localStorage.getItem(tab+"-disable-dex-limit")?pkmnData:pkmnData.slice(0,games[tab].dexLimit).filter((pokemon=>pokemon.exclude===undefined||!pokemon.exclude.includes(tab))));if(value){$(this).dropdown("set selected",value);setTimeout((()=>{this.querySelector('[data-value="'+value+'"]').scrollIntoView({block:"center"})}),10)}$(this).find(".search").focus()},onHide:function(){const elm=$(this);const value=elm.dropdown("get value");const name=elm.data("name");elm.find(".search").val("");elm.dropdown("change values",[]);if(value){elm.dropdown("set value",value);elm.dropdown("set text",name)}else{elm.dropdown("restore placeholder text")}},className:{icon:"pkmn"},forceSelection:false,ignoreCase:true,ignoreDiacritics:true,selectOnKeydown:false});$("#"+tab+'-locations .encounter-picker[data-name!=""]').each((function(){const value=escapeHTML($(this).data("value"));$(this).dropdown("set value",value);$(this).dropdown("set text",'<i class="pkmn '+value+'"></i>'+$(this).data("name"))}));$("#"+tab+"-locations").closest("table").tablesort();$("#"+tab+"-locations").closest("table").find("th").first().trigger("click")}function saveData(game){const blobData={id:game,locations:[],customLocations:JSON.parse(localStorage.getItem(game+"-custom-locations")||"[]"),settings:{}};if(localStorage.getItem(game+"-disable-dex-limit")){blobData.settings.disableDexLimit=true}games[game].locations.forEach((location=>{const encounter=localStorage.getItem(game+location.value+"-encounter");const name=localStorage.getItem(game+location.value+"-name");const nickname=localStorage.getItem(game+location.value+"-nickname");const status=localStorage.getItem(game+location.value+"-status");if(encounter||name||nickname||status){blobData.locations.push({id:location.value,encounter:encounter,name:name,nickname:nickname,status:status})}}));const link=document.createElement("a");const blob=new Blob([JSON.stringify(blobData)],{type:"application/json;charset=utf-8"});link.setAttribute("href",URL.createObjectURL(blob));link.setAttribute("download",game+"."+(new Date).toISOString().slice(0,10)+".json");link.click()}function addLocation(location,game){const customLocations=JSON.parse(localStorage.getItem(game+"-custom-locations")||"[]");if(customLocations.length){location.value="c"+(parseInt(customLocations[customLocations.length-1].value.slice(1))+1)}else{location.value="c0"}const duplicateLocationOrder=customLocations.findIndex((e=>e.order==location.order));if(duplicateLocationOrder!==-1){customLocations[duplicateLocationOrder].order=location.value}customLocations.push(location);localStorage.setItem(game+"-custom-locations",JSON.stringify(customLocations));updateTab(game,true)}function removeLocation(value,game){const customLocations=JSON.parse(localStorage.getItem(game+"-custom-locations")||"[]");const location=customLocations.find((location=>location.value==value));const dependantLocation=customLocations.findIndex((e=>e.order==location.value));if(dependantLocation!==-1){customLocations[dependantLocation].order=location.order}customLocations.splice(customLocations.findIndex((e=>e.value==location.value)),1);localStorage.setItem(game+"-custom-locations",JSON.stringify(customLocations));updateTab(game,true)}function updateTab(game,updateDropdown){sortLocations(game);$("#"+game+"-locations").html(renderLocations(games[game],localStorage.getItem("darkTheme")==="true"));initTab(game);if(updateDropdown){updateLocationDropdown()}games[game].loaded=true}function updateLocationDropdown(){const locations=[];games[selectedGame].locations.forEach((location=>{locations.push({name:"After "+escapeHTML(location.name),value:location.value})}));$("#locationOrder").dropdown("change values",locations);$("#locationOrder").dropdown("set selected","0")}sortLocations(selectedGame);const darkTheme=localStorage.getItem("darkTheme")==="true";$("#dark-theme").prop("checked",darkTheme).on("change",(function(){localStorage.setItem("darkTheme",this.checked);document.body.classList.toggle("dark-theme",this.checked);if(this.checked){$(".ui:not(.footer)").addClass("inverted")}else{$(".ui:not(.footer)").removeClass("inverted")}}));$("#disableDexLimit").on("change",(()=>{toggleDexLimit(selectedGame)}));document.body.classList.toggle("dark-theme",darkTheme);if(darkTheme){$(".ui.loading.segment").addClass("inverted")}$((()=>{$(document).on("click","#saveData",(()=>{saveData(selectedGame)})).on("click",".singleReset.button",(function(){const id=selectedGame+$(this).data("locationId");if($(this).closest("tr").hasClass("customLocation")){$("#clearModal").data("target",$(this).data("locationId"));$("#clearModal").modal("show")}else{clearLocation(id)}})).on("change",".nickname-input",(function(){const elm=$(this);if(elm.val()){elm.closest("td").data("sortValue",elm.val());localStorage.setItem(elm.prop("id"),elm.val())}else{elm.closest("td").data("sortValue","");localStorage.removeItem(elm.prop("id"))}}));$("#resetModal").modal({onApprove:e=>{resetGame(selectedGame,e.data("action")==="remove");updateTab(selectedGame,true)}});$("#clearModal").modal({onApprove:function(e){if(e.data("action")==="clear"){clearLocation(selectedGame+$(this).data("target"))}else if(e.data("action")==="remove"){clearLocation(selectedGame+$(this).data("target"));removeLocation($(this).data("target"),selectedGame)}$(this).removeData("target")}});$("#importModal").modal({onApprove:()=>{uploadFile($("#fileLoader")[0])}});$("#customLocationName").on("input",(function(){$(this).parent(".field").toggleClass("error",false)}));$("#locationModal").modal({onApprove:()=>{const locationName=$("#customLocationName").val().trim();$("#customLocationName").parent().toggleClass("error",locationName==false);if(locationName==false){return false}addLocation({name:locationName,order:$("#locationOrder").dropdown("get value")||"0"},selectedGame);$("#customLocationName").val("");$("#locationOrder").dropdown("set selected","0")}});$(".message .close").on("click",(function(){$(this).closest(".message").transition("fade")}));$("#mainContent").html(renderMain());$("#"+selectedGame+"-locations").html(renderLocations(games[selectedGame],darkTheme));$('[data-tab="'+selectedGame+'"]').addClass("active");$("#gameMenu .menu .item").tab({onFirstLoad:tabPath=>{if(!games[tabPath].loaded){updateTab(tabPath,false)}},onLoad:tabPath=>{selectedGame=tabPath;localStorage.setItem("selectedGame",tabPath);updateLocationDropdown();$("#disableDexLimit").prop("checked",localStorage.getItem(tabPath+"-disable-dex-limit"))}});$("#resetModal").modal("attach events","#resetData","show");$("#locationModal").modal("attach events",".addLocation","show");$("#settingsModal").modal("attach events",".gameSettings","show");$("#fileLoader").on("change",(()=>{$("#importModal").modal("show")}));$("#languageOptions").dropdown({onChange:function(value,text,$choice){if(value){$("#languageOptions").val(value);localStorage.setItem("language",value);translatePage()}}});$("#gameMenu").dropdown();$("#locationOrder").dropdown({onChange:value=>{$("#locationOrder").val(value)}});if(darkTheme){$(".ui:not(.footer)").addClass("inverted")}initTab(selectedGame);updateLocationDropdown();$("#disableDexLimit").prop("checked",localStorage.getItem(selectedGame+"-disable-dex-limit"))}));